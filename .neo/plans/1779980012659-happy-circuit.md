...
- [ ] Confirm whether the change belongs in Neo-owned code or shared upstream code.
...
- Prefer Neo-owned directories for Neo-specific behavior.
- If shared upstream files must be edited, keep the change narrow and add `neocode_change` markers where required.
