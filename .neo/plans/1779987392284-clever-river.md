...
## Findings
- Runtime colorization exists only in `frontend/src/main/kotlin/ai/neocode/client/ui/SvgIconColorizer.kt`.
- The only production caller is `frontend/src/main/kotlin/ai/neocode/client/session/scroll/ScrollButtonIcon.kt`.
...
- Other used frontend icons already have light/dark pairs:
  ...
  - `neo.svg` / `neo_dark.svg`
  - `neo-content.svg` / `neo-content_dark.svg`
  - `plus.svg` / `plus_dark.svg` exists, though no current direct source reference was found.
  - `neo@20x20.svg` / `neo@20x20_dark.svg` exists, though no current direct source reference was found.
...
2. Delete `frontend/src/main/kotlin/ai/neocode/client/ui/SvgIconColorizer.kt` after confirming no callers remain.
...
6. Run the smallest relevant verification from `packages/neo-jetbrains/`:
   - `bun run typecheck` or `./gradlew typecheck`.

## Files Expected To Change
- `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/session/scroll/ScrollButtonIcon.kt`
- `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/session/ui/style/SessionUiStyle.kt`
- Delete `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/ui/SvgIconColorizer.kt`
- Add `packages/neo-jetbrains/src/main/resources/META-INF/pluginIcon_dark.svg`
