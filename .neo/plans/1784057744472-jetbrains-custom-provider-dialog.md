...
All work is in `packages/neo-jetbrains/frontend/`. No backend, RPC, or DTO changes. `saveCustom` already upserts, and `ProviderSettingsDto.config[id]` already carries the fields needed to prefill an edit. No `neocode_change` markers are needed (all files are under Neo-owned `packages/neo-jetbrains/`).
...
Only edit the base `NeoBundle.properties`; other locale files fall back to base for missing keys.

### 2. `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/settings/providers/ProviderCatalog.kt`
...
### 3. `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/settings/providers/ProviderListRows.kt`
...
### 4. `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/settings/providers/ProvidersSettingsUi.kt`
...
## Tests — `packages/neo-jetbrains/frontend/src/test/kotlin/ai/neocode/client/settings/providers/ProvidersSettingsUiTest.kt`
...
Run from `packages/neo-jetbrains/`:
