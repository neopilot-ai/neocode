...
- The relevant files are `packages/neo-jetbrains/frontend/src/main/kotlin/ai/neocode/client/session/SessionUi.kt`, `.../scroll/SessionScroll.kt`, `.../views/question/QuestionView.kt`, `.../views/permission/PermissionView.kt`, `.../views/LoginRequiredView.kt`, `.../views/base/BaseQuestionView.kt`, and `frontend/src/test/kotlin/ai/neocode/client/session/SessionScrollTest.kt`.
...
- From `packages/neo-jetbrains/`, run `./gradlew test --tests "ai.neocode.client.session.SessionScrollTest"`.
- From `packages/neo-jetbrains/`, run `./gradlew typecheck`.
