...
const file = "packages/neo-jetbrains/package.json"
...
if (values.help) {
  console.log(`
Usage: bun .neo/skills/release-jetbrains/script/set-pin.ts (--latest | --version <x.y.z>) [--pr]
...
console.log("Test locally with: cd packages/neo-jetbrains && ./gradlew typecheck && ./gradlew test")
