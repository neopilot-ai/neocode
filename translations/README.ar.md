...
Neo Code هو وكيل برمجة بالذكاء الاصطناعي يعمل معك أينما تعمل: [VS Code](https://neo.khulnasoft.com/landing/vs-code) و[JetBrains](https://neo.khulnasoft.com/features/jetbrains-native) و[CLI](https://neo.khulnasoft.com/cli). إنه مفتوح المصدر وبتسعير مفتوح. يمكنك الاختيار من بين أكثر من 500 نموذج، والتبديل بينها أثناء المهمة، ودفع سعر مزود النموذج من دون أي هامش إضافي. لا تحتاج إلى مفاتيح API للبدء.

### التثبيت

اختر المكان الذي تريد تشغيل Neo فيه.
...
ثبّت [إضافة Neo Code](vscode:extension/neocode.neo-code) مباشرة، أو احصل عليها من [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=neocode.Neo-Code). أنشئ حسابًا وستحصل على إمكانية الوصول إلى أكثر من 500 نموذج، بما في ذلك GPT-5.5 وClaude Opus 4.7 وClaude Sonnet 4.6 وGemini 3.1 Pro Preview، كلها بسعر المزود.
...
بعد ذلك شغّل `neo` في أي مجلد مشروع للبدء.
...
ثبّت [إضافة Neo Code](https://plugins.jetbrains.com/plugin/28350-neo-code) من JetBrains Marketplace، أو ابحث عن "Neo Code" في `Settings → Plugins` داخل أي JetBrains IDE.
...
شغّل Neo من الويب، من دون جهاز محلي، على [app.neo.khulnasoft.com/cloud](https://app.neo.khulnasoft.com/cloud).
...
أعدّ مراجعات كود آلية بالذكاء الاصطناعي لطلبات السحب الخاصة بك على [app.neo.khulnasoft.com/code-reviews](https://app.neo.khulnasoft.com/code-reviews).
...
شغّل وكيل الذكاء الاصطناعي الدائم لديك على [app.neo.khulnasoft.com/claw](https://app.neo.khulnasoft.com/claw).
...
نزّل أحدث ملف ثنائي من [صفحة Releases](https://github.com/Neopilot-Ai/neocode/releases).

| المنصة | الملف |
|---|---|
| Windows (معظم أجهزة PC) | `neo-windows-x64.zip` |
...
ملاحظات: `x64-baseline` هو بناء توافق للمعالجات القديمة التي لا تدعم AVX. `musl` هو البناء المرتبط ثابتًا لـ Alpine أو صور Docker البسيطة من دون glibc. `neo-vscode-*.vsix` هو حزمة إضافة VS Code وليس CLI. أرشيفات `Source code` مخصصة للبناء من المصدر.

</details>

### Agents

يأتي Neo مع agents متخصصة يمكنك التبديل بينها حسب المهمة. يمكنك أيضًا إنشاء agents مخصصة خاصة بك.
...
تعرّف أكثر على [agents وagents المخصصة](https://neo.khulnasoft.com/docs/code-with-ai/agents/using-agents).
...
شغّل `neo run` مع `--auto` للعمل بشكل مستقل بالكامل ومن دون prompts، وهو مصمم لخطوط CI/CD:
...
لإعدادات التكوين وكل ما عدا ذلك، راجع [التوثيق](https://neo.khulnasoft.com/docs).

### المساهمة

نرحب بمساهمات المطورين والكتّاب والجميع. ابدأ بـ [Contributing Guide](/CONTRIBUTING.md) لإعداد البيئة ومعايير الكود وكيفية فتح pull request. راجع [RELEASING.md](../RELEASING.md) لعملية إصدار إضافة VS Code وCLI، و[packages/neo-jetbrains/RELEASING.md](../packages/neo-jetbrains/RELEASING.md) لإضافة JetBrains.
...
<details>
<summary>من أين جاء Neo CLI؟</summary>

Neo CLI هو fork من [OpenCode](https://github.com/anomalyco/opencode)، وتم تحسينه للعمل داخل منصة Neo agentic engineering.

</details>

---

**انضم إلى المجتمع** [Discord](https://neo.khulnasoft.com/discord) | [X](https://x.com/neocode) | [Reddit](https://www.reddit.com/r/neocode/)
