...
Neo Code es un agente de programación con IA que te acompaña en todos los lugares donde trabajas: [VS Code](https://neo.khulnasoft.com/landing/vs-code), [JetBrains](https://neo.khulnasoft.com/features/jetbrains-native) y la [CLI](https://neo.khulnasoft.com/cli). Es de código abierto y tiene precios abiertos. Puedes elegir entre más de 500 modelos, cambiar entre ellos a mitad de una tarea y pagar la tarifa del proveedor del modelo sin recargos. No necesitas claves de API para empezar.

### Instalación

Elige dónde quieres ejecutar Neo.
...
Instala directamente la [extensión Neo Code](vscode:extension/neocode.neo-code), o descárgala desde [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=neocode.Neo-Code). Crea una cuenta y tendrás acceso a más de 500 modelos, incluidos GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 y Gemini 3.1 Pro Preview, todos con precios del proveedor.
...
Luego ejecuta `neo` en cualquier directorio de proyecto para empezar.
...
Instala el [plugin Neo Code](https://plugins.jetbrains.com/plugin/28350-neo-code) desde JetBrains Marketplace, o busca "Neo Code" en `Settings → Plugins` dentro de cualquier IDE de JetBrains.
...
Ejecuta Neo desde la web, sin necesitar una máquina local, en [app.neo.khulnasoft.com/cloud](https://app.neo.khulnasoft.com/cloud).
...
Configura revisiones automáticas de código con IA en tus pull requests en [app.neo.khulnasoft.com/code-reviews](https://app.neo.khulnasoft.com/code-reviews).
...
Activa tu agente de IA siempre disponible en [app.neo.khulnasoft.com/claw](https://app.neo.khulnasoft.com/claw).
...
Descarga el binario más reciente desde la [página de Releases](https://github.com/Neopilot-Ai/neocode/releases).

| Plataforma | Recurso |
|---|---|
| Windows (la mayoría de PCs) | `neo-windows-x64.zip` |
...
Notas: `x64-baseline` es una compilación de compatibilidad para CPUs antiguas sin AVX. `musl` es la compilación enlazada estáticamente para Alpine o imágenes Docker mínimas sin glibc. `neo-vscode-*.vsix` es el paquete de extensión de VS Code, no la CLI. Los archivos `Source code` son para compilar desde el código fuente.

</details>

### Agents

Neo incluye agents especializados entre los que puedes cambiar según la tarea. También puedes crear tus propios agents personalizados.
...
Más información sobre [agents y agents personalizados](https://neo.khulnasoft.com/docs/code-with-ai/agents/using-agents).
...
Ejecuta `neo run` con `--auto` para operar de forma totalmente autónoma y sin prompts, pensado para pipelines CI/CD:
...
<details>
<summary>¿De dónde viene Neo CLI?</summary>

Neo CLI es un fork de [OpenCode](https://github.com/anomalyco/opencode), mejorado para funcionar dentro de la plataforma de ingeniería agéntica de Neo.

</details>

---

**Únete a la comunidad** [Discord](https://neo.khulnasoft.com/discord) | [X](https://x.com/neocode) | [Reddit](https://www.reddit.com/r/neocode/)
