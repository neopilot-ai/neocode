...
Neo Code হলো একটি AI কোডিং এজেন্ট যা আপনি যেখানে কাজ করেন সেখানেই কাজ করে: [VS Code](https://neo.khulnasoft.com/landing/vs-code), [JetBrains](https://neo.khulnasoft.com/features/jetbrains-native) এবং [CLI](https://neo.khulnasoft.com/cli)। এটি ওপেন সোর্স এবং খোলা মূল্যনীতির। আপনি 500টির বেশি মডেল থেকে বেছে নিতে পারেন, কাজের মাঝখানে মডেল বদলাতে পারেন এবং কোনো অতিরিক্ত চার্জ ছাড়াই মডেল প্রদানকারীর রেট পরিশোধ করেন। শুরু করতে API key দরকার নেই।

### ইনস্টলেশন

আপনি কোথায় Neo চালাতে চান তা বেছে নিন।
...
[Neo Code extension](vscode:extension/neocode.neo-code) সরাসরি ইনস্টল করুন, অথবা [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=neocode.Neo-Code) থেকে নিন। একটি অ্যাকাউন্ট তৈরি করলে GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 এবং Gemini 3.1 Pro Preview সহ 500টির বেশি মডেলে প্রদানকারীর দামে অ্যাক্সেস পাবেন।
...
তারপর শুরু করতে যেকোনো প্রজেক্ট ডিরেক্টরিতে `neo` চালান।
...
JetBrains Marketplace থেকে [Neo Code plugin](https://plugins.jetbrains.com/plugin/28350-neo-code) ইনস্টল করুন, অথবা যেকোনো JetBrains IDE-তে `Settings → Plugins`-এ "Neo Code" খুঁজুন।
...
লোকাল মেশিন ছাড়াই ওয়েব থেকে [app.neo.khulnasoft.com/cloud](https://app.neo.khulnasoft.com/cloud)-এ Neo চালান।
...
[app.neo.khulnasoft.com/code-reviews](https://app.neo.khulnasoft.com/code-reviews)-এ আপনার pull request-এ স্বয়ংক্রিয় AI code review সেট আপ করুন।
...
[app.neo.khulnasoft.com/claw](https://app.neo.khulnasoft.com/claw)-এ আপনার always-on AI agent চালু করুন।
...
[Releases page](https://github.com/Neopilot-Ai/neocode/releases) থেকে সর্বশেষ বাইনারি ডাউনলোড করুন।

| প্ল্যাটফর্ম | Asset |
|---|---|
| Windows (বেশিরভাগ PC) | `neo-windows-x64.zip` |
...
নোট: `x64-baseline` হলো AVX ছাড়া পুরোনো CPU-এর জন্য compatibility build। `musl` হলো Alpine বা glibc ছাড়া minimal Docker image-এর জন্য statically linked build। `neo-vscode-*.vsix` হলো VS Code extension package, CLI নয়। `Source code` archive source থেকে build করার জন্য।

</details>

### Agents

Neo বিশেষায়িত agents সহ আসে, কাজ অনুযায়ী আপনি এগুলোর মধ্যে বদলাতে পারেন। আপনি নিজের custom agents-ও বানাতে পারেন।
...
[agents এবং custom agents](https://neo.khulnasoft.com/docs/code-with-ai/agents/using-agents) সম্পর্কে আরও জানুন।
...
CI/CD pipeline-এর জন্য prompts ছাড়া পুরোপুরি autonomous operation পেতে `neo run`-এর সাথে `--auto` ব্যবহার করুন:
...
Configuration এবং বাকি সবকিছুর জন্য [docs](https://neo.khulnasoft.com/docs) দেখুন।

### Contributing

Developer, writer এবং সবাইকে contribution-এর জন্য স্বাগতম। environment setup, coding standard এবং pull request খোলার পদ্ধতির জন্য [Contributing Guide](/CONTRIBUTING.md) দিয়ে শুরু করুন। VS Code extension এবং CLI release process-এর জন্য [RELEASING.md](../RELEASING.md), এবং JetBrains plugin-এর জন্য [packages/neo-jetbrains/RELEASING.md](../packages/neo-jetbrains/RELEASING.md) দেখুন।
...
<details>
<summary>Neo CLI কোথা থেকে এসেছে?</summary>

Neo CLI হলো [OpenCode](https://github.com/anomalyco/opencode)-এর একটি fork, Neo agentic engineering platform-এর মধ্যে কাজ করার জন্য উন্নত করা হয়েছে।

</details>

---

**কমিউনিটিতে যোগ দিন** [Discord](https://neo.khulnasoft.com/discord) | [X](https://x.com/neocode) | [Reddit](https://www.reddit.com/r/neocode/)
