 ...
 * metadata. Neo-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeNeoModelId(modelId: string | undefined): string | undefined {
  return modelId
}
