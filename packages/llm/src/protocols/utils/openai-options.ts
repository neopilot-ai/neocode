...
// neocode_change start - support every reasoning summary mode in the OpenAI Responses API
...
const REASONING_SUMMARIES = new Set<string>(OpenAIReasoningSummaries) // neocode_change
const TEXT_VERBOSITY = new Set<string>(["low", "medium", "high"])
const INCLUDABLES = new Set<string>(OpenAIResponseIncludables)
const SERVICE_TIERS = new Set<string>(OpenAIServiceTiers)

export const OpenAIReasoningEffort = Schema.Literals(OpenAIReasoningEfforts)
export const OpenAIReasoningSummary = Schema.Literals(OpenAIReasoningSummaries) // neocode_change
...
// neocode_change start - preserve every reasoning summary mode supported by OpenAI Responses
