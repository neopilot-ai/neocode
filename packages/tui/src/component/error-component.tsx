...
// neocode_change start — guard against missing renderer context in ErrorBoundary fallback
...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/Neopilot-Ai/neocode/issues/new?template=bug-report.yml") // neocode_change
  ...
  issueURL.searchParams.set("neo-version", InstallationVersion) // neocode_change
  ...
  return (
    <box flexDirection="column" gap={1} backgroundColor={colors.bg}>
      ...
      <scrollbox
        height={Math.floor(height() * 0.7)} // neocode_change — use safe terminal height fallback
