...
export interface DialogSelectProps<T> {
  ...
  locked?: boolean
  actions?: DialogSelectAction<T>[] // neocode_change - supports actions without a selected option
  footerHints?: {
    title: string
    label: string
    side?: "left" | "right"
...
// neocode_change start - support list-level actions when no option is selected
      ...
      commands: [
        ...
        ...visible.map((item) => ({
          ...
          run() {
            ...
            setStore("input", "keyboard")
            // neocode_change start - allow actions such as scope toggles on empty lists
