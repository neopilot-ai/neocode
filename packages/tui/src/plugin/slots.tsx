import type { TuiPluginApi, TuiSlotContext, TuiSlotMap, TuiSlotProps } from "@neocode/plugin/tui"
import { createSlot, createSolidSlotRegistry, type JSX, type SolidPlugin } from "@opentui/solid"
import { children, createSignal, mergeProps } from "solid-js" // neocode_change
...
export function createSlots() {
  ...
  // neocode_change start - keep stateful fallback children mounted while preserving reactive slot props
