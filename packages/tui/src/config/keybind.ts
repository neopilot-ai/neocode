...
export const Definitions = {
  ...
  "prompt.vim.toggle": keybind("none", "Toggle vim modal editing in the prompt input"), // neocode_change
  ...
  news_toggle: keybind("none", "Toggle news on home screen"), // neocode_change
...
export const CommandMap = {
  ...
  news_toggle: "news.toggle", // neocode_change
