import { createStore, reconcile, unwrap } from "solid-js/store" // neocode_change
...
export type Route = HomeRoute | SessionRoute | PluginRoute | NeoClawRoute // neocode_change
  ...
  init: (props: { initialRoute?: Route }) => {
    ...
    return {
      ...
      navigate(route: Route) {
        previous = structuredClone(unwrap(store)) // neocode_change
