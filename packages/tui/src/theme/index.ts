...
import colorblind from "./assets/colorblind.json" with { type: "json" } // neocode_change
...
import neo from "./assets/neo.json" with { type: "json" } // neocode_change
import neo1 from "./assets/neo-v1.json" with { type: "json" } // neocode_change
