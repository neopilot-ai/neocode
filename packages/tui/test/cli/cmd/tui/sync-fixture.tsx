...
import { ToastProvider } from "../../../../src/ui/toast" // neocode_change
import { ExitProvider } from "../../../../src/context/exit" // neocode_change
...
export async function mount(override?: FetchHandler, state?: string) {
        ...
        <KVProvider>
          ...
          <ToastProvider>
            ...
            <SDKProvider url="http://test" directory={directory} fetch={calls.fetch} events={events.source}>
              <ProjectProvider>
                {/* neocode_change start - SyncProvider consumes the exit context */}
                <ExitProvider exit={() => {}}>
                  <SyncProvider>
                    <Probe />
                  </SyncProvider>
  ...
  await ready
  await project.sync() // neocode_change - event routing requires the resolved project
