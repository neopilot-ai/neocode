...
const tools: readonly ToolFixture[] = [
  ...
  },
  {
    icon: "✱",
    label:
      'Grep "export const NEO_DB|NEO_DB|NEO_DEV|Global\\.Path\\.data|data =" in packages/opencode/src (115 matches)',
  },
] as const
...
describe("TUI inline tool wrapping", () => {
  test("falls back for unknown tool names", () => {
    ...
    // neocode_change start - Neo tools keep their dedicated renderers
