...
import type { Event, GlobalEvent } from "@neocode/sdk/v2"
import { createSignal, onMount, Show, type ParentProps } from "solid-js" // neocode_change
import { ProjectProvider, useProject } from "../../../src/context/project" // neocode_change
...
// neocode_change start - initialize Neo's project filter before mounting V2 event consumers
...
// neocode_change start - preserve Neo's V2 hydration-race coverage after the DataProvider extraction
