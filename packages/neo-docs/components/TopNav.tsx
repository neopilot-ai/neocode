...
const mainNavItems: NavItem[] = [
  ...
  { label: "Neo Gateway", href: "/gateway" },
  { label: "NeoClaw", href: "/neoclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Neo Code" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Neopilot-Ai/neocode?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/Neopilot-Ai/", description: "View source and issues" },
  { label: "Discord Community", href: "https://neo.khulnasoft.com/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://neo.khulnasoft.com/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/Neopilot-Ai/neocode/releases",
...
function preview(url: string) {
  ...
  if (value.hostname !== "neo.khulnasoft.com" || !value.pathname.startsWith("/docs")) return url
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Neo Code</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://neo.khulnasoft.com/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.neo.khulnasoft.com" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="announcement-banner">
        <p>
          The all-new Neo Code extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">Neo CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the Neo Gateway →
        </p>
      </div>
