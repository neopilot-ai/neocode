...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Add header
    sections.push("# Neo Code Documentation")
    sections.push("")
    sections.push(
      "This file contains the complete documentation for Neo Code, the leading open source agentic engineering platform.",
    )
    sections.push("")
    const protocol = req.headers["x-forwarded-proto"] || "https"
    const host = req.headers.host || "neo.khulnasoft.com"
