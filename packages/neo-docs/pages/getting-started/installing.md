---
title: "Installation"
description: "How to install Neo Code on your system"
---

# Installation

Get started with Neo Code by installing it on your preferred platform. Choose your development environment below:
...
The current Neo Code extension is built on the [Neo CLI](https://github.com/Neopilot-Ai/neocode) and is distributed as the **pre-release version** on the VS Code Marketplace.
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Neo Code page on Open VSX Registry](https://open-vsx.org/extension/neocode/Neo-Code).
...
4. Search for "Neo Code"
5. Select "Neo Code" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [Neo Code GitHub Releases page](https://github.com/Neopilot-Ai/neocode/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Neopilot-Ai/neocode/releases/latest)
...
1. Open the [Neo Code GitHub Releases page](https://github.com/Neopilot-Ai/neocode/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Neo Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing Neo Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Neo Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Neo Code")
...
2. **[Run your first task](/docs/getting-started/quickstart)** — Learn how to chat with Neo to complete tasks
...
- Submit issues on [GitHub](https://github.com/Neopilot-Ai/neocode/issues)
