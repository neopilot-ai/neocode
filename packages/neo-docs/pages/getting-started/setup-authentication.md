...
description: "Configure Neo Code and connect to your AI providers"
---

# Authentication

When you install Neo Code, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with Neo Account

{% tabs %}
{% tab label="VS Code" %}

The extension prompts you to sign in when you first open Neo Code in VS Code. Click **Sign In** and complete the browser-based flow. Sign-in applies across extension surfaces, including the sidebar and Agent Manager.
...
[Add credits to your account](https://app.neo.khulnasoft.com/profile), or sign up for [Neo Pass](https://neo.khulnasoft.com/pricing/neo-pass).
{% /callout %}

## Neo Gateway API Key

If you're using the [Neo AI Gateway](/docs/gateway/) outside of the Neo Code extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:

1. Go to [app.neo.khulnasoft.com](https://app.neo.khulnasoft.com)
...
If you prefer to use your own API key or existing subscription, Neo Code supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! Neo Code supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with Neo Code through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
These settings apply across the extension, including the sidebar and Agent Manager. Agent Manager does not need separate provider or Neo CLI authentication setup.
...
Or use `neo auth login` for providers that support OAuth, such as GitHub Copilot or ChatGPT Plus/Pro.
...
Reach out to our [support team](mailto:hi@neo.khulnasoft.com) or join our [Discord community](https://neo.khulnasoft.com/discord).
{% /callout %}
