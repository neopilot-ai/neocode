...
description: "Questions about accounts and integrations in Neo Code"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in Neo Code.
...
This process involves removing the **Neo Connect** application from your GitHub account settings.
...
2. Find **Neo Connect** in the list of installed applications
3. Click **Configure** next to Neo Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your Neo Code profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
