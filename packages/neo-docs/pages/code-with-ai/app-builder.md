---
title: "App Builder"
description: "Build complete applications with Neo Code"
---
...
Neo's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Neo dashboard. No local environment setup required.
...
- **Active Neo Code account**  
  Sign up or log in at [app.neo.khulnasoft.com](https://app.neo.khulnasoft.com)

---

## Cost

- You pay only for the AI model usage via Neo Code credits
...
1. Navigate to **[App Builder](https://app.neo.khulnasoft.com/app-builder)** from your Neo dashboard.
