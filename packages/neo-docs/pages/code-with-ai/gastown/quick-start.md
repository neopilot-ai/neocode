...
- A [Neo account](https://app.neo.khulnasoft.com) (free tier works)
...
{% browserFrame url="app.neo.khulnasoft.com/gastown" caption="The new town onboarding flow" %}
...
Gastown uses the [Neo GitHub App](https://github.com/apps/neo-code) to access your repository. You'll be prompted to install it if you haven't already.

{% browserFrame url="app.neo.khulnasoft.com/gastown/town/rigs/new" caption="Adding a new rig — connect your repository" %}
...
{% browserFrame url="app.neo.khulnasoft.com/gastown/town/rigs/main" caption="The rig page — convoy tracker and kanban board showing beads in various states" %}
...
{% browserFrame url="app.neo.khulnasoft.com/gastown/town" caption="The Mayor — your conversational interface to the town" %}
