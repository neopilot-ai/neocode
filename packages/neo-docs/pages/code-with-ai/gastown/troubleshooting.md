...
**Fix:**
1. Check that the [Neo GitHub App](https://github.com/apps/neo-code) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/neo-code](https://github.com/apps/neo-code) |
...
3. **Contact support** — reach out at [neo.khulnasoft.com/discord](https://neo.khulnasoft.com/discord) with your town ID
