---
title: "Using Agents"
description: "Understanding and using different agents in Neo Code"
---

# Using Agents

Agents in Neo Code are specialized personas that tailor the assistant's behavior to your current task. Each agent offers different capabilities, expertise, and access levels to help you accomplish specific goals.
...
| **Tool Access** | Read-only tools plus restricted file editing (plan files in `.neo/plans/` only) |
