---
title: "GitHub"
description: "Using Neo Code in GitHub issues, pull requests, and review comments"
---

# Neo for GitHub

**Neo for GitHub** lets you interact with Neo directly from your GitHub issues, pull requests, and review comments. Mention the bot and it will:
...
{% image src="/docs/img/connect/github/github-review.png" alt="Asking @neocode-bot a question on a GitHub pull request review comment" width="800" /%}
...
{% image src="/docs/img/connect/github/github-issue.png" alt="Asking @neocode-bot to fix a GitHub issue" width="800" /%}
...
```
@neocode-bot what could be the cause of this issue?
```
...
{% image src="/docs/img/connect/github/github-bug.png" alt="Asking @neocode-bot to diagnose a bug report on a GitHub issue" width="800" /%}

---

## How It Works

1. **Mention `@neocode-bot`** on an issue, pull request, or review comment
2. **Neo reads the context** — the issue description, PR diff, review thread, and connected repository code
3. **A Cloud Agent spins up** to process the request
4. **Neo responds** with an answer, analysis, or a pull request containing the implementation
...
- Your GitHub integration configured via the Integrations tab at [app.neo.khulnasoft.com](https://app.neo.khulnasoft.com)
- The Neo Code Bot GitHub App installed on the relevant repositories
...
2. Connect your GitHub account through the **NeoConnect** GitHub App if you haven't already
3. Install the **Neo Code Bot** GitHub App on your repositories at [github.com/apps/neo-code-bot](https://github.com/apps/neo-code-bot/)

Once installed, `@neocode-bot` is available on any issue or PR in the repositories you've authorized.
...
Make sure the Neo Code Bot GitHub App is installed on the repository and that you're mentioning `@neocode-bot` (not `@neo`).

**The bot can't access the repository.**
Verify that both the NeoConnect App and the Neo Code Bot App are installed and have access to the repository in question.
