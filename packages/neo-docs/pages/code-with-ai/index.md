---
title: "Code with AI"
description: "Learn how to code with AI using Neo Code across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Neo Code is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to Neo Code? Start here to understand the core concepts:

- [**Install Neo Code**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use Neo Code wherever you work:
...
- [**Cloud Agent**](/docs/code-with-ai/platforms/cloud-agent) — Run Neo in the cloud
- [**Mobile Apps**](/docs/code-with-ai/platforms/mobile) — iOS and Android support
- [**Slack**](/docs/code-with-ai/platforms/slack) — Chat with Neo in your workspace
- [**App Builder**](/docs/code-with-ai/app-builder) — Create full-stack applications with AI

## Working with Agents

Neo uses specialized agents to help with different tasks:
...
- Explore [**Customize**](/docs/customize) to tailor Neo to your workflow
