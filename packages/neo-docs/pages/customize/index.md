---
title: "Customize"
description: "Make Neo Code work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Neo Code is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how Neo Code behaves and responds:
...
- [**Skills**](/docs/customize/skills) - Extend Neo's capabilities with reusable skill definitions
- [**Prompt Engineering**](/docs/customize/prompt-engineering) - Write effective prompts for better results

## Context & Indexing

Help Neo understand your codebase better:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide Neo Code's behavior
2. **Explore Custom Modes** — Try the built-in modes first, then create your own
3. **Enable Codebase Indexing** — Help Neo understand your project structure
...
- Check out [**Code with AI**](/docs/code-with-ai) to learn how to use Neo effectively
