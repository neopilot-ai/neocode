...
## Why Neo Code Uses MCP

Neo Code leverages MCP to provide:
...
MCP creates a universal connector between Neo Code and external services, with REST APIs often powering those services behind the scenes.
