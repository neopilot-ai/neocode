...
description: "How to configure and use MCP servers in the Neo CLI"
---

# Using MCP in the CLI

The Neo CLI supports both local and remote MCP servers. Once added, MCP tools are automatically available to the LLM alongside built-in tools.
...
|---|---|---|
| **Global** | `~/.config/neo/neo.json` | `neo.jsonc`, `config.json` |
| **Project** | `./neo.json` or `./.neo/neo.json` | `neo.jsonc` |
...
Browse community-contributed MCP server configurations and agent skills in the [Neo Marketplace](https://github.com/Neopilot-Ai/neo-marketplace). The marketplace includes ready-to-use configs for popular tools like Figma, Sentry, and more.
