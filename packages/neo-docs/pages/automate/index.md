---
title: "Automate"
description: "Automate your development workflows with Neo Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Neo Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Neo Code to external tools and services:
...
- [**Using MCP in Neo Code**](/docs/automate/mcp/using-in-neo-code) — Configuration guide
...
Connect Neo Code with your development tools:
...
Customize and extend Neo Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-neo-code) for external integrations
