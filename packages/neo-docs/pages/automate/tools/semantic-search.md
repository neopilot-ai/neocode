---
title: Semantic Search Tool | Neo Code Docs
...
- When Neo Code needs to find code related to specific functionality across your project
...
- When implementing a new feature, Neo Code searches for "authentication middleware" to understand existing patterns before writing new code.
- When debugging an issue, Neo Code searches for "error handling in API calls" to find related error patterns across the codebase.
- When refactoring code, Neo Code searches for "database transaction patterns" to ensure consistency across all database operations.
- When onboarding to a new codebase, Neo Code searches for "configuration loading" to understand how the application bootstraps.
