---
title: "Using Moonshot AI (Kimi) with Neo Code"
description: "Connect Moonshot's Kimi models to Neo Code. Setup guide for getting an API key and selecting models in VS Code and the CLI."
sidebar_label: Moonshot.ai
---

# Using Moonshot.ai With Neo Code
...
3. **Create a Key:** Click to generate a new API key. Give it a descriptive name (e.g., "Neo Code").
...
- **Kimi-specific prompting:** Neo automatically uses a Kimi-tuned system prompt for model IDs containing `kimi`; no extra configuration is required.
