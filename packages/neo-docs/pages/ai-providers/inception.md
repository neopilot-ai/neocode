---
title: "Using Inception Labs with Neo Code"
description: "Connect Inception Labs' Mercury diffusion LLMs to Neo Code for ultra-fast code generation. Setup guide for VS Code and the CLI."
sidebar_label: Inception
---

# Using Inception With Neo Code
...
Neo Code supports Inception's available models. Model selection and capabilities may vary based on your account tier.
...
- **Docs Feedback:** Report documentation issues at [Neopilot-Ai/neocode issues](https://github.com/Neopilot-Ai/neocode/issues/new?title=Documentation%20Issue:%20/docs/ai-providers/inception).
