---
title: "Using Fireworks AI with Neo Code | Fast Inference"
description: "Run open-source and proprietary models on Fireworks AI's high-performance platform in Neo Code. Setup guide for VS Code and the CLI."
---

# Using Fireworks AI With Neo Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Neo Code").
