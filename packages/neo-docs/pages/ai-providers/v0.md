---
title: "Using Vercel v0 with Neo Code"
description: "Connect Vercel's v0 models to Neo Code for UI-focused code generation. Setup guide for VS Code and the CLI."
sidebar_label: v0
---

# Using v0 With Neo Code

Neo Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Neo Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Neo Code, you'll need:
