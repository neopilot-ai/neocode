---
title: "Using Anthropic Claude with Neo Code"
description: "Configure Anthropic's Claude models in Neo Code. Guide to getting an API key, setting up Claude Sonnet and Opus in VS Code and the CLI."
sidebar_label: Anthropic
---

# Using Anthropic With Neo Code
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Neo Code").
