---
title: "Using Synthetic with Neo Code"
description: "Access open-source AI models through Synthetic in Neo Code. Setup guide for getting an API key and configuring models."
sidebar_label: Synthetic
---

# Using Synthetic With Neo Code
...
Neo Code supports all "always on" Synthetic AI models. The available models include various open-source options optimized for different use cases.
