---
title: "Using ZenMux with Neo Code | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in Neo Code with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With Neo Code
...
3. **Configure in Neo Code:** Add your API key to Neo Code settings.
...
- Check the [Neo Code GitHub repository](https://github.com/Neopilot-Ai/neocode) for integration-specific issues
