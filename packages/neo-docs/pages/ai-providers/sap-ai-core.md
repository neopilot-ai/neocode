---
title: "Using SAP AI Core with Neo Code"
description: "Connect SAP AI Core to Neo Code to use enterprise foundation models from your SAP BTP account. Setup and authentication guide."
sidebar_label: SAP AI Core
---

# Using SAP AI Core With Neo Code

Neo Code supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Neo Code, you'll need to create a service key for your SAP AI Core service instance:
...
Neo Code applies the following filters when fetching models:
...
3. Configure Neo Code with your credentials
