---
title: "Using Vercel AI Gateway with Neo Code"
description: Configure the Vercel AI Gateway in Neo Code to robustly access 100+ language models from various providers through a centralized interface.
keywords:
  - neo code
  - vercel ai gateway
  - ai provider
...
# Using Vercel AI Gateway With Neo Code
...
The Vercel AI Gateway supports a large and growing number of models. Neo Code automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
