---
title: "Using MiniMax with Neo Code"
description: "Configure MiniMax AI models in Neo Code. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: MiniMax
---

# Using MiniMax With Neo Code
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., "Neo Code").
