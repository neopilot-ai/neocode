---
title: "Deploy"
description: "Deploy your applications with Neo Code"
---

# Deploy

Neo Deploy lets you ship **Next.js** and **static sites** directly from Neo Code, with:

- **One-click deployment** from the Neo Code dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Neo Code
...
- Navigate to your [Organization dashboard](https://app.neo.khulnasoft.com/organizations) or [Profile](https://app.neo.khulnasoft.com/profile)
...
Neo Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Neo Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
