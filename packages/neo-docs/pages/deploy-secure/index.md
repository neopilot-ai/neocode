---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Neo Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Neo Code and manage security with AI-powered reviews and scans.
{% /callout %}
