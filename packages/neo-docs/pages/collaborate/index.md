---
title: "Collaborate"
description: "Work together with Neo Code team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Neo Code makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with Neo. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Neo Code sessions
...
Neo Code's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://neo.khulnasoft.com/contact-sales))** — Model controls, audit logs, SSO, dedicated support
...
1. [Install Neo Code](/docs/getting-started/installing) in your preferred environment
