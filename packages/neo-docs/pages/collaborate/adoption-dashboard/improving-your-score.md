...
**Action:** Install the Neo CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Neo Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Neo's other modes unlock additional value.
...
4. Consider Neo Deploy to validate AI output
