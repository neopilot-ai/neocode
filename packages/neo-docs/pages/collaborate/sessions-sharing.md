...
description: "Share and collaborate on Neo Code sessions"
---

# Sessions & Sharing

A session is your platform-agnostic interaction with Neo. It remembers your repository, your task, and the conversation so you can pause and resume work without losing context. Sessions are private to your account by default; you can optionally share a link with others who can read or fork your session.
...
This information lets Neo show your recent sessions and continue right from the same context the next time you open it.
...
3. Interact with Neo via any of our interfaces- the CLI, the Cloud Agent, or the Extensions in your favorite IDE.
...
To keep sessions fast and resumable, Neo stores small JSON blobs associated with your session. These include your conversation history and task metadata. If you share a session, Neo keeps a public copy used by the share link while your private session remains under your account.
