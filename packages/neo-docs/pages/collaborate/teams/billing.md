...
Neo seats uses a transparent, two-part billing system: a monthly subscription per seat, plus pay-as-you-go Neo credits with zero markup.

{% callout type="note" %}

Neo Code seats purchases of Teams or Enterprise are separate from Neo credits.

No Neo credits are included with a Teams or Enterprise purchase.

{% /callout %}

## Organization Credits

Organization Owners can purchase Neo credits on the [Organization dashboard](https://app.neo.khulnasoft.com).

Organization credits are purchased on behalf of all users in the organization. Every member of the organization can use the credits in the organization's balance with the Neo Code model provider.
...
Organization members can use organization credits by choosing the correct organization profile in the dropdown in the Profiles tab of the Neo Code extension.
...
In order to add Members to your Neo Code Organization, you must have seat(s) available for them.
...
Ensure your team has uninterrupted access to Neo Code by enabling [Automatic Top-Up](https://neo.khulnasoft.com/features/auto-top-ups). This feature keeps your organization's balance funded so you never have to worry about manual recharges. Auto top-up is also available for individual accounts — see [Adding Credits](/docs/getting-started/adding-credits) for details.
...
- **Automatic Thresholds** — Once enabled, Neo Code will automatically recharge your balance whenever it falls below $50.00.
...
Invoices for any payment on the Neo Code platform, for seats or credits, will be available in the Invoices tab.
