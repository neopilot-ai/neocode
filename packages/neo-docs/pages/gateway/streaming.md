---
title: "Streaming"
description: "Learn how to implement real-time streaming responses with the Neo AI Gateway using Server-Sent Events (SSE)."
---

# Streaming

The Neo AI Gateway supports streaming responses from all models using Server-Sent Events (SSE). Streaming allows your application to display tokens as they're generated, providing a more responsive user experience.
...
const response = await fetch("https://api.neo.khulnasoft.com/api/gateway/chat/completions", {
  method: "POST",
  headers: {
