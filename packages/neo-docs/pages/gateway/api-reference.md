---
title: "API Reference"
description: "Complete API reference for the Neo AI Gateway, including chat completions, FIM completions, and model listing endpoints."
---

# API Reference

The Neo AI Gateway provides an OpenAI-compatible API. All endpoints use the base URL:
...
```bash
curl -X POST "https://api.neo.khulnasoft.com/api/fim/completions" \
  -H "Authorization: Bearer $NEO_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
