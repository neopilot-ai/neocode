---
title: "Usage & Billing"
description: "Understand how the Neo AI Gateway tracks costs, manages balances, and enforces organization-level spending controls."
---

# Usage & Billing

The Neo AI Gateway tracks usage and costs for every request with microdollar precision (1 USD = 1,000,000 microdollars). This enables accurate billing even for very low-cost requests.
...
- **BYOK requests**: When using your own API key, the cost is set to $0 on Neo's side. You pay the provider directly based on your agreement with them

## Balance management

### Individual accounts

Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Neo dashboard](https://app.neo.khulnasoft.com).
...
```json
{
  "error": {
    ...
    "code": 402,
    "metadata": {
      "buyCreditsUrl": "https://app.neo.khulnasoft.com/credits"
    }
  }
}
```
