...
description: "Connect your NeoClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your NeoClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Neo-Agent-Vault`).
...
## Step 3: Configure NeoClaw

1. Navigate to your NeoClaw dashboard: [app.neo.khulnasoft.com/claw](https://app.neo.khulnasoft.com/claw).
