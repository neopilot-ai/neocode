---
title: "Telegram"
description: "Use NeoClaw with Telegram: setup, DM access control, and group chat configuration"
---

# Telegram

This page covers everything you need to use NeoClaw with Telegram: connecting your bot and adding it to group chats.

## Connecting NeoClaw to Telegram

{% youtube url="https://youtu.be/hIfKz073hGw" title="Telegram Setup Guide" caption="How to connect your NeoClaw agent to Telegram" /%}

Create a bot via BotFather and link it to your NeoClaw dashboard.

1. Open Telegram and search for [@BotFather](https://t.me/BotFather)
2. Send `/newbot` and follow the prompts to create your bot
3. Copy the **Bot Token** that BotFather gives you
4. Go to the **Settings** tab on your [NeoClaw dashboard](/docs/neoclaw/dashboard)
5. Paste the token into the **Telegram Bot Token** field
6. Click **Save**
7. Redeploy your NeoClaw instance
8. Send a direct message to your bot in Telegram: `/start`

{% image src="/docs/img/neoclaw/telegram.png" alt="Connect account screen" width="800" caption="Telegram bot token entry" /%}

You can remove or replace a configured token at any time.

## Adding NeoClaw to a Telegram Group Chat

By default, NeoClaw will not participate in a group chat, even if added. If you would like to use your NeoClaw in a group chat, you must configure the NeoClaw settings.
...
Tell your NeoClaw bot to add the group to its configuration. You can do this via DM:
