...
description: "How NeoClaw instances are structured"
---

# Architecture Notes

For advanced users — how NeoClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Neo controller.
