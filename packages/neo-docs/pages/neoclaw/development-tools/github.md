...
description: "Connect a GitHub account to your NeoClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your NeoClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
NeoClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `neoclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in NeoClaw
...
NeoClaw accepts both GitHub token formats:
...
When your instance starts, NeoClaw automatically:
...
- Tokens are encrypted at rest using NeoClaw's secret management system
