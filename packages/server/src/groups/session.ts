...
import { LocationMiddleware } from "./location" // neocode_change
...
export const SessionGroup = HttpApiGroup.make("server.session")
  ...
  .add(
    HttpApiEndpoint.post("session.create", "/api/session", {
      ...
      .middleware(LocationMiddleware) // neocode_change - use the SDK's configured directory when payload location is omitted
      .annotateMerge(
        OpenApi.annotations({
