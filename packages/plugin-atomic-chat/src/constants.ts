/** Provider id and `neo.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = "[@neocode/plugin-atomic-chat]" as const

export const ATOMIC_CHAT_PLUGIN = "@neocode/plugin-atomic-chat" as const
