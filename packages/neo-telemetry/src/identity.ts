...
import { fetchProfile } from "@neocode/neo-gateway"
...
export namespace Identity {
  ...
  export async function getMachineId(): Promise<string | undefined> {
    ...
    const override = process.env.NEO_MACHINE_ID
    if (override) {
      machineId = override
      return machineId
    }
  ...
  export async function updateFromNeoAuth(token: string | null, accountId?: string): Promise<void> {
