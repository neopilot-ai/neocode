...
export function ServersRoute() {
  ...
  return (
    ...
    >
      <ConfigToolbar
        title="Server Sync"
        description="Register global Neo server endpoints and choose which ones receive configuration updates."
      ...
      <Card class="server-table-card">
        ...
        <div class="server-table" role="table" aria-label="Connected Neo servers">
