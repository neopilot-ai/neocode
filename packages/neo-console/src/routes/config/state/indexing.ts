...
import { isFileExtension } from "@neocode/neo-indexing/file-extensions"

export { parseFileExtensions } from "@neocode/neo-indexing/file-extensions"
...
export function providerPatch(provider: IndexingConfig["provider"] | "", model?: string): IndexingConfig {
  return {
    ...
    model: provider === "neo" ? model || undefined : undefined,
    dimension: undefined,
  }
}
