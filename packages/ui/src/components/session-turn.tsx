...
import type { SessionStatus } from "@neocode/sdk/v2"
...
export function SessionTurn(
  ...
  const pending = createMemo(() => {
    if (typeof props.active === "boolean" && typeof props.queued === "boolean") return // neocode_change
    const messages = allMessages() ?? emptyMessages
  ...
  // neocode_change start — restore queued feature
  ...
  const showThinking = createMemo(() => {
    ...
    if (queued()) return false // neocode_change
