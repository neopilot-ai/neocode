...
export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abbonati a Neo Go per un accesso affidabile ai migliori modelli open source, a partire da $5 al mese.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} di {{total}} righe mantenute", // neocode_change
  "ui.tool.list": "Elenco",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
