export const dict: Record<string, string> = {
  ...
  "ui.fileMedia.state.unavailable": "Попередній перегляд {{kind}} недоступний.", // neocode_change
  ...
  "ui.sessionTurn.retry.retrying": "повтор спроби", // neocode_change
  "ui.sessionTurn.retry.inSeconds": "через {{seconds}}с", // neocode_change
  "ui.sessionTurn.retry.attempt": "спроба №{{attempt}}",
  "ui.sessionTurn.retry.attemptLine": "{{line}} — спроба №{{attempt}}",
  "ui.sessionTurn.retry.geminiHot": "Gemini зараз перевантажений", // neocode_change
  ...
  // neocode_change start - complete upstream usage-exceeded translations
  "dialog.usageExceeded.freeTier.title": "Досягнуто безкоштовного ліміту",
  "dialog.usageExceeded.freeTier.description":
    "Підпишіться на Neo Go, щоб отримати надійний доступ до найкращих моделей із відкритим кодом, від $5 на місяць.",
  ...
  "ui.messagePart.title.write": "Записати", // neocode_change
  "ui.messagePart.option.typeOwnAnswer": "Введіть власну відповідь",
  "ui.messagePart.review.title": "Перегляньте свої відповіді", // neocode_change
  ...
  // neocode_change end
  "ui.scrollView.ariaLabel": "вміст з прокруткою", // neocode_change

  "ui.tool.read": "Читання",
  "ui.tool.loaded": "Завантажено",
  "ui.tool.swePruned": "SWE-Pruner · збережено {{kept}} з {{total}} рядків", // neocode_change
  "ui.tool.list": "Список",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
  "ui.tool.task": "Завдання",
  "ui.tool.webfetch": "Веб-запит", // neocode_change
  "ui.tool.websearch": "Веб-пошук",
  "ui.tool.codesearch": "Пошук коду", // neocode_change
  ...
  "ui.patch.action.patched": "Застосовано патч", // neocode_change

  "ui.question.subtitle.answered": "{{count}} відповідей",
  "ui.question.subtitle.dismissed": "{{count}} dismissed", // neocode_change
  "ui.question.answer.none": "(немає відповіді)",
  "ui.question.answer.dismissed": "Dismissed", // neocode_change
