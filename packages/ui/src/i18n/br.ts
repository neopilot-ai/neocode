export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Assine o Neo Go para ter acesso confiável aos melhores modelos open-source, a partir de $5/mês.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} de {{total}} linhas mantidas", // neocode_change
  "ui.tool.list": "Listar",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
