...
import { Tooltip, TooltipKeybind } from "@neocode-ai/ui/tooltip"
import { ResizeHandle } from "@neocode-ai/ui/resize-handle"
import { Tabs } from "@neocode-ai/ui/tabs"
import { useCodeComponent } from "@neocode-ai/ui/context/code"
import { LineComment as LineCommentView, LineCommentEditor } from "@neocode-ai/ui/line-comment"
import { SessionTurn } from "@neocode-ai/ui/session-turn"
import { BasicTool } from "@neocode-ai/ui/basic-tool"
import { createAutoScroll } from "@neocode-ai/ui/hooks"
import { SessionReview } from "@neocode-ai/ui/session-review"
import { Mark } from "@neocode-ai/ui/logo"
...
import { checksum, base64Encode } from "@neocode-ai/util/encode"
...
import { UserMessage } from "@neocode-ai/sdk/v2"
import type { FileDiff } from "@neocode-ai/sdk/v2/client"
...
export default function Page() {
  ...
  createEffect(() => {
    const sessionID = params.id
    if (!sessionID) return
    const raw = sessionStorage.getItem("neocode.pendingMessage")
    if (!raw) return
    ...
    sessionStorage.removeItem("neocode.pendingMessage")
