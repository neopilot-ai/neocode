...
import { useTheme } from "@neocode-ai/ui/theme"
  ...
  return (
    ...
    >
      ...
      <div class="min-w-0 flex items-center justify-center pointer-events-none lg:absolute lg:inset-0 lg:flex lg:items-center lg:justify-center">
        <div id="neocode-titlebar-center" class="pointer-events-auto w-full min-w-0 flex justify-center lg:w-fit" />
      </div>
      ...
      <div
        ...
        onMouseDown={drag}
      >
        <div id="neocode-titlebar-right" class="flex items-center gap-3 shrink-0 justify-end" />
        <Show when={windows()}>
