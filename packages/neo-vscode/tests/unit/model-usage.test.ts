...
const models = [
  { providerID: "neo", modelID: "qwen/qwen3.7-plus-20260602", steps: 1, cost: 0.01, tokens },
...
describe("model usage", () => {
  test("groups billing routes and resolves compact catalog names", () => {
    ...
    expect(groupModelUsage(models, providers).map((group) => group.providerName)).toEqual(["Neo Gateway", "MiniMax"])
