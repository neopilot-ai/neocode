...
describe("getChatAutocompleteModel", () => {
  it("uses the matching FIM model for Next Edit settings", () => {
    expect(getChatAutocompleteModel("neo", "inception/mercury-next-edit").id).toBe("neo/inception/mercury-edit-2")
  ...
  it("keeps FIM settings unchanged", () => {
    expect(getChatAutocompleteModel("neo", "mistralai/codestral-2508").id).toBe("neo/mistralai/codestral-2508")
  })
})
