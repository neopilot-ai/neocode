 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, neo-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @neocode/neo-ui)
...
// Layer 3: neo-i18n overrides
import { dict as neoEn } from "../../../neo-i18n/src/en"
import { dict as neoZh } from "../../../neo-i18n/src/zh"
import { dict as neoZht } from "../../../neo-i18n/src/zht"
import { dict as neoKo } from "../../../neo-i18n/src/ko"
import { dict as neoDe } from "../../../neo-i18n/src/de"
import { dict as neoEs } from "../../../neo-i18n/src/es"
import { dict as neoFr } from "../../../neo-i18n/src/fr"
import { dict as neoDa } from "../../../neo-i18n/src/da"
import { dict as neoJa } from "../../../neo-i18n/src/ja"
import { dict as neoPl } from "../../../neo-i18n/src/pl"
import { dict as neoRu } from "../../../neo-i18n/src/ru"
import { dict as neoAr } from "../../../neo-i18n/src/ar"
import { dict as neoNo } from "../../../neo-i18n/src/no"
import { dict as neoBr } from "../../../neo-i18n/src/br"
import { dict as neoTh } from "../../../neo-i18n/src/th"
import { dict as neoBs } from "../../../neo-i18n/src/bs"
import { dict as neoTr } from "../../../neo-i18n/src/tr"
import { dict as neoNl } from "../../../neo-i18n/src/nl"
import { dict as neoUk } from "../../../neo-i18n/src/uk"
import { dict as neoIt } from "../../../neo-i18n/src/it"
...
const neoLocales: Record<string, Record<string, string>> = {
  en: neoEn,
  zh: neoZh,
  zht: neoZht,
  ko: neoKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...neoEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("neo-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(neoEn, neoLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing neo-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
