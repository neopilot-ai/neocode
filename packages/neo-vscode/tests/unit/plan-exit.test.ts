...
describe("planDisplayPath", () => {
  it("returns a relative path unchanged", () => {
    expect(planDisplayPath(".neo/plans/my-plan.md", "/repo")).toBe(".neo/plans/my-plan.md")
  })

  it("returns absolute path inside repo as repo-relative", () => {
    expect(planDisplayPath("/repo/.neo/plans/my-plan.md", "/repo")).toBe(".neo/plans/my-plan.md")
  })
  ...
  it("handles Windows absolute paths inside root", () => {
    expect(planDisplayPath("C:\\repo\\.neo\\plans\\plan.md", "C:\\repo")).toBe(".neo\\plans\\plan.md")
  })
