...
- Consider reusing neo-ui's `MessageNav` component
- Evaluate whether CLI session undo/redo/revert maps to Neo's checkpoint model or if extension needs its own git-based implementation
