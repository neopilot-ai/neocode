...
**Priority:** P0
**Issue:** [#6083](https://github.com/Neopilot-Ai/neocode/issues/6083)
...
- Check if both versions attempt to spawn `neo serve` simultaneously causing port/race conflicts
