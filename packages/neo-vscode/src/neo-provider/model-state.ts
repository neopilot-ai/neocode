 ...
 *
 * Reads/writes ~/.local/state/neo/model.json (same file the CLI TUI uses)
...
async function resolve(client: NeoClient | null): Promise<string | undefined> {
...
async function read(client: NeoClient | null): Promise<Record<string, unknown>> {
...
function write(client: NeoClient | null, key: string, value: unknown): Promise<void> {
...
export async function reset(client: NeoClient | null, post: PostMessage): Promise<void> {
