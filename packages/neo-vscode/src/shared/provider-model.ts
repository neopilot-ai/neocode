export const NEO_PROVIDER_ID = "neo"
export const NEO_AUTO = { providerID: NEO_PROVIDER_ID, modelID: "neo-auto/free" } as const
...
export function createNeoFallbackProvider() {
  return {
    id: NEO_PROVIDER_ID,
    name: "Neo Gateway",
