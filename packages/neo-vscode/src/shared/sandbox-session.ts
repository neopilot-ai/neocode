...
export const SANDBOX_METADATA_KEY = "neocode.sandbox"
...
export async function sandboxDefault(preference: SandboxPreference | undefined, client: NeoClient, directory: string) {
