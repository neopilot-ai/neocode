 ...
 * ## Why this exists
 *
 * The sidebar NeoProvider always uses `getWorkspaceDirectory()`, which returns
 ...
 *
 * ## How NeoProvider uses this
 *
 * Each NeoProvider instance can receive an explicit `projectDirectory` via
 * `NeoProviderOptions`. When set:
 *
...
/**
 * Resolve the effective project directory for a NeoProvider instance.
 *
 * @param override - Explicit directory from NeoProviderOptions. `undefined`
 ...
 *   `getWorkspaceDirectory(sessionId)` from NeoProvider).
 */
