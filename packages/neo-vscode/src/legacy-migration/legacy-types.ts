/**
 * legacy-migration - Types for legacy Neo Code extension (v5.x) data structures.
 *
 * These types represent the shapes stored in VS Code SecretStorage and on disk
 * by the legacy extension (neocode.neo-code v5.x, a Roo Code fork).
...
// ---------------------------------------------------------------------------
// Settings (stored in VS Code globalState under "neo-code.*" keys)
// ---------------------------------------------------------------------------
