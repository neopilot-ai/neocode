...
const AM_PREFIX = "neo-code.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "neo-code.new.agentManagerOpen": "agentManagerOpen",
  "neo-code.new.cycleAgentMode": "cycleAgentMode",
  "neo-code.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
