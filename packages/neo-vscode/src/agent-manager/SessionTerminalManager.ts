...
export class SessionTerminalManager {
  ...
  constructor(
    ...
    this.disposables.push(
      ...
      host.onActiveTerminalChanged((terminal) => {
        ...
        void host.setContext("neo-code.agentTerminalFocus", managed)
      }),
    )
  ...
  dispose(): void {
    void this.host.setContext("neo-code.agentTerminalFocus", false)
  ...
  private updateContextKey(): void {
    ...
    void this.host.setContext("neo-code.agentTerminalFocus", managed)
  }
