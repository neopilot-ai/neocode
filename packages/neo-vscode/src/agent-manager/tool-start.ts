...
export interface ToolDeps {
  ...
  sessionMetadata: (client: NeoClient, dir: string) => Promise<Record<string, unknown>>
...
async function prompt(client: NeoClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: NeoClient, task: ToolTask, directory?: string, source?: ToolSource) {
