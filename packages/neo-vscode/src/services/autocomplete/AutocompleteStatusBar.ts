...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Neo Gateway"
const SETTINGS_COMMAND = `command:neo-code.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("neocode:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("neocode:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("neocode:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("neocode:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("neocode:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("neocode:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("neocode:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("neocode:autocomplete.statusBar.tooltip.noUsableProvider", {
