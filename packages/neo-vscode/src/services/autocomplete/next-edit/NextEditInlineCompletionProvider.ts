...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "neo-code.new.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local Neo gateway (handles auth + BYOK). */
  connectionService: NeoConnectionService
  /** Optional source of recently-viewed snippets (neocode's VisibleCodeTracker can adapt to this). */
