...
async function loadLanguageForFileExt(fileExtension: string): Promise<Language> {
  ...
  // In production (compiled): __dirname = /path/to/neocode/src/dist or dist/
  // In development: __dirname = /path/to/neocode/src/services/autocomplete/continuedev/core/util
  const candidatePaths: string[] = [
