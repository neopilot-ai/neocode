...
export class InstallationDetector {
   ...
   *
   * Agents are detected from .neo/agents/*.md files.
   * MCP servers and modes are detected from neo.json config files.
  ...
  /** Scan .neo/agents/*.md files to detect installed marketplace agents. */
  ...
  /** Read mcp and agent entries from a neo.json config file. */
