...
import { NeoConnectionService } from "./connection-service"
...
describe("NeoConnectionService sandbox preference", () => {
  test("uses workspace state instead of extension-global state", () => {
    const service = new NeoConnectionService({
...
describe("NeoConnectionService clients", () => {
  test("returns a connected client without a workspace folder", async () => {
    const service = new NeoConnectionService({} as any)
    const client = {}
...
describe("NeoConnectionService viewed sessions", () => {
...
describe("NeoConnectionService drainPendingPrompts", () => {
