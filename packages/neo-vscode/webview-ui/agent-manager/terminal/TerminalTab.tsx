...
export const TerminalTab: Component<Props> = (props) => {
  ...
  const log = (...args: unknown[]) => console.warn(`[Neo New][XTerm][${props.terminalId}]`, ...args)
  ...
  onMount(() => {
    ...
    // `NeoProvider.handleWebviewMessage` path which already calls
    ...
    const fontSub = vscode.onMessage((message) => {
      ...
      // fontSizeChanged/ready control the Neo chat UI font — do not apply
