...
import { DialogProvider, useDialog } from "@neocode/neo-ui/context/dialog"
import { Dialog } from "@neocode/neo-ui/dialog"
import { DropdownMenu } from "@neocode/neo-ui/dropdown-menu"
...
import { Toast, showToast } from "@neocode/neo-ui/toast"
import { ResizeHandle } from "@neocode/neo-ui/resize-handle"
import { Icon } from "@neocode/neo-ui/icon"
import { Button } from "@neocode/neo-ui/button"
import { IconButton } from "@neocode/neo-ui/icon-button"
import { Spinner } from "@neocode/neo-ui/spinner"
import { Tooltip, TooltipKeybind } from "@neocode/neo-ui/tooltip"
import { Popover } from "@neocode/neo-ui/popover"
...
import { NeoEmbeddingModelsProvider } from "../src/context/neo-embedding-models"
  ...
  onMount(() => {
    ...
    const unsub = vscode.onMessage((msg) => {
      ...
      if (msg.type === "agentManager.state") {
        ...
        // When not a git repo, also mark sessions as loaded since the Neo
      ...
      // to send the prompt through the normal NeoProvider sendMessage path.
