// NeoClaw lightweight language context
//
// Self-contained i18n for the NeoClaw panel. Does not depend on
...
export function NeoClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useNeoClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useNeoClawLanguage must be used within NeoClawLanguageProvider")
  return ctx
}
