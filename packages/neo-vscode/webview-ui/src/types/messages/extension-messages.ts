...
import type { BrowserSettings, Config, FeatureFlags, IndexingStatus, NeoEmbeddingModelCatalog } from "./config"
import type { WorkStyle, WorkStyleState } from "../../../../src/shared/work-style-presets"
import type { NeocodeNotification, ProfileData } from "./profile"
import type {
...
export interface SelectNeoModelMessage {
  type: "selectNeoModel"
  modelID?: string
  agent?: string
}
...
export interface NeoEmbeddingModelsLoadedMessage {
  type: "neoEmbeddingModelsLoaded"
  catalog: NeoEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | NeoEmbeddingModelsLoadedMessage
