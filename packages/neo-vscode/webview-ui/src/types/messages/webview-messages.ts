...
export interface OpenConfigFileRequest {
  ...
  labels: {
    ...
    openFailed: string
    sourceXdg: string
    sourceHomeNeo: string
    sourceHomeNeocode: string
    sourceHomeOpencode: string
    sourceEnvFile: string
    sourceEnvDir: string
    sourceEnvContent: string
    sourceProjectNeo: string
    sourceProjectRoot: string
    sourceProjectNeocode: string
...
export interface OpenNeoClawRequest {
  type: "openNeoClaw"
}
...
export interface RequestNeoEmbeddingModelsMessage {
  type: "requestNeoEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  /** Global config patch written to ~/.config/neo/neo.json. */
  config: Partial<Config>
  globalUnset?: string[][]
  /** Project config patch written to the workspace's .neo/neo.jsonc or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestNeoEmbeddingModelsMessage
  | UpdateConfigMessage
