import type { NeocodeSessionModelUsageResponse } from "@neocode/sdk/v2"
import type { Part, TokenUsage } from "./parts"

export type SessionModelUsage = NeocodeSessionModelUsageResponse
...
// Cloud session info (from Neo cloud API)
