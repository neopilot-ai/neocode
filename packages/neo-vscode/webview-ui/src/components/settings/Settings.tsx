...
import { Tabs } from "@neocode/neo-ui/tabs"
import { Button } from "@neocode/neo-ui/button"
import { Tooltip } from "@neocode/neo-ui/tooltip"
...
import AboutneocodeTab from "./AboutneocodeTab"
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  const open = (scope: "local" | "global") => {
    ...
    vscode.postMessage({
      ...
      labels: {
        ...
        sourceHomeNeo: language.t("settings.config.source.homeNeo"),
        sourceHomeNeocode: language.t("settings.config.source.homeNeocode"),
        ...
        sourceProjectNeo: language.t("settings.config.source.projectNeo"),
        sourceProjectRoot: language.t("settings.config.source.projectRoot"),
        sourceProjectNeocode: language.t("settings.config.source.projectNeocode"),
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      ...
      >
        <h2 style={{ "font-size": "var(--neo-font-size-16)", "font-weight": "600", margin: 0, flex: 1 }}>
      ...
      >
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutneocode" aria-label={language.t("settings.aboutneocode.title")}>
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutneocode.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutneocode">
          <h3>{language.t("settings.aboutneocode.title")}</h3>
          <AboutneocodeTab
