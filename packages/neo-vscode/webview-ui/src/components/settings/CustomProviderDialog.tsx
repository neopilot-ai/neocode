    ...
    >
      ...
      >
        <div style={{ padding: "0 10px", display: "flex", gap: "16px", "align-items": "center" }}>
          ...
          <div
            style={{ "font-size": "var(--neo-font-size-16)", "font-weight": "500", color: "var(--vscode-foreground)" }}
          >
        ...
        >
          <div style={{ "font-size": "var(--neo-font-size-14)", color: "var(--text-base)" }}>
            {language.t("provider.custom.description.prefix")}
            <a
              href="https://neo.khulnasoft.com/docs/ai-providers#custom-provider"
              onClick={(e) => {
                e.preventDefault()
                vscode.postMessage({
                  type: "openExternal",
                  url: "https://neo.khulnasoft.com/docs/ai-providers#custom-provider",
                })
              }}
            >
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
            ...
            <Show when={fetchError()}>
              {(err) => (
                <span
                  style={{ "font-size": "var(--neo-font-size-12)", color: "var(--vscode-errorForeground, #f14c4c)" }}
                >
                  {err()}
                </span>
              )}
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
            <label
              style={{ "font-size": "var(--neo-font-size-12)", "font-weight": "500", color: "var(--text-weak-base)" }}
            >
