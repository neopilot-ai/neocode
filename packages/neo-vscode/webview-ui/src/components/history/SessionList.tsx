 ...
 * Uses neo-ui List component for keyboard navigation and accessibility.
...
import { ContextMenu } from "@neocode/neo-ui/context-menu"
...
const SessionList: Component<SessionListProps> = (props) => {
  ...
  onMount(() => {
    console.log("[Neo New] SessionList mounted, loading sessions")
