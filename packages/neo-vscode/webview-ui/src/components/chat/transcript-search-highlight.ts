 ...
 * using the CSS Custom Highlight API (same technique as neo-ui's code find
...
const MATCH_NAME = "neo-transcript-search-match"
const ACTIVE_NAME = "neo-transcript-search-match-active"
