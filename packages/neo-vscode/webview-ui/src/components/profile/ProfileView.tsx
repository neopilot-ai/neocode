...
const ProfileView: Component<ProfileViewProps> = (props) => {
  ...
  const handleDashboard = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.neo.khulnasoft.com/profile" })
  }

  const handleTopUp = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.neo.khulnasoft.com/credits" })
  }

  const handleGetPass = () => {
    vscode.postMessage({ type: "openExternal", url: "https://neo.khulnasoft.com/pricing/neo-pass" })
  }
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%" }}>
      ...
      >
        <h2 style={{ "font-size": "var(--neo-font-size-16)", "font-weight": "600", margin: 0 }}>
            ...
            <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
              ...
              <Show when={orgOptions().length > 0}>
                <Card>
                  <p
                    style={{
                      "font-size": "var(--neo-font-size-11)",
                  ...
                  <Card style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
                    <div style={{ display: "flex", "align-items": "center", "justify-content": "space-between" }}>
                      <div>
                        ...
                        <p
                          style={{
                            "font-size": "var(--neo-font-size-18)",
                            "font-weight": "600",
                            color: "var(--vscode-foreground)",
                            margin: 0,
                          }}
                    ...
                    {/* Neo Pass is part of personal credits, so only show it on the personal account */}
                    <Show
                      when={
                    ...
                    >
                      {(pass) => (
                        ...
                        >
                          ...
                          >
                            <span style={{ "font-weight": "600", color: "var(--vscode-foreground)" }}>Neo Pass</span>
                    ...
                    {/* No active Neo Pass on the personal account — nudge to subscribe */}
                    <Show
                      when={
