...
// ---------------------------------------------------------------------------
// NeoLogo — replicates the pattern from MessageList.tsx
// ---------------------------------------------------------------------------
...
const NeoLogo = (): JSX.Element => {
  ...
  const icon = isLight ? "neo-light.svg" : "neo-dark.svg"
  return (
    <div class="migration-wizard__logo">
      <img src={`${iconsBaseUri}/${icon}`} alt="Neo Code" />
    </div>
  )
}
      ...
      <div class="migration-wizard__container">
        ...
        <div class={screen() === "whats-new" ? "migration-wizard__screen--active" : "migration-wizard__screen--hidden"}>
          ...
          <div class="migration-wizard__blog-link">
            <a href="https://blog.neo.khulnasoft.com/p/new-neo-for-vs-code-is-live">
              {language.t("migration.whatsNew.blogLink")} <span>&rarr;</span>
            </a>
            <a href="https://neo.khulnasoft.com/docs/code-with-ai/platforms/vscode/whats-new">
