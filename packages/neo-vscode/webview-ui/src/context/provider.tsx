...
import type { ProviderAuthMethod } from "@neocode/sdk/v2/client"
import { flattenModels, findModel as _findModel, isModelValid as isValid } from "./provider-utils"
import { NEO_AUTO } from "../../../src/shared/provider-model"
...
export const ProviderProvider: ParentComponent = (props) => {
  ...
  const [defaultSelection, setDefaultSelection] = createSignal<ModelSelection>(NEO_AUTO)
