...
export const ServerProvider: ParentComponent = (props) => {
  ...
  onMount(() => {
    const unsubscribe = vscode.onMessage((message: ExtensionMessage) => {
      switch (message.type) {
        case "ready":
          console.log("[Neo New] Server ready:", message.serverInfo)
        ...
        case "connectionState":
          console.log("[Neo New] Connection state changed:", message.state)
        ...
        case "error":
          console.error("[Neo New] Server error:", message.message)
          setErrorMessage(message.message)
          setErrorDetails(message.message)
          break

        case "profileData":
          console.log("[Neo New] Profile data:", message.data ? "received" : "null")
          setProfileData(message.data)
          break

        case "deviceAuthStarted":
          console.log("[Neo New] Device auth started")
          setDeviceAuth({
            status: "pending",
            code: message.code,
        ...
        case "deviceAuthComplete":
          console.log("[Neo New] Device auth complete")
        ...
        case "deviceAuthFailed":
          console.log("[Neo New] Device auth failed:", message.error)
          setDeviceAuth({ status: "error", error: message.error })
          break

        case "deviceAuthCancelled":
          console.log("[Neo New] Device auth cancelled")
    ...
    console.log("[Neo New] Webview ready")
   ...
   * outside the Profile page — e.g. the Neo Gateway card in the Providers
