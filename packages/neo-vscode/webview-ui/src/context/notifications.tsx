...
import type { NeocodeNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<NeocodeNotification[]>
  filteredNotifications: Accessor<NeocodeNotification[]>
...
export const NotificationsProvider: ParentComponent = (props) => {
  ...
  const [notifications, setNotifications] = createSignal<NeocodeNotification[]>([])
