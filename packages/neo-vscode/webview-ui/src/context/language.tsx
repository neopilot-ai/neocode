/**
 * Language context
 * Provides i18n translations for neo-ui components.
 * Merges UI translations from @opencode-ai/ui and Neo overrides from @neocode/neo-i18n.
 *
...
import { I18nProvider } from "@neocode/neo-ui/context"
import type { UiI18nKey, UiI18nParams } from "@neocode/neo-ui/context"
import { dict as uiEn } from "@neocode/neo-ui/i18n/en"
import { dict as uiZh } from "@neocode/neo-ui/i18n/zh"
import { dict as uiZht } from "@neocode/neo-ui/i18n/zht"
import { dict as uiKo } from "@neocode/neo-ui/i18n/ko"
import { dict as uiDe } from "@neocode/neo-ui/i18n/de"
import { dict as uiEs } from "@neocode/neo-ui/i18n/es"
import { dict as uiFr } from "@neocode/neo-ui/i18n/fr"
import { dict as uiDa } from "@neocode/neo-ui/i18n/da"
import { dict as uiJa } from "@neocode/neo-ui/i18n/ja"
import { dict as uiPl } from "@neocode/neo-ui/i18n/pl"
import { dict as uiRu } from "@neocode/neo-ui/i18n/ru"
import { dict as uiAr } from "@neocode/neo-ui/i18n/ar"
import { dict as uiNo } from "@neocode/neo-ui/i18n/no"
import { dict as uiBr } from "@neocode/neo-ui/i18n/br"
import { dict as uiTh } from "@neocode/neo-ui/i18n/th"
import { dict as uiBs } from "@neocode/neo-ui/i18n/bs"
import { dict as uiTr } from "@neocode/neo-ui/i18n/tr"
import { dict as uiNl } from "@neocode/neo-ui/i18n/nl"
import { dict as uiUk } from "@neocode/neo-ui/i18n/uk"
import { dict as uiIt } from "@neocode/neo-ui/i18n/it"
...
import { dict as neoEn } from "@neocode/neo-i18n/en"
import { dict as neoZh } from "@neocode/neo-i18n/zh"
import { dict as neoZht } from "@neocode/neo-i18n/zht"
import { dict as neoKo } from "@neocode/neo-i18n/ko"
import { dict as neoDe } from "@neocode/neo-i18n/de"
import { dict as neoEs } from "@neocode/neo-i18n/es"
import { dict as neoFr } from "@neocode/neo-i18n/fr"
import { dict as neoDa } from "@neocode/neo-i18n/da"
import { dict as neoJa } from "@neocode/neo-i18n/ja"
import { dict as neoPl } from "@neocode/neo-i18n/pl"
import { dict as neoRu } from "@neocode/neo-i18n/ru"
import { dict as neoAr } from "@neocode/neo-i18n/ar"
import { dict as neoNo } from "@neocode/neo-i18n/no"
import { dict as neoBr } from "@neocode/neo-i18n/br"
import { dict as neoTh } from "@neocode/neo-i18n/th"
import { dict as neoBs } from "@neocode/neo-i18n/bs"
import { dict as neoTr } from "@neocode/neo-i18n/tr"
import { dict as neoNl } from "@neocode/neo-i18n/nl"
import { dict as neoUk } from "@neocode/neo-i18n/uk"
import { dict as neoIt } from "@neocode/neo-i18n/it"
...
// Merge 4 dict layers: app + ui + neo + agent manager (neo and agent manager override last)
const base = { ...appEn, ...uiEn, ...neoEn }
const dicts: Record<Locale, Record<string, string>> = {
  en: { ...base, ...amEn },
  zh: { ...base, ...appZh, ...uiZh, ...neoZh, ...amEn, ...amZh },
  zht: { ...base, ...appZht, ...uiZht, ...neoZht, ...amEn, ...amZht },
  ko: { ...base, ...appKo, ...uiKo, ...neoKo, ...amEn, ...amKo },
  de: { ...base, ...appDe, ...uiDe, ...neoDe, ...amEn, ...amDe },
  es: { ...base, ...appEs, ...uiEs, ...neoEs, ...amEn, ...amEs },
  fr: { ...base, ...appFr, ...uiFr, ...neoFr, ...amEn, ...amFr },
  da: { ...base, ...appDa, ...uiDa, ...neoDa, ...amEn, ...amDa },
  ja: { ...base, ...appJa, ...uiJa, ...neoJa, ...amEn, ...amJa },
  pl: { ...base, ...appPl, ...uiPl, ...neoPl, ...amEn, ...amPl },
  ru: { ...base, ...appRu, ...uiRu, ...neoRu, ...amEn, ...amRu },
  ar: { ...base, ...appAr, ...uiAr, ...neoAr, ...amEn, ...amAr },
  no: { ...base, ...appNo, ...uiNo, ...neoNo, ...amEn, ...amNo },
  br: { ...base, ...appBr, ...uiBr, ...neoBr, ...amEn, ...amBr },
  th: { ...base, ...appTh, ...uiTh, ...neoTh, ...amEn, ...amTh },
  bs: { ...base, ...appBs, ...uiBs, ...neoBs, ...amEn, ...amBs },
  tr: { ...base, ...appTr, ...uiTr, ...neoTr, ...amEn, ...amTr },
  nl: { ...base, ...appNl, ...uiNl, ...neoNl, ...amEn, ...amNl },
  uk: { ...base, ...appUk, ...uiUk, ...neoUk, ...amEn, ...amUk },
  it: { ...base, ...appIt, ...uiIt, ...neoIt, ...amEn, ...amIt },
}
