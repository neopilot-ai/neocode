...
import { MemoryContract } from "@neocode/neo-memory/effect/httpapi"
...
export const UserMessageReviewComments: Story = {
  ...
  render: () => {
    const comments: ReviewComment[] = [
      {
        id: "review-1",
        file: "src/components/chat/NeoBackendChatManager.kt",
        side: "additions",
        line: 114,
      ...
      {
        id: "review-2",
        file: "resources/messages/NeoBundle_bs.properties",
        side: "deletions",
        line: 235,
  ...
  [toolAssistantID]: [
    ...
    },
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/neocode/.neo/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
...
const usageData = {
  ...
  models: [
    { providerID: "neo", modelID: "qwen/qwen3.7-plus-20260602", steps: 3, cost: 0.067214, tokens: usageTokens },
    {
      providerID: "minimax",
      modelID: "minimax-m3",
      steps: 1,
...
const usageProvider = {
  ...
  connected: () => ["neo", "minimax"],
  defaults: () => ({}),
  defaultSelection: () => ({ providerID: "neo", modelID: "qwen/qwen3.7-plus" }),
  models: () => [],
  findModel: () => undefined,
  authMethods: () => ({}),
  authStates: () => ({}),
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + NeoNotifications
// ---------------------------------------------------------------------------

const MOCK_NOTIFICATION = {
  id: "notif-1",
  title: "Try BYOK for Neo Gateway",
  message: "Bring your own API key for even more flexibility with Neo Gateway models.",
  action: { actionText: "Learn more", actionURL: "https://neo.khulnasoft.com/docs" },
}
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@neo.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "Neo Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
