...
import { writeToolOpen } from "../../../../neo-ui/src/components/tool-open-state"
...
const hits = [
  'packages/neo-ui/src/components/message-part.tsx:1847: <div data-component="tool-output">',
  'packages/neo-ui/src/components/basic-tool.css:250: [data-component="tool-output"]',
  "packages/neo-vscode/webview-ui/src/components/chat/VscodeToolOverrides.tsx:141: background process output",
].join("\n")
...
const proc = [
  ...
  "status: running",
  "cwd: /project",
  "command: bun run --cwd packages/neo-vscode storybook",
  "last_output:",
...
const gapPatch = [
  "===================================================================",
  "--- packages/neo-ui/src/components/message-part.css",
  "+++ packages/neo-ui/src/components/message-part.css",
  "@@ -560,5 +560,5 @@",
  ' html[data-theme="neo-vscode"] [data-component="reasoning-part"] {',
...
const writePatch = [
  "===================================================================",
  "--- packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "+++ packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "@@ -1,3 +1,4 @@",
  " /** @jsxImportSource solid-js */",
...
const permissions: PermissionRequest[] = [
  {
    ...
    always: ["bun *"],
    args: {
      command: "bun test packages/neo-vscode/tests/unit",
  ...
  },
  {
    ...
    sessionID: SID,
    toolName: "edit",
    patterns: ["packages/neo-ui/src/components/message-part.css"],
    always: ["packages/neo-ui/src/components/*"],
    args: {
      filediff: {
        file: "packages/neo-ui/src/components/message-part.css",
        patch: gapPatch,
        additions: 1,
        deletions: 1,
      },
...
const blocks: SDKPart[] = [
  ...
  bash(
    ...
    "matrix-call-bash",
    "Run visual check",
    "bun run --cwd packages/neo-vscode build-storybook",
    ...
    { outputPath: "/tmp/neo-tool-output.log" },
  ),
  done(
    "read",
    "read",
    { filePath: "packages/neo-ui/src/components/message-part.tsx", offset: 1788, limit: 80 },
    "Read tool renderers",
  ),
  done(
    "glob",
    "glob",
    { pattern: "webview-ui/src/**/*.tsx", path: "packages/neo-vscode" },
    "Find webview files",
    [
      "packages/neo-vscode/webview-ui/src/components/chat/AssistantMessage.tsx",
      "packages/neo-vscode/webview-ui/src/components/chat/QuestionDock.tsx",
    ].join("\n"),
  ),
  done(
    "grep",
    "grep",
    { pattern: "tool-collapsible", include: "*.css", path: "packages/neo-ui/src/components" },
    "Find gaps",
    hits,
  ),
  done(
  ...
  tool("matrix-edit", "matrix-call-edit", "edit", {
    status: "completed",
    input: {
      filePath: "packages/neo-ui/src/components/message-part.css",
      oldString: "gap: 4px;",
      newString: "gap: 8px;",
    },
    output: "",
    ...
    metadata: {
      ...
      diagnostics: {
        "/project/packages/neo-ui/src/components/message-part.css": [
          {
            severity: 2,
    ...
    "write",
    {
      filePath: "packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  ...
  tool("matrix-write", "matrix-call-write", "write", {
    ...
    metadata: {
      filediff: {
        file: "packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
        patch: writePatch,
        additions: 1,
        deletions: 0,
      },
  ...
  tool("matrix-patch", "matrix-call-patch", "apply_patch", {
    ...
    input: {
      patchText:
        "*** Begin Patch\n*** Update File: packages/neo-ui/src/components/message-part.css\n@@\n-gap: 4px;\n+gap: 8px;\n*** End Patch",
    },
    output: "",
    ...
    metadata: {
      files: [
        {
          filePath: "/project/packages/neo-ui/src/components/message-part.css",
          relativePath: "packages/neo-ui/src/components/message-part.css",
          type: "update",
          patch: gapPatch,
          diff: gapPatch,
          additions: 1,
        ...
        {
          filePath: "/project/packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          relativePath: "packages/neo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          type: "update",
          patch: writePatch,
          diff: writePatch,
          additions: 1,
  ...
  tool("matrix-task-explore", "matrix-call-task-explore", "task", {
    ...
    metadata: {
      parentSessionId: SID,
      sessionId: CHILD,
      model: { providerID: "neo", modelID: "anthropic/claude-sonnet-4-6" },
      truncated: false,
    },
  ...
  tool(
    ...
    "repo-clone",
    "repo_clone",
    { repository: "Neopilot-Ai/neocode" },
    "Clone repository",
    "Repository ready: Neopilot-Ai/neocode\nStatus: cached\nLocal path: /cache/neocode",
    { repository: "Neopilot-Ai/neocode", status: "cached", localPath: "/cache/neocode" },
  ),
  done(
    "repo-overview",
    "repo_overview",
    ...
    "Search codebase",
    "### packages/neo-ui/src/components/message-part.tsx\nThe registry selects a renderer by exact tool ID.",
    { count: 1 },
  ),
  done(
    "semantic-search",
    "semantic_search",
    { query: "tool renderer selection", path: "packages/neo-ui" },
    "Semantic code search",
    "Found 1 result in packages/neo-ui/src/components/message-part.tsx",
    {
      results: [
        {
          filePath: "packages/neo-ui/src/components/message-part.tsx",
          score: 0.92,
          startLine: 1210,
          endLine: 1220,
    ...
    "Legacy code search",
    "https://github.com/Neopilot-Ai/neocode/blob/main/packages/neo-ui/src/components/message-part.tsx",
  ),
  tool(
    "matrix-tool-hint",
    "matrix-call-tool-hint",
    "edit",
    failed({ filePath: "packages/neo-ui/src/components/message-part.css" }, "oldString and newString are identical"),
  ),
  tool(
    "matrix-tool-error",
...
for (const key of [
  ...
  "neo_local_recall:matrix-call-local-recall",
          ...
          <div class="tool-call-lab-search-previews">
            ...
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              ...
              <div class="tool-call-lab-stack">
                ...
                <div class="tool-call-lab-example">
                  ...
                  <StartupErrorBanner
                    errorMessage="Failed to start the Neo CLI"
                    errorDetails="spawn /path/to/neo ENOENT"
                  />
                </div>
              </div>
            </section>
            <section class="tool-call-lab-panel tool-call-lab-panel-wide">
              <div class="tool-call-lab-panel-header">
                ...
                <span class="tool-call-lab-panel-note">
                  Generic provider errors and Neo authentication or promotion actions.
                </span>
              </div>
              <div class="tool-call-lab-stack">
                <div class="tool-call-lab-example">
