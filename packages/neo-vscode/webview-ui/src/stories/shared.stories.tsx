  ...
  render: () => (
    <StoryProviders>
      <div style={{ display: "flex", "align-items": "center", gap: "8px" }}>
        <ModelSelectorBase
          value={{ providerID: "neo", modelID: "neo-auto/frontier" }}
          onSelect={() => {}}
...
const ACCESSIBLE_MODELS: EnrichedModel[] = [
  ...
  { id: "alpha", name: "Alpha", providerID: "neo", providerName: "Neo" },
  { id: "bravo", name: "Bravo", providerID: "neo", providerName: "Neo" },
  { id: "charlie", name: "Charlie", providerID: "neo", providerName: "Neo" },
  { id: "delta", name: "Delta", providerID: "neo", providerName: "Neo" },
  { id: "echo", name: "Echo", providerID: "neo", providerName: "Neo" },
...
const AccessibleModelSelector = () => {
  const [value, setValue] = createSignal<ModelSelection | null>({ providerID: "neo", modelID: "alpha" })
...
export const ModelSelectorSelectedFavorite: Story = {
  ...
  render: () => {
    const session = {
      ...mockSessionValue(),
      favoriteModels: () => [{ providerID: "neo", modelID: "alpha" }],
    }
