...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.signedOut": "请打开 Anaconda Desktop 并登录，然后再连接 Neo。",
  "provider.anaconda.state.unauthorized":
    "Neo 无法访问 Anaconda Desktop。请打开 Desktop，重新登录，并在需要时重新启动它。",
  ...
  "provider.anaconda.state.ready": "Neo 找到了一个健康的本地文本生成服务器，可以导入其当前的连接设置。",
  ...
  "provider.anaconda.toast.refreshed.description": "当前本地服务器和模型在 Neo 中已是最新。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo 无法检查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "Neo 无法检查 MCP 服务器状态。",
  "agentRequirements.error.scopeMismatch": "此代理要求检查已不再有效。",
  "agentRequirements.error.requestFailed": "Neo 无法检查代理要求。",
  ...
  "dialog.model.unpaid.freeModels.title": "Neo 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Neo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Neo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Neo 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 Neo 目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 Neo 目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 Neo 目录。",
  "prompt.action.sandbox.description.disabled": "点击以限制文件系统写入和网络访问。",
  "prompt.action.sandbox.description.disabledNetworkAllowed":
    "点击以限制文件系统写入。根据你的沙盒设置，网络访问仍然允许。",

  "speechToText.tooltip.start": "使用 Neo Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 Neo 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 Neo 服务器。",
  ...
  "toast.update.description": "Neo 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Neo 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Neo 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Neo 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Neo 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Neo 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Neo 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Neo 启动时自动检查更新",
  ...
  "settings.indexing.neoModel.title": "Neo 模型预设",
  "settings.indexing.neoModel.description": "选择受支持的 Neo 托管嵌入模型。",
  "settings.indexing.neoSignIn.title": "需要登录 Neo",
  "settings.indexing.neoSignIn.description": "登录 Neo 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Neo Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Neo 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Neo Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Neo 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Neo 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Neo 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeNeo": "主目录 .neo 配置",
  "settings.config.source.homeNeocode": "主目录 .neocode 配置",
  "settings.config.source.homeOpencode": "主目录 .opencode 配置",
  "settings.config.source.envFile": "NEO_CONFIG 环境变量文件",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectNeo": "项目 .neo 配置",
  "settings.config.source.projectRoot": "项目根目录配置",
  "settings.config.source.projectNeocode": "旧版 .neocode 配置",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo 会在工作过程中暂停并向你展示其计划。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 neo import 命令",
  ...
  "settings.aboutneocode.title": "关于 Neo Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Neo Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutneocode.status.connected": "已连接",
  "settings.aboutneocode.status.connecting": "连接中...",
  "settings.aboutneocode.status.disconnected": "已断开",
  "settings.aboutneocode.status.error": "错误",
  "settings.aboutneocode.cliServer": "CLI 服务器",
  "settings.aboutneocode.status.label": "状态：",
  "settings.aboutneocode.port.label": "端口：",
  "settings.aboutneocode.versionInfo": "版本信息",
  "settings.aboutneocode.version.label": "版本：",
  "settings.aboutneocode.extensionName": "Neo Code 扩展",
  "settings.aboutneocode.community": "社区与支持",
  "settings.aboutneocode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutneocode.feedback.or": "或",
  "settings.aboutneocode.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutneocode.resetSettings.title": "重置设置",
  "settings.aboutneocode.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutneocode.resetSettings.button": "重置所有设置",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "设置迁移",
  "settings.aboutneocode.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutneocode.exportSettings": "导出",
  "settings.aboutneocode.importSettings": "导入",
  "settings.aboutneocode.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutneocode.importSettings.invalidConfig": "文件不包含有效的 Neo 设置。",
  "settings.aboutneocode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutneocode.importSettings.newerVersion": "此文件由较新版本的 Neo 导出。部分设置可能会被忽略。",
  "settings.aboutneocode.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutneocode.telemetry.title": "遥测",
  "settings.aboutneocode.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutneocode.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Neo Code 界面的语言。',
  ...
  "settings.experimental.speechToText.description": "通过 Neo Gateway 使用您的 Neo 帐户在提示词字段中启用语音输入。",
  "settings.models.speechToText.disabledDescription":
    "启用并登录 Neo 提供商以使用 Speech to Text。Speech to Text 目前仅支持通过 Neo Gateway 使用。",
  "settings.models.speechToTextModel.title": "语音转文本模型",
  "settings.models.speechToTextModel.description": "选择用于语音输入的 Neo Gateway 转录模型。",
  ...
  "settings.experimental.remote.description": "通过 Neo Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Neo 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 neo.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Neo webview UI 的字体大小。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Neo 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Neo 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
