export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instalirajte Anaconda Desktop na ovom računaru, zatim se vratite ovdje. Neo ne pokreće instalacijski program umjesto vas.",
  ...
  "provider.anaconda.state.unauthorized":
    "Neo nije mogao pristupiti Anaconda Desktopu. Otvorite Desktop, ponovo se prijavite i ponovo ga pokrenite ako je potrebno.",
  ...
  "provider.anaconda.state.ready":
    "Neo je pronašao ispravan lokalni server za generisanje teksta i može uvesti njegove trenutne postavke veze.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo nije mogao provjeriti dostupne vještine.",
  "agentRequirements.error.mcpStatusFailed": "Neo nije mogao provjeriti status MCP servera.",
  "agentRequirements.error.scopeMismatch": "Ova provjera zahtjeva agenta više nije aktivna.",
  "agentRequirements.error.requestFailed": "Neo nije mogao provjeriti zahtjeve agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Neo",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Neo-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Neo-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Neo-u.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox je omogućen. Shell komande agenta su ograničene na direktorije projekta i Neo.",
  "prompt.action.sandbox.disabled":
    "Sandbox je onemogućen. Kliknite da ograničite pisanje shell komandi agenta na direktorije projekta i Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Pisanje je ograničeno na direktorije projekta i Neo.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na Neo da koristite glasovni unos.",
  ...
  "dialog.server.description": "Promijeni na koji se Neo server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Neo-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Neo timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Neo još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Neo uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Neo-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Neo izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Neo-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Neo pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Neo-a.",
  ...
  "settings.indexing.neoModel.title": "Preset Neo modela",
  "settings.indexing.neoModel.description": "Odaberite podržani model embeddinga hostovan na Neo.",
  "settings.indexing.neoSignIn.title": "Potrebna je prijava na Neo",
  "settings.indexing.neoSignIn.description": "Prijavite se na Neo za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Neo Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Neo ostane otvoren, bez vezivanja.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij Neo Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} Neo konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu Neo konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} Neo konfiguracijske datoteke: {{message}}",
  "settings.config.source.xdg": "XDG globalna konfiguracija",
  "settings.config.source.homeNeo": "Home .neo konfiguracija",
  "settings.config.source.homeNeocode": "Home .neocode konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "NEO_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectNeo": "Projektna .neo konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectNeocode": "Zastarjela .neocode konfiguracija",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili neo import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Neo Code",
  ...
  "profile.action.login": "Prijavite se putem Neo Code",
  ...
  "profile.pass.subscribe": "Nabavite Neo Pass da dodate kredite i zaradite bonuse",
  ...
  "settings.aboutneocode.title": "O Neo Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Neo Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutneocode.status.connected": "Povezano",
  "settings.aboutneocode.status.connecting": "Povezivanje...",
  "settings.aboutneocode.status.disconnected": "Odspojeno",
  "settings.aboutneocode.status.error": "Greška",
  "settings.aboutneocode.cliServer": "CLI server",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Informacije o verziji",
  "settings.aboutneocode.version.label": "Verzija:",
  "settings.aboutneocode.extensionName": "Neo Code ekstenzija",
  "settings.aboutneocode.community": "Zajednica i podrška",
  "settings.aboutneocode.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutneocode.feedback.or": "ili",
  "settings.aboutneocode.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutneocode.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutneocode.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutneocode.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutneocode.exportSettings": "Izvezi",
  "settings.aboutneocode.importSettings": "Uvezi",
  "settings.aboutneocode.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutneocode.importSettings.invalidConfig": "Fajl ne sadrži važeće Neo postavke.",
  "settings.aboutneocode.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Neo-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutneocode.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutneocode.telemetry.title": "Telemetrija",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Neo Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.speechToText.description":
    "Omogućite glasovni unos u poljima za promptove koristeći vaš Neo račun preko Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Omogućite i prijavite se na Neo provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz Neo Gateway.",
  "settings.models.speechToTextModel.title": "Model govora u tekst",
  "settings.models.speechToTextModel.description": "Odaberite Neo Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Neo Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Neo koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u neo.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.sandboxing.enabled.description":
    "Pokrenite shell komande agenta unutar sandboxa na nivou operativnog sistema koji ograničava pisanje na direktorije stanja projekta i Neo",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Neo webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutneocode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Neo Code, uključujući API ključeve provajdera i podrazumijevani model.",
  "settings.aboutneocode.rooImport.description": "Uvezite historiju razgovora iz instalacije Roo Code.",
  "settings.aboutneocode.rooImport.button": "Uvezi sesije iz Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Neo proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Neo promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
