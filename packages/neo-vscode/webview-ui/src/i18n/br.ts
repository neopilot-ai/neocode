export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instale o Anaconda Desktop nesta máquina e depois volte aqui. O Neo não executa o instalador para você.",
  ...
  "provider.anaconda.state.signedOut": "Abra o Anaconda Desktop e faça login antes de conectar o Neo.",
  "provider.anaconda.state.unauthorized":
    "O Neo não conseguiu acessar o Anaconda Desktop. Abra o Desktop, faça login novamente e reinicie-o se necessário.",
  ...
  "provider.anaconda.state.ready":
    "O Neo encontrou um servidor local saudável de geração de texto e pode importar suas configurações de conexão atuais.",
  ...
  "provider.anaconda.toast.refreshed.description": "O servidor local ativo e os modelos estão atualizados no Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "O Neo não conseguiu verificar as skills disponíveis.",
  "agentRequirements.error.mcpStatusFailed": "O Neo não conseguiu verificar o status do servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta verificação de requisitos do agente não está mais ativa.",
  "agentRequirements.error.requestFailed": "O Neo não conseguiu verificar os requisitos do agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Neo",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ativado. Os comandos shell do agente estão limitados aos diretórios do projeto e do Neo.",
  "prompt.action.sandbox.disabled":
    "Sandbox desativado. Clique para limitar as escritas dos comandos shell do agente aos diretórios do projeto e do Neo.",
  ...
  "prompt.action.sandbox.description.enabled":
    "As operações de escrita são limitadas aos diretórios do projeto e do Neo.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no Neo para usar a entrada de voz.",
  ...
  "dialog.server.description": "Trocar para qual servidor Neo este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Neo ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Neo",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Neo ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Neo inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Neo",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Neo aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Neo é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Neo iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Neo.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Neo Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Neo aberto, sem lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do Neo Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Neo",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Neo.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Neo: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeNeo": "Configuração .neo da Home",
  "settings.config.source.homeNeocode": "Configuração .neocode da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectNeo": "Configuração .neo do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectNeocode": "Configuração .neocode legada",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "O Neo pausa e mostra o plano enquanto trabalha.",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando neo import",
  ...
  "deviceAuth.title": "Entrar no Neo Code",
  ...
  "profile.action.login": "Entrar com Neo Code",
  ...
  "profile.pass.subscribe": "Obtenha o Neo Pass para adicionar créditos e ganhar bônus",
  ...
  "settings.indexing.neoModel.title": "Predefinição de modelo do Neo",
  "settings.indexing.neoModel.description": "Escolha um modelo de embedding hospedado pelo Neo compatível.",
  "settings.indexing.neoSignIn.title": "Login no Neo necessário",
  "settings.indexing.neoSignIn.description": "Entre no Neo para usar embeddings hospedados.",
  ...
  "settings.aboutneocode.title": "Sobre o Neo Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Neo Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutneocode.status.error": "Erro",
  ...
  "settings.aboutneocode.versionInfo": "Informações da Versão",
  "settings.aboutneocode.version.label": "Versão:",
  "settings.aboutneocode.extensionName": "Extensão Neo Code",
  "settings.aboutneocode.community": "Comunidade e Suporte",
  "settings.aboutneocode.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutneocode.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutneocode.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutneocode.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Neo.",
  ...
  "settings.aboutneocode.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Neo. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Neo Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Ative a entrada de voz nos campos de prompt usando sua conta do Neo por meio do Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Ative e faça login no provedor Neo para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o Neo Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de fala para texto",
  "settings.models.speechToTextModel.description":
    "Escolha o modelo de transcrição do Neo Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Neo Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Neo utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em neo.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.sandboxing.enabled.description":
    "Executar os comandos shell do agente dentro de um sandbox a nível de sistema operacional que restringe escritas aos diretórios de estado do projeto e do Neo",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Neo independentemente do VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migração Legada",
  "settings.aboutneocode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Neo Code, incluindo chaves de API de provedor e modelo padrão.",
  "settings.aboutneocode.rooImport.description": "Importe o histórico de conversas de uma instalação do Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importar sessões do Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Neo. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Neo durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
