export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Neo n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.signedOut": "Ouvrez Anaconda Desktop et connectez-vous avant de connecter Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "Neo a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
  ...
  "provider.anaconda.toast.refreshed.description": "Le serveur local actif et les modèles sont à jour dans Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo n’a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Neo n’a pas pu vérifier l’état du serveur MCP.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des prérequis de l’agent n’est plus active.",
  "agentRequirements.error.requestFailed": "Neo n’a pas pu vérifier les prérequis de l’agent.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Neo",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Le sandbox est activé. Les commandes shell de l'agent sont limitées aux répertoires du projet et de Neo.",
  "prompt.action.sandbox.disabled":
    "Le sandbox est désactivé. Cliquez pour limiter les écritures des commandes shell de l'agent aux répertoires du projet et de Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Les écritures sont limitées aux répertoires du projet et de Neo.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Neo pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Neo auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Neo ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Neo",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Neo ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Neo inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Neo",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Neo sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Neo.",
  ...
  "settings.indexing.neoModel.title": "Préréglage de modèle Neo",
  "settings.indexing.neoModel.description": "Choisissez un modèle d'embedding hébergé par Neo pris en charge.",
  "settings.indexing.neoSignIn.title": "Connexion à Neo requise",
  "settings.indexing.neoSignIn.description": "Connectez-vous à Neo pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Neo",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Neo.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Neo Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Neo ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Neo Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Neo {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Neo local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Neo {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeNeo": "Configuration .neo de Home",
  "settings.config.source.homeNeocode": "Configuration .neocode de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Configuration d'environnement en ligne",
  "settings.config.source.projectNeo": "Configuration .neo du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectNeocode": "Configuration obsolète .neocode",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Neo",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande neo import",
  ...
  "deviceAuth.title": "Se connecter à Neo Code",
  ...
  "profile.action.login": "Se connecter avec Neo Code",
  ...
  "profile.pass.subscribe": "Obtenez Neo Pass pour ajouter des crédits et gagner des bonus",
  ...
  "settings.aboutneocode.title": "À propos de Neo Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Neo Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutneocode.status.connected": "Connecté",
  "settings.aboutneocode.status.connecting": "Connexion en cours...",
  "settings.aboutneocode.status.disconnected": "Déconnecté",
  "settings.aboutneocode.status.error": "Erreur",
  "settings.aboutneocode.cliServer": "Serveur CLI",
  "settings.aboutneocode.status.label": "Statut :",
  "settings.aboutneocode.port.label": "Port :",
  "settings.aboutneocode.versionInfo": "Informations de version",
  "settings.aboutneocode.version.label": "Version :",
  "settings.aboutneocode.extensionName": "Extension Neo Code",
  "settings.aboutneocode.community": "Communauté et support",
  "settings.aboutneocode.feedback.prefix":
    "Si vous avez des questions ou des commentaires, n'hésitez pas à ouvrir un ticket sur",
  "settings.aboutneocode.feedback.or": "ou",
  "settings.aboutneocode.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutneocode.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutneocode.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutneocode.exportSettings": "Exporter",
  "settings.aboutneocode.importSettings": "Importer",
  ...
  "settings.aboutneocode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Neo valides.",
  ...
  "settings.aboutneocode.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Neo. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutneocode.telemetry.title": "Télémétrie",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Neo Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Neo via Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Neo pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Neo Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Neo Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Neo Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Neo utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans neo.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.sandboxing.enabled.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de Neo",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Neo indépendamment de VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutneocode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Neo Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "settings.aboutneocode.rooImport.description":
    "Importer l'historique des conversations depuis une installation de Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Neo. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Neo pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
