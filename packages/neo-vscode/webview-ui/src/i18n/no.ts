...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskinen, og kom deretter tilbake hit. Neo kjører ikke installasjonsprogrammet for deg.",
  ...
  "provider.anaconda.state.signedOut": "Åpne Anaconda Desktop og logg inn før du kobler til Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo fikk ikke tilgang til Anaconda Desktop. Åpne Desktop, logg inn på nytt, og start det på nytt om nødvendig.",
  ...
  "provider.anaconda.state.ready":
    "Neo fant en sunn lokal tekstgenereringsserver og kan importere de gjeldende tilkoblingsinnstillingene.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale serveren og modellene er oppdatert i Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo kunne ikke sjekke tilgjengelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Neo kunne ikke sjekke MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne sjekken av agentkrav er ikke lenger aktiv.",
  "agentRequirements.error.requestFailed": "Neo kunne ikke sjekke agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Neo",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktivert. Shell-kommandoer for agenten er begrenset til prosjekt- og Neo-mappene.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktivert. Klikk for å begrense skriving av shell-kommandoer for agenten til prosjekt- og Neo-mappene.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivetilgang er begrenset til prosjekt- og Neo-mappene.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på Neo for å bruke taleinndata.",
  ...
  "dialog.server.description": "Bytt hvilken Neo-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Neo ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Neo-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Neo ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Neo inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Neo",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Neo ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Neo er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Neo starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Neo.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Neo Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Neo åpent, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Neo Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "settings.config.title": "Åpne {{scope}} Neo-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Neo-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Neo-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeNeo": "Home .neo-konfigurasjon",
  "settings.config.source.homeNeocode": "Home .neocode-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "NEO_CONFIG miljøfil",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectNeo": "Prosjekt .neo-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectNeocode": "Eldre .neocode-konfigurasjon",
  ...
  "workStyle.onboarding.welcome": "Velkommen til Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo tar pause og viser deg planen sin mens den arbeider.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller neo import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Neo Code",
  ...
  "profile.action.login": "Logg inn med Neo Code",
  ...
  "profile.pass.subscribe": "Få Neo Pass for å legge til kreditt og tjene bonuser",
  ...
  "settings.aboutneocode.title": "Om Neo Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Neo Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutneocode.status.connected": "Tilkoblet",
  "settings.aboutneocode.status.connecting": "Kobler til...",
  "settings.aboutneocode.status.disconnected": "Frakoblet",
  "settings.aboutneocode.status.error": "Feil",
  "settings.aboutneocode.cliServer": "CLI-server",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Versjonsinformasjon",
  "settings.aboutneocode.version.label": "Versjon:",
  "settings.aboutneocode.extensionName": "Neo Code-utvidelse",
  "settings.aboutneocode.community": "Fellesskap og støtte",
  "settings.aboutneocode.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutneocode.feedback.or": "eller",
  "settings.aboutneocode.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutneocode.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutneocode.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutneocode.exportSettings": "Eksporter",
  "settings.aboutneocode.importSettings": "Importer",
  "settings.aboutneocode.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutneocode.importSettings.invalidConfig": "Filen inneholder ikke gyldige Neo-innstillinger.",
  "settings.aboutneocode.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Neo. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutneocode.telemetry.title": "Telemetri",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Neo Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.speechToText.description":
    "Aktiver taleinndata i prompt-felt ved å bruke din Neo-konto gjennom Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktiver og logg på Neo-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med Neo Gateway.",
  "settings.models.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.models.speechToTextModel.description": "Velg Neo Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Neo Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.neoModel.title": "Neo-modellforhåndsvalg",
  "settings.indexing.neoModel.description": "Velg en støttet Neo-hostet embedding-modell.",
  "settings.indexing.neoSignIn.title": "Neo-pålogging kreves",
  "settings.indexing.neoSignIn.description": "Logg inn på Neo for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Neo skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i neo.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.sandboxing.enabled.description":
    "Kjør shell-kommandoer for agenten i en sandbox på operativsystemnivå som begrenser skriving til prosjekt- og Neo-tilstandsmapper",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Neo webview UI uavhengig av VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutneocode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Neo Code, inkludert API-nøkler for leverandører og standardmodell.",
  "settings.aboutneocode.rooImport.description": "Importer samtalehistorikk fra en installasjon av Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importer økter fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Neo-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Neo i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
