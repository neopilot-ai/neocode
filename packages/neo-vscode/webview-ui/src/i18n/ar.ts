export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ثبّت Anaconda Desktop على هذا الجهاز، ثم عُد إلى هنا. لا يقوم Neo بتشغيل المثبّت نيابةً عنك.",
  ...
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل Neo.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على Neo الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مرة أخرى، وأعد تشغيله إذا لزم الأمر.",
  ...
  "provider.anaconda.state.ready":
    "عثر Neo على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية الخاصة به.",
  ...
  "provider.anaconda.toast.refreshed.description": "الخادم المحلي النشط والنماذج محدّثة في Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "تعذر على Neo فحص المهارات المتاحة.",
  "agentRequirements.error.mcpStatusFailed": "تعذر على Neo فحص حالة خادم MCP.",
  "agentRequirements.error.scopeMismatch": "لم يعد فحص متطلبات هذا الوكيل نشطًا.",
  "agentRequirements.error.requestFailed": "تعذر على Neo فحص متطلبات الوكيل.",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Neo",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Neo.",
  ...
  "prompt.action.sandbox.enabled": "sandbox مُفعّل. أوامر shell الخاصة بالوكيل مقتصرة على مجلدات المشروع و Neo.",
  "prompt.action.sandbox.disabled":
    "sandbox مُعطّل. انقر لتقييد كتابة أوامر shell الخاصة بالوكيل على مجلدات المشروع و Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "تقتصر عمليات الكتابة على مجلدات المشروع و Neo.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Neo Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Neo لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم Neo الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Neo ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Neo",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Neo لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Neo نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Neo",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Neo على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Neo.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Neo",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Neo.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Neo Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Neo مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Neo Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Neo {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Neo المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Neo {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeNeo": "تكوين .neo في Home",
  "settings.config.source.homeNeocode": "تكوين .neocode في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectNeo": "تكوين .neo للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectNeocode": "تكوين .neocode القديم",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Neo مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر neo import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Neo Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Neo Code",
  ...
  "profile.pass.subscribe": "احصل على Neo Pass لإضافة رصيد وكسب مكافآت",
  ...
  "settings.indexing.neoModel.title": "إعداد مسبق لنموذج Neo",
  "settings.indexing.neoModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Neo.",
  "settings.indexing.neoSignIn.title": "تسجيل الدخول إلى Neo مطلوب",
  "settings.indexing.neoSignIn.description": "سجّل الدخول إلى Neo لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutneocode.title": "حول Neo Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Neo Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutneocode.status.connected": "متصل",
  "settings.aboutneocode.status.connecting": "جارٍ الاتصال...",
  "settings.aboutneocode.status.disconnected": "غير متصل",
  "settings.aboutneocode.status.error": "خطأ",
  "settings.aboutneocode.cliServer": "خادم CLI",
  "settings.aboutneocode.status.label": "الحالة:",
  "settings.aboutneocode.port.label": "المنفذ:",
  "settings.aboutneocode.versionInfo": "معلومات الإصدار",
  "settings.aboutneocode.version.label": "الإصدار:",
  "settings.aboutneocode.extensionName": "إضافة Neo Code",
  "settings.aboutneocode.community": "المجتمع والدعم",
  "settings.aboutneocode.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutneocode.feedback.or": "أو",
  "settings.aboutneocode.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutneocode.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutneocode.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutneocode.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutneocode.exportSettings": "تصدير",
  "settings.aboutneocode.importSettings": "استيراد",
  "settings.aboutneocode.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutneocode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Neo صالحة.",
  "settings.aboutneocode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Neo. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutneocode.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Neo Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب Neo الخاص بك من خلال Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Neo لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Neo Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ Neo Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Neo Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Neo مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في neo.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.sandboxing.enabled.description":
    "تشغيل أوامر shell الخاصة بالوكيل داخل sandbox على مستوى نظام التشغيل يقيّد الكتابة على مجلدات حالة المشروع و Neo",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Neo بشكل مستقل عن VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutneocode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Neo Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutneocode.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutneocode.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Neo. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Neo خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
