export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Встановіть Anaconda Desktop на цьому комп'ютері, а потім поверніться сюди. Neo не запускає інсталятор за вас.",
  ...
  "provider.anaconda.state.signedOut": "Відкрийте Anaconda Desktop та увійдіть перед підключенням Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo не вдалося отримати доступ до Anaconda Desktop. Відкрийте Desktop, увійдіть знову та перезапустіть його за потреби.",
  ...
  "provider.anaconda.state.ready":
    "Neo знайшов справний локальний сервер генерації тексту та може імпортувати його поточні налаштування підключення.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активний локальний сервер та моделі актуальні в Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo не зміг перевірити доступні навички.",
  "agentRequirements.error.mcpStatusFailed": "Neo не зміг перевірити стан сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Ця перевірка вимог агента більше не активна.",
  "agentRequirements.error.requestFailed": "Neo не зміг перевірити вимоги агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Neo",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Neo.",
  ...
  "prompt.action.sandbox.enabled": "Пісочницю увімкнено. Команди оболонки агента обмежені каталогами проєкту та Neo.",
  "prompt.action.sandbox.disabled":
    "Пісочницю вимкнено. Натисніть, щоб обмежити запис команд оболонки агента каталогами проєкту та Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Запис дозволено лише в каталогах проєкту та Neo.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до Neo, щоб використовувати голосове введення.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Neo підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Neo ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Neo",
  ...
  "error.chain.mcpFailed": 'MCP-сервер "{{name}}" зазнав помилки. Примітка: Neo поки не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Neo включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Neo",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Neo на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Neo.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Neo",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Neo.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Neo Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Neo залишається відкритим — без прив'язки.",
  ...
  "settings.config.title": "Відкрити файл конфігурації Neo ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації Neo.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації Neo ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальна конфігурація XDG",
  "settings.config.source.homeNeo": "Конфігурація .neo (Home)",
  "settings.config.source.homeNeocode": "Конфігурація .neocode (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectNeo": "Конфігурація .neo проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectNeocode": "Застаріла конфігурація .neocode",
  ...
  "workStyle.onboarding.welcome": "Ласкаво просимо до Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo призупиняється та показує свій план у процесі роботи.",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда neo import",
  ...
  "deviceAuth.title": "Увійти до Neo Code",
  ...
  "profile.action.login": "Увійти через Neo Code",
  ...
  "profile.pass.subscribe": "Отримайте Neo Pass, щоб додати кредити та заробляти бонуси",
  ...
  "settings.aboutneocode.title": "Про Neo Code",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Neo Code — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutneocode.status.connected": "Підключено",
  "settings.aboutneocode.status.connecting": "Підключення...",
  "settings.aboutneocode.status.disconnected": "Відключено",
  "settings.aboutneocode.status.error": "Помилка",
  "settings.aboutneocode.cliServer": "CLI-сервер",
  "settings.aboutneocode.status.label": "Статус:",
  "settings.aboutneocode.port.label": "Порт:",
  "settings.aboutneocode.versionInfo": "Інформація про версію",
  "settings.aboutneocode.version.label": "Версія:",
  "settings.aboutneocode.extensionName": "Розширення Neo Code",
  "settings.aboutneocode.community": "Спільнота і підтримка",
  "settings.aboutneocode.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutneocode.feedback.or": "або",
  "settings.aboutneocode.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutneocode.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutneocode.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutneocode.exportSettings": "Експортувати",
  "settings.aboutneocode.importSettings": "Імпортувати",
  "settings.aboutneocode.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutneocode.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Neo.",
  "settings.aboutneocode.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Neo. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutneocode.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutneocode.telemetry.title": "Телеметрія",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Neo Code.',
  ...
  "settings.experimental.speechToText.description":
    "Увімкніть голосове введення в полях запитів, використовуючи ваш обліковий запис Neo через Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Увімкніть провайдер Neo та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з Neo Gateway.",
  "settings.models.speechToTextModel.title": "Модель мовлення в текст",
  "settings.models.speechToTextModel.description": "Виберіть модель транскрипції Neo Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Neo Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.sandboxing.enabled.description":
    "Виконувати команди оболонки агента в пісочниці на рівні ОС, яка обмежує запис до каталогів стану проєкту та Neo",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Neo використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до neo.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Neo незалежно від VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Приховувати моделі Neo Gateway, постачальники яких можуть використовувати ваші запити для навчання.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutneocode.legacyMigration.description":
    "Перенести налаштування з попередньої версії Neo Code, включаючи API-ключі провайдерів та стандартну модель.",
  "settings.aboutneocode.rooImport.description": "Імпортувати історію розмов з інсталяції Roo Code.",
  "settings.aboutneocode.rooImport.button": "Імпортувати сесії з Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Neo. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.neoModel.title": "Пресет моделі Neo",
  "settings.indexing.neoModel.description": "Виберіть підтримувану модель Neo-hosted embeddings.",
  "settings.indexing.neoSignIn.title": "Потрібен вхід у Neo",
  "settings.indexing.neoSignIn.description": "Увійдіть у Neo, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Neo під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
