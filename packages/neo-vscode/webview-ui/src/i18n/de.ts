...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. Neo führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.signedOut": "Öffnen Sie Anaconda Desktop und melden Sie sich an, bevor Sie Neo verbinden.",
  "provider.anaconda.state.unauthorized":
    "Neo konnte nicht auf Anaconda Desktop zugreifen. Öffnen Sie Desktop, melden Sie sich erneut an und starten Sie es bei Bedarf neu.",
  ...
  "provider.anaconda.state.ready":
    "Neo hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in Neo auf dem neuesten Stand.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo konnte die verfügbaren Skills nicht prüfen.",
  "agentRequirements.error.mcpStatusFailed": "Neo konnte den MCP-Serverstatus nicht prüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Prüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "Neo konnte die Agentenanforderungen nicht prüfen.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Neo",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Neo zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Neo zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Neo zu nutzen.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und Neo-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und Neo-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und Neo-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Neo Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Neo an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den Neo-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Neo ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Neo-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Neo unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Neo enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Neo ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Neo auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Neo anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Neo automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Neo.",
  ...
  "settings.indexing.neoModel.title": "Neo-Modellvoreinstellung",
  "settings.indexing.neoModel.description": "Wählen Sie ein unterstütztes von Neo gehostetes Embedding-Modell.",
  "settings.indexing.neoSignIn.title": "Neo-Anmeldung erforderlich",
  "settings.indexing.neoSignIn.description": "Melden Sie sich bei Neo an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Neo-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Neo-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Neo-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Neo-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeNeo": "Home .neo-Konfiguration",
  "settings.config.source.homeNeocode": "Home .neocode-Konfiguration",
  "settings.config.source.homeOpencode": "Home .opencode-Konfiguration",
  "settings.config.source.envFile": "NEO_CONFIG Umgebungsdatei",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Inline-Umgebungskonfiguration",
  "settings.config.source.projectNeo": "Projekt .neo-Konfiguration",
  "settings.config.source.projectRoot": "Projektstamm-Konfiguration",
  "settings.config.source.projectNeocode": "Veraltete .neocode-Konfiguration",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder neo import-Befehl",
  ...
  "deviceAuth.title": "Bei Neo Code anmelden",
  ...
  "profile.action.login": "Mit Neo Code anmelden",
  ...
  "profile.pass.subscribe": "Hol dir Neo Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  ...
  "settings.aboutneocode.title": "Über Neo Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Neo Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutneocode.status.connected": "Verbunden",
  "settings.aboutneocode.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutneocode.status.disconnected": "Getrennt",
  "settings.aboutneocode.status.error": "Fehler",
  "settings.aboutneocode.cliServer": "CLI-Server",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Versionsinformationen",
  "settings.aboutneocode.version.label": "Version:",
  "settings.aboutneocode.extensionName": "Neo Code Erweiterung",
  "settings.aboutneocode.community": "Community & Support",
  "settings.aboutneocode.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutneocode.feedback.or": "oder",
  "settings.aboutneocode.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutneocode.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutneocode.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutneocode.exportSettings": "Exportieren",
  "settings.aboutneocode.importSettings": "Importieren",
  "settings.aboutneocode.importSettings.invalidJson":
    "Ungültige JSON-Datei. Bitte wählen Sie eine gültige Einstellungsdatei aus.",
  "settings.aboutneocode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Neo-Einstellungen.",
  ...
  "settings.aboutneocode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Neo exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Neo Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem Neo-Konto über Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den Neo-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Neo Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das Neo Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Neo Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Neo Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in neo.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und Neo-Statusverzeichnisse beschränkt",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Neo webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Legacy-Migration",
  "settings.aboutneocode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Neo Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "settings.aboutneocode.rooImport.description":
    "Importieren Sie den Konversationsverlauf von einer Installation von Roo Code.",
  "settings.aboutneocode.rooImport.button": "Sitzungen aus Roo Code importieren",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Neo-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Neo während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
