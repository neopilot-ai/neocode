export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskine, og vend derefter tilbage hertil. Neo kører ikke installationsprogrammet for dig.",
  ...
  "provider.anaconda.state.signedOut": "Åbn Anaconda Desktop og log ind, før du forbinder Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo kunne ikke få adgang til Anaconda Desktop. Åbn Desktop, log ind igen, og genstart den om nødvendigt.",
  ...
  "provider.anaconda.state.ready":
    "Neo fandt en sund lokal tekstgenereringsserver og kan importere dens aktuelle forbindelsesindstillinger.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale server og modeller er opdaterede i Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo kunne ikke kontrollere de tilgængelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Neo kunne ikke kontrollere MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne agentkravskontrol er ikke længere aktiv.",
  "agentRequirements.error.requestFailed": "Neo kunne ikke kontrollere agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Neo",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktiveret. Shell-kommandoer for agenten er begrænset til projekt- og Neo-mapperne.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktiveret. Klik for at begrænse skrivning af shell-kommandoer for agenten til projekt- og Neo-mapperne.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivning er begrænset til projekt- og Neo-mapperne.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Neo for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken Neo-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Neo ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Neo-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Neo understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Neo inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Neo",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Neo ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Neo er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Neo starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Neo.",
  ...
  "settings.indexing.neoModel.title": "Neo-modelpreset",
  "settings.indexing.neoModel.description": "Vælg en understøttet Neo-hostet embedding-model.",
  "settings.indexing.neoSignIn.title": "Neo-login kræves",
  "settings.indexing.neoSignIn.description": "Log ind på Neo for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Neo Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Neo åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Neo Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Neo konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Neo konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Neo konfigurationsfil: {{message}}",
  ...
  "settings.config.source.projectNeocode": "Forældet .neocode konfiguration",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller neo import-kommando",
  ...
  "deviceAuth.title": "Log ind på Neo Code",
  ...
  "profile.action.login": "Log ind med Neo Code",
  ...
  "profile.pass.subscribe": "Få Neo Pass for at tilføje kredit og optjene bonusser",
  ...
  "session.messages.welcome":
    "Neo Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutneocode.status.connected": "Forbundet",
  "settings.aboutneocode.status.connecting": "Forbinder...",
  "settings.aboutneocode.status.disconnected": "Afbrudt",
  "settings.aboutneocode.status.error": "Fejl",
  "settings.aboutneocode.cliServer": "CLI-server",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Versionsinformation",
  "settings.aboutneocode.version.label": "Version:",
  "settings.aboutneocode.extensionName": "Neo Code-udvidelse",
  "settings.aboutneocode.community": "Fællesskab og support",
  ...
  "settings.aboutneocode.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutneocode.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutneocode.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutneocode.exportSettings": "Eksportér",
  "settings.aboutneocode.importSettings": "Importér",
  "settings.aboutneocode.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutneocode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Neo-indstillinger.",
  "settings.aboutneocode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Neo. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Neo Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din Neo-konto gennem Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på Neo-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Neo Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg Neo Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Neo Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Neo til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i neo.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.sandboxing.enabled.description":
    "Kør shell-kommandoer for agenten i en sandbox på operativsystemniveau, der begrænser skrivning til projekt- og Neo-tilstandsmapperne",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Neo webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Legacy-migrering",
  "settings.aboutneocode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Neo Code, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutneocode.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Neo-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Neo i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
