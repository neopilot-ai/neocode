...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.signedOut": "請開啟 Anaconda Desktop 並登入，然後再連接 Neo。",
  "provider.anaconda.state.unauthorized":
    "Neo 無法存取 Anaconda Desktop。請開啟 Desktop，重新登入，並在需要時重新啟動它。",
  ...
  "provider.anaconda.state.ready": "Neo 找到了一個正常運作的本機文字生成伺服器，並可匯入其目前的連接設定。",
  ...
  "provider.anaconda.toast.refreshed.description": "使用中的本機伺服器與模型在 Neo 中已是最新狀態。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo 無法檢查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "Neo 無法檢查 MCP 伺服器狀態。",
  "agentRequirements.error.scopeMismatch": "此代理需求檢查已不再有效。",
  "agentRequirements.error.requestFailed": "Neo 無法檢查代理需求。",
  ...
  "dialog.model.unpaid.freeModels.title": "Neo 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Neo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Neo 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Neo 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已啟用。代理 shell 指令被限制在專案和 Neo 目錄內。",
  "prompt.action.sandbox.disabled": "沙盒已停用。點擊以將代理 shell 指令的寫入限制在專案和 Neo 目錄內。",
  ...
  "prompt.action.sandbox.description.enabled": "寫入僅限於專案和 Neo 目錄。",
  ...
  "speechToText.tooltip.start": "使用 Neo Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 Neo 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Neo 伺服器。",
  ...
  "toast.update.description": "Neo 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Neo 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Neo 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Neo 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Neo 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Neo 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Neo 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Neo 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Neo。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Neo Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Neo 開放，絕不綁定。",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Neo Gateway 模型。",
  ...
  "settings.config.title": "開啟 {{scope}} Neo 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Neo 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Neo 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeNeo": "主目錄 .neo 設定",
  "settings.config.source.homeNeocode": "主目錄 .neocode 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "NEO_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectNeo": "專案 .neo 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectNeocode": "舊版 .neocode 設定",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 neo import 指令",
  ...
  "settings.aboutneocode.title": "關於 Neo Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Neo Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutneocode.status.connected": "已連線",
  "settings.aboutneocode.status.connecting": "連線中...",
  "settings.aboutneocode.status.disconnected": "已中斷",
  "settings.aboutneocode.status.error": "錯誤",
  "settings.aboutneocode.cliServer": "CLI 伺服器",
  "settings.aboutneocode.status.label": "狀態：",
  "settings.aboutneocode.port.label": "連接埠：",
  "settings.aboutneocode.versionInfo": "版本資訊",
  "settings.aboutneocode.version.label": "版本：",
  "settings.aboutneocode.extensionName": "Neo Code 擴充功能",
  "settings.aboutneocode.community": "社群與支援",
  "settings.aboutneocode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutneocode.feedback.or": "或",
  "settings.aboutneocode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutneocode.resetSettings.title": "重置設定",
  "settings.aboutneocode.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutneocode.resetSettings.button": "重置所有設定",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "設定轉移",
  "settings.aboutneocode.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutneocode.exportSettings": "匯出",
  "settings.aboutneocode.importSettings": "匯入",
  "settings.aboutneocode.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutneocode.importSettings.invalidConfig": "檔案不包含有效的 Neo 設定。",
  "settings.aboutneocode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutneocode.importSettings.newerVersion": "此檔案由較新版本的 Neo 匯出。部分設定可能會被忽略。",
  "settings.aboutneocode.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutneocode.telemetry.title": "遙測",
  "settings.aboutneocode.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutneocode.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Neo Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.speechToText.description": "透過 Neo Gateway 使用您的 Neo 帳戶在提示詞欄位中啟用語音輸入。",
  "settings.models.speechToText.disabledDescription":
    "啟用並登入 Neo 供應商以使用 Speech to Text。Speech to Text 目前僅支援透過 Neo Gateway 使用。",
  "settings.models.speechToTextModel.title": "語音轉文字模型",
  "settings.models.speechToTextModel.description": "選擇用於語音輸入的 Neo Gateway 轉錄模型。",
  ...
  "settings.experimental.remote.description": "透過 Neo Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Neo 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 neo.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.sandboxing.enabled.description":
    "在作業系統層級沙盒中執行代理 shell 指令，將寫入限制在專案和 Neo 狀態目錄內",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Neo webview UI 的字體大小。",
  ...
  "settings.indexing.neoModel.title": "Neo 模型預設",
  "settings.indexing.neoModel.description": "選擇支援的 Neo 託管嵌入模型。",
  "settings.indexing.neoSignIn.title": "需要登入 Neo",
  "settings.indexing.neoSignIn.description": "登入 Neo 以使用託管嵌入。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Neo Code 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Neo 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Neo 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
