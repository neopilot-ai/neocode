export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop'ı bu makineye kurun, ardından buraya dönün. Neo kurulumu sizin için çalıştırmaz.",
  ...
  "provider.anaconda.state.signedOut": "Neo'yu bağlamadan önce Anaconda Desktop'ı açın ve oturum açın.",
  "provider.anaconda.state.unauthorized":
    "Neo Anaconda Desktop'a erişemedi. Desktop'ı açın, tekrar oturum açın ve gerekirse yeniden başlatın.",
  ...
  "provider.anaconda.state.ready":
    "Neo sağlıklı bir yerel metin üretme sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.toast.refreshed.description": "Etkin yerel sunucu ve modeller Neo'da güncel.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo mevcut yetenekleri denetleyemedi.",
  "agentRequirements.error.mcpStatusFailed": "Neo MCP sunucu durumunu denetleyemedi.",
  "agentRequirements.error.scopeMismatch": "Bu ajan gereksinimi denetimi artık etkin değil.",
  "agentRequirements.error.requestFailed": "Neo ajan gereksinimlerini denetleyemedi.",
  ...
  "dialog.model.unpaid.freeModels.title": "Neo tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Neo'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Neo'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Neo'da {{provider}} modellerini kullanın.",
  ...
  "prompt.action.sandbox.enabled": "Sandbox etkin. Agent shell komutları proje ve Neo dizinleriyle sınırlıdır.",
  "prompt.action.sandbox.disabled":
    "Sandbox devre dışı. Agent shell komut yazma işlemlerini proje ve Neo dizinleriyle sınırlamak için tıklayın.",
  ...
  "prompt.action.sandbox.description.enabled": "Yazma işlemleri proje ve Neo dizinleriyle sınırlıdır.",
  ...
  "speechToText.tooltip.start": "Neo Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için Neo'ya giriş yapın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Neo sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Neo'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Neo ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Neo henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Neo ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.general.row.language.description": "Neo'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Neo'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Neo'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Neo başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Neo'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Neo Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Neo'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} Neo yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Neo yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Neo yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeNeo": "Home .neo yapılandırması",
  "settings.config.source.homeNeocode": "Home .neocode yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "NEO_CONFIG ortam dosyası",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectNeo": "Proje .neo yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectNeocode": "Eski .neocode yapılandırması",
  ...
  "workStyle.onboarding.welcome": "Neo'ya hoş geldiniz",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo çalışırken duraklar ve planını size gösterir.",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya neo import komutu",
  ...
  "deviceAuth.title": "Neo Code'a giriş yap",
  ...
  "profile.action.login": "Neo Code ile giriş yap",
  ...
  "profile.pass.subscribe": "Kredi eklemek ve bonus kazanmak için Neo Pass edinin",
  ...
  "settings.aboutneocode.title": "Neo Code Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Neo Code bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutneocode.status.connected": "Bağlı",
  "settings.aboutneocode.status.connecting": "Bağlanıyor...",
  "settings.aboutneocode.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutneocode.status.error": "Hata",
  "settings.aboutneocode.cliServer": "CLI Sunucusu",
  "settings.aboutneocode.status.label": "Durum:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Sürüm Bilgisi",
  "settings.aboutneocode.version.label": "Sürüm:",
  "settings.aboutneocode.extensionName": "Neo Code Uzantısı",
  "settings.aboutneocode.community": "Topluluk ve Destek",
  "settings.aboutneocode.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutneocode.feedback.or": "veya",
  "settings.aboutneocode.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutneocode.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutneocode.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutneocode.exportSettings": "Dışa Aktar",
  "settings.aboutneocode.importSettings": "İçe Aktar",
  "settings.aboutneocode.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutneocode.importSettings.invalidConfig": "Dosya geçerli Neo ayarları içermiyor.",
  "settings.aboutneocode.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Bu dosya Neo'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.experimental.speechToText.description":
    "Neo Gateway üzerinden Neo hesabınızı kullanarak komut alanlarında sesli girişi etkinleştirin.",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text kullanmak için Neo sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca Neo Gateway ile desteklenmektedir.",
  "settings.models.speechToTextModel.title": "Sesten metne modeli",
  "settings.models.speechToTextModel.description": "Sesli giriş için Neo Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "Neo Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.sandboxing.enabled.description":
    "Agent shell komutlarını, proje ve Neo durum dizinlerine yazmaları kısıtlanan işletim sistemi düzeyinde bir sandbox içinde çalıştırın",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Neo'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. neo.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.display.fontSize.description": "Neo webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sağlayıcıları istemlerinizi eğitim için kullanabilecek Neo Gateway modellerini gizleyin.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutneocode.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Neo Code'un önceki yüklemesinden ayarları taşıyın.",
  "settings.aboutneocode.rooImport.description": "Bir Roo Code yüklemesinden konuşma geçmişini içe aktarın.",
  "settings.aboutneocode.rooImport.button": "Roo Code'dan Oturumları İçe Aktar",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neo Code'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Neo ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.neoModel.title": "Neo model önayarı",
  "settings.indexing.neoModel.description": "Desteklenen bir Neo-hosted embeddings modeli seçin.",
  "settings.indexing.neoSignIn.title": "Neo oturumu açmak gerekiyor",
  "settings.indexing.neoSignIn.description": "Hosted embeddings kullanmak için Neo'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Neo tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
