export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installeer Anaconda Desktop op deze machine en kom hier dan terug. Neo voert het installatieprogramma niet voor je uit.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop en meld je aan voordat je Neo verbindt.",
  "provider.anaconda.state.unauthorized":
    "Neo kon geen toegang krijgen tot Anaconda Desktop. Open Desktop, meld je opnieuw aan en herstart het indien nodig.",
  ...
  "provider.anaconda.state.ready":
    "Neo heeft een gezonde lokale tekstgeneratieserver gevonden en kan de huidige verbindingsinstellingen importeren.",
  ...
  "provider.anaconda.toast.refreshed.description": "De actieve lokale server en modellen zijn up-to-date in Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo kon de beschikbare skills niet controleren.",
  "agentRequirements.error.mcpStatusFailed": "Neo kon de MCP-serverstatus niet controleren.",
  "agentRequirements.error.scopeMismatch": "Deze controle van agentvereisten is niet meer actief.",
  "agentRequirements.error.requestFailed": "Neo kon de agentvereisten niet controleren.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Neo",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is ingeschakeld. Shell-opdrachten van de agent zijn beperkt tot de project- en Neo-mappen.",
  "prompt.action.sandbox.disabled":
    "Sandbox is uitgeschakeld. Klik om schrijfbewerkingen van shell-opdrachten van de agent te beperken tot de project- en Neo-mappen.",
  ...
  "prompt.action.sandbox.description.enabled": "Schrijfbewerkingen zijn beperkt tot de project- en Neo-mappen.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij Neo om spraakinvoer te gebruiken.",
  ...
  "dialog.server.description": "Wissel met welke Neo-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Neo ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Neo team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, Neo ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Neo bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Neo",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Neo eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Neo aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Neo start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Neo.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Neo Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Neo open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Neo-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Neo-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Neo-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeNeo": "Home .neo-configuratie",
  "settings.config.source.homeNeocode": "Home .neocode-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "NEO_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectNeo": "Project .neo-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectNeocode": "Verouderde .neocode-configuratie",
  ...
  "workStyle.onboarding.welcome": "Welkom bij Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo pauzeert en toont tijdens het werk zijn plan.",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of neo import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Neo Code",
  ...
  "profile.action.login": "Inloggen met Neo Code",
  ...
  "profile.pass.subscribe": "Schaf Neo Pass aan om tegoed toe te voegen en bonussen te verdienen",
  ...
  "settings.aboutneocode.title": "Over Neo Code",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Neo Code is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutneocode.status.connected": "Verbonden",
  "settings.aboutneocode.status.connecting": "Verbinden...",
  "settings.aboutneocode.status.disconnected": "Verbinding verbroken",
  "settings.aboutneocode.status.error": "Fout",
  "settings.aboutneocode.cliServer": "CLI Server",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Poort:",
  "settings.aboutneocode.versionInfo": "Versie-informatie",
  "settings.aboutneocode.version.label": "Versie:",
  "settings.aboutneocode.extensionName": "Neo Code Extensie",
  "settings.aboutneocode.community": "Community & Ondersteuning",
  "settings.aboutneocode.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutneocode.feedback.or": "of",
  "settings.aboutneocode.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutneocode.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutneocode.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutneocode.exportSettings": "Exporteren",
  "settings.aboutneocode.importSettings": "Importeren",
  "settings.aboutneocode.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutneocode.importSettings.invalidConfig": "Het bestand bevat geen geldige Neo-instellingen.",
  ...
  "settings.aboutneocode.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Neo. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutneocode.telemetry.title": "Telemetrie",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Neo Code UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.speechToText.description":
    "Schakel spraakinvoer in promptvelden in met uw Neo-account via Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Schakel de Neo-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met Neo Gateway.",
  "settings.models.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.models.speechToTextModel.description": "Kies het Neo Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Neo Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-opdrachten van de agent uitvoeren in een sandbox op besturingssysteemniveau die schrijfbewerkingen beperkt tot de project- en Neo-statusmappen",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Neo je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in neo.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Neo webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg Neo Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Legacy Migratie",
  "settings.aboutneocode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Neo Code, inclusief provider API-sleutels en standaard model.",
  "settings.aboutneocode.rooImport.description": "Importeer gespreksgeschiedenis van een Roo Code installatie.",
  "settings.aboutneocode.rooImport.button": "Sessies importeren uit Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Neo-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.neoModel.title": "Neo-model voorinstelling",
  "settings.indexing.neoModel.description": "Kies een ondersteund Neo-hosted embeddings model.",
  "settings.indexing.neoSignIn.title": "Neo-aanmelding vereist",
  "settings.indexing.neoSignIn.description": "Log in op Neo om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Neo tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
