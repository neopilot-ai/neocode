export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instala Anaconda Desktop en este equipo y luego vuelve aquí. Neo no ejecuta el instalador por ti.",
  ...
  "provider.anaconda.state.signedOut": "Abre Anaconda Desktop e inicia sesión antes de conectar Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo no pudo acceder a Anaconda Desktop. Abre Desktop, inicia sesión de nuevo y reinícialo si es necesario.",
  ...
  "provider.anaconda.state.ready":
    "Neo encontró un servidor local de generación de texto en buen estado y puede importar su configuración de conexión actual.",
  ...
  "provider.anaconda.toast.refreshed.description": "El servidor local activo y los modelos están actualizados en Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo no pudo comprobar las habilidades disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Neo no pudo comprobar el estado del servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta comprobación de requisitos del agente ya no está activa.",
  "agentRequirements.error.requestFailed": "Neo no pudo comprobar los requisitos del agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Neo",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox activado. Los comandos de shell del agente están limitados a los directorios del proyecto y de Neo.",
  "prompt.action.sandbox.disabled":
    "Sandbox desactivado. Haz clic para limitar las escrituras de los comandos de shell del agente a los directorios del proyecto y de Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Las escrituras se limitan a los directorios del proyecto y de Neo.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Neo para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Neo se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Neo ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Neo",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Neo no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Neo incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Neo",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Neo en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Neo.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Neo",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Neo.",
  ...
  "settings.indexing.neoModel.title": "Preajuste de modelo de Neo",
  "settings.indexing.neoModel.description": "Elige un modelo de embeddings alojado por Neo compatible.",
  "settings.indexing.neoSignIn.title": "Se requiere iniciar sesión en Neo",
  "settings.indexing.neoSignIn.description": "Inicia sesión en Neo para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Neo Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Neo abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Neo Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Neo {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Neo local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Neo {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeNeo": "Configuración .neo de Home",
  "settings.config.source.homeNeocode": "Configuración .neocode de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectNeo": "Configuración .neo del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectNeocode": "Configuración heredada .neocode",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando neo import",
  ...
  "deviceAuth.title": "Iniciar sesión en Neo Code",
  ...
  "profile.action.login": "Iniciar sesión con Neo Code",
  ...
  "profile.pass.subscribe": "Obtén Neo Pass para añadir créditos y ganar bonificaciones",
  ...
  "settings.aboutneocode.title": "Acerca de Neo Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Neo Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutneocode.status.connected": "Conectado",
  "settings.aboutneocode.status.connecting": "Conectando...",
  "settings.aboutneocode.status.disconnected": "Desconectado",
  "settings.aboutneocode.status.error": "Error",
  "settings.aboutneocode.cliServer": "Servidor CLI",
  "settings.aboutneocode.status.label": "Estado:",
  "settings.aboutneocode.port.label": "Puerto:",
  "settings.aboutneocode.versionInfo": "Información de versión",
  "settings.aboutneocode.version.label": "Versión:",
  "settings.aboutneocode.extensionName": "Extensión Neo Code",
  "settings.aboutneocode.community": "Comunidad y soporte",
  "settings.aboutneocode.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutneocode.feedback.or": "o",
  "settings.aboutneocode.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutneocode.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutneocode.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Transferencia de ajustes",
  "settings.aboutneocode.settingsTransfer.description":
    "Exporta o importa tus ajustes para transferirlos entre instancias de VS Code.",
  "settings.aboutneocode.exportSettings": "Exportar",
  "settings.aboutneocode.importSettings": "Importar",
  "settings.aboutneocode.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutneocode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Neo.",
  "settings.aboutneocode.importSettings.tooLarge":
    "El archivo es demasiado grande. Los archivos de ajustes deben ser menores de 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Neo. Algunos ajustes podrían ignorarse.",
  "settings.aboutneocode.importSettings.success":
    "Ajustes importados. Revise los cambios anteriores y luego haga clic en Guardar.",

  "settings.aboutneocode.telemetry.title": "Telemetría",
  "settings.aboutneocode.telemetry.description":
  ...
  "settings.aboutneocode.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Neo Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Neo a través de Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Neo para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Neo Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Neo Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Neo Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Neo utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en neo.jsonc o pida al agente que los añada.",
  ...
  "settings.sandboxing.enabled.description":
    "Ejecutar los comandos de shell del agente dentro de un sandbox a nivel de sistema operativo que restringe las escrituras a los directorios de estado del proyecto y de Neo",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Neo de forma independiente a VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migración heredada",
  "settings.aboutneocode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Neo Code, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutneocode.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Neo. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Neo durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
