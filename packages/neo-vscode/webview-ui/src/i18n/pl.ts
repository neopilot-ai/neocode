export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. Neo nie uruchamia instalatora za Ciebie.",
  ...
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo nie mógł uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i w razie potrzeby uruchom ją ponownie.",
  ...
  "provider.anaconda.state.ready":
    "Neo znalazł sprawny lokalny serwer generowania tekstu i może zaimportować jego bieżące ustawienia połączenia.",
  ...
  "provider.anaconda.toast.refreshed.description": "Aktywny serwer lokalny i modele są aktualne w Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo nie mógł sprawdzić dostępnych umiejętności.",
  "agentRequirements.error.mcpStatusFailed": "Neo nie mógł sprawdzić stanu serwera MCP.",
  "agentRequirements.error.scopeMismatch": "To sprawdzenie wymagań agenta nie jest już aktywne.",
  "agentRequirements.error.requestFailed": "Neo nie mógł sprawdzić wymagań agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Neo",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox jest włączony. Polecenia shell agenta są ograniczone do katalogów projektu i Neo.",
  "prompt.action.sandbox.disabled":
    "Sandbox jest wyłączony. Kliknij, aby ograniczyć zapisy poleceń shell agenta do katalogów projektu i Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Zapisy są ograniczone do katalogów projektu i Neo.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Neo, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer Neo, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Neo ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Neo",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Neo nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Neo zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Neo",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Neo na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Neo.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Neo",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Neo.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Neo Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Neo, bez lock-inu.",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele Neo Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Neo ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Neo.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Neo ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeNeo": "Konfiguracja .neo (Home)",
  "settings.config.source.homeNeocode": "Konfiguracja .neocode (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectNeo": "Konfiguracja .neo projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectNeocode": "Przestarzała konfiguracja .neocode",
  ...
  "workStyle.onboarding.welcome": "Witamy w Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie neo import",
  ...
  "deviceAuth.title": "Zaloguj się do Neo Code",
  ...
  "profile.action.login": "Zaloguj się przez Neo Code",
  ...
  "profile.pass.subscribe": "Zdobądź Neo Pass, aby dodać środki i zdobywać bonusy",
  ...
  "settings.aboutneocode.title": "O Neo Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Neo Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutneocode.status.connected": "Połączono",
  "settings.aboutneocode.status.connecting": "Łączenie...",
  "settings.aboutneocode.status.disconnected": "Rozłączono",
  "settings.aboutneocode.status.error": "Błąd",
  "settings.aboutneocode.cliServer": "Serwer CLI",
  "settings.aboutneocode.status.label": "Status:",
  "settings.aboutneocode.port.label": "Port:",
  "settings.aboutneocode.versionInfo": "Informacje o wersji",
  "settings.aboutneocode.version.label": "Wersja:",
  "settings.aboutneocode.extensionName": "Rozszerzenie Neo Code",
  ...
  "settings.aboutneocode.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutneocode.exportSettings": "Eksportuj",
  "settings.aboutneocode.importSettings": "Importuj",
  "settings.aboutneocode.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutneocode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Neo.",
  "settings.aboutneocode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Neo. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Neo Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta Neo za pośrednictwem Neo Gateway.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Neo Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.neoModel.title": "Preset modelu Neo",
  "settings.indexing.neoModel.description": "Wybierz obsługiwany model osadzania hostowany przez Neo.",
  "settings.indexing.neoSignIn.title": "Wymagane logowanie do Neo",
  "settings.indexing.neoSignIn.description": "Zaloguj się do Neo, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Neo korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w neo.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.sandboxing.enabled.description":
    "Uruchamiaj polecenia shell agenta w sandboxie na poziomie systemu operacyjnego, który ogranicza zapisy do katalogów stanu projektu i Neo",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Neo niezależnie od VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutneocode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Neo Code, w tym klucze API dostawców i domyślny model.",
  "settings.aboutneocode.rooImport.description": "Importuj historię rozmów z instalacji Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importuj sesje z Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Neo. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Neo w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
