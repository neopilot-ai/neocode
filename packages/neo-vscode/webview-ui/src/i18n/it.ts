export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. Neo non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.signedOut": "Apri Anaconda Desktop e accedi prima di connettere Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "Neo ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
  ...
  "provider.anaconda.toast.refreshed.description": "Il server locale attivo e i modelli sono aggiornati in Neo.",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Neo",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in Neo.",
  ...
  "dialog.server.description": "Cambia il server Neo a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di Neo ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Neo",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: Neo non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Neo include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di Neo",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Neo sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Neo.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando Neo si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di Neo.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider Neo Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere Neo aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config Neo {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Neo locale.",
  "settings.config.openFailed": "Apertura file config Neo {{scope}} non riuscita: {{message}}",
  "settings.config.source.xdg": "Config globale XDG",
  "settings.config.source.homeNeo": "Config home .neo",
  "settings.config.source.homeNeocode": "Config home .neocode",
  "settings.config.source.homeOpencode": "Config home .opencode",
  "settings.config.source.envFile": "File ambiente NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Config ambiente inline",
  "settings.config.source.projectNeo": "Config progetto .neo",
  "settings.config.source.projectRoot": "Config root progetto",
  "settings.config.source.projectNeocode": "Config legacy progetto .neocode",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo si mette in pausa e ti mostra il suo piano mentre lavora.",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando neo import",
  ...
  "deviceAuth.title": "Accedi a Neo Code",
  ...
  "profile.action.login": "Accedi con Neo Code",
  ...
  "profile.pass.subscribe": "Ottieni Neo Pass per aggiungere crediti e guadagnare bonus",
  ...
  "settings.aboutneocode.title": "Informazioni su Neo Code",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Neo Code è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutneocode.status.connected": "Connesso",
  "settings.aboutneocode.status.connecting": "Connessione...",
  "settings.aboutneocode.status.disconnected": "Disconnesso",
  "settings.aboutneocode.status.error": "Errore",
  "settings.aboutneocode.cliServer": "Server CLI",
  "settings.aboutneocode.status.label": "Stato:",
  "settings.aboutneocode.port.label": "Porta:",
  "settings.aboutneocode.versionInfo": "Informazioni versione",
  "settings.aboutneocode.version.label": "Versione:",
  "settings.aboutneocode.extensionName": "Estensione Neo Code",
  "settings.aboutneocode.community": "Community e supporto",
  "settings.aboutneocode.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutneocode.feedback.or": "oppure",
  "settings.aboutneocode.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutneocode.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutneocode.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutneocode.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutneocode.exportSettings": "Esporta",
  "settings.aboutneocode.importSettings": "Importa",
  "settings.aboutneocode.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutneocode.importSettings.invalidConfig": "Il file non contiene impostazioni Neo valide.",
  "settings.aboutneocode.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di Neo. Alcune impostazioni potrebbero essere ignorate.",
  "settings.aboutneocode.importSettings.success":
    "Impostazioni importate. Controlla le modifiche sopra, poi fai clic su Salva.",
  "settings.aboutneocode.telemetry.title": "Telemetria",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Neo Code. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Neo Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox abilitata. I comandi shell dell'agente sono limitati alle directory del progetto e di Neo.",
  "prompt.action.sandbox.disabled":
    "Sandbox disabilitata. Fai clic per limitare le scritture dei comandi shell dell'agente alle directory del progetto e di Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Le scritture sono limitate alle directory del progetto e di Neo.",
  ...
  "settings.sandboxing.enabled.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di Neo",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Neo usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in neo.jsonc, o chiedi all'agente di aggiungerli per te.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Neo indipendentemente da VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Migrazione legacy",
  "settings.aboutneocode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Neo Code, incluse API key dei provider e modello predefinito.",
  "settings.aboutneocode.rooImport.description":
    "Importa la cronologia delle conversazioni da una installazione di Roo Code.",
  "settings.aboutneocode.rooImport.button": "Importa sessioni da Roo Code",
  "migration.whatsNew.title": "Novità in Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto Neo. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Neo durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account Neo tramite Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Abilita e accedi al provider Neo per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite Neo Gateway.",
  "settings.models.speechToTextModel.title": "Modello Da voce a testo",
  "settings.models.speechToTextModel.description": "Scegli il modello di trascrizione Neo Gateway per l'input vocale.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli Neo Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.neoModel.title": "Preset modello Neo",
  "settings.indexing.neoModel.description": "Scegli un modello embedding ospitato da Neo.",
  "settings.indexing.neoSignIn.title": "Accesso Neo richiesto",
  "settings.indexing.neoSignIn.description": "Accedi a Neo per usare gli embedding ospitati.",
  ...
  "agentRequirements.error.discoveryFailed": "Neo non ha potuto controllare le skill disponibili.",
  "agentRequirements.error.mcpStatusFailed": "Neo non ha potuto controllare lo stato del server MCP.",
  "agentRequirements.error.scopeMismatch": "Questo controllo dei requisiti dell’agente non è più attivo.",
  "agentRequirements.error.requestFailed": "Neo non ha potuto controllare i requisiti dell’agente.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Neo per usare l'input vocale.",
