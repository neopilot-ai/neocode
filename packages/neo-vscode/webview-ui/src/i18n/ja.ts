export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "このマシンに Anaconda Desktop をインストールしてから、ここに戻ってください。Neo はインストーラーを実行しません。",
  ...
  "provider.anaconda.state.signedOut": "Neo を接続する前に、Anaconda Desktop を開いてサインインしてください。",
  "provider.anaconda.state.unauthorized":
    "Neo は Anaconda Desktop にアクセスできませんでした。Desktop を開いて再度サインインし、必要に応じて再起動してください。",
  ...
  "provider.anaconda.state.ready":
    "Neo は正常なローカルのテキスト生成サーバーを見つけ、現在の接続設定をインポートできます。",
  ...
  "provider.anaconda.toast.refreshed.description": "アクティブなローカルサーバーとモデルが Neo で最新になりました。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo は利用可能なスキルを確認できませんでした。",
  "agentRequirements.error.mcpStatusFailed": "Neo は MCP サーバーの状態を確認できませんでした。",
  "agentRequirements.error.scopeMismatch": "このエージェント要件の確認はもう有効ではありません。",
  "agentRequirements.error.requestFailed": "Neo はエージェント要件を確認できませんでした。",
  ...
  "dialog.model.unpaid.freeModels.title": "Neoが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Neoで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNeoで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Neoで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.sandbox.enabled":
    "サンドボックスが有効です。エージェントのシェルコマンドは、プロジェクトおよびNeoディレクトリに制限されています。",
  "prompt.action.sandbox.disabled":
    "サンドボックスが無効です。クリックしてエージェントのシェルコマンドの書き込みをプロジェクトおよびNeoディレクトリに制限します。",
  ...
  "prompt.action.sandbox.description.enabled": "書き込みはプロジェクトおよびNeoディレクトリ内に制限されます。",
  ...
  "speechToText.tooltip.start": "Neo Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはNeoにサインインしてください。",
  ...
  "dialog.server.description": "このアプリが接続するNeoサーバーを切り替えます。",
  ...
  "toast.update.description": "Neoの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNeoチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NeoはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Neoには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Neoの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのNeoの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Neoのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Neo の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Neo は最新バージョンです。",
  ...
  "settings.indexing.neoModel.title": "Neoモデルプリセット",
  "settings.indexing.neoModel.description": "サポートされているNeoホスト型埋め込みモデルを選択します。",
  "settings.indexing.neoSignIn.title": "Neoへのサインインが必要です",
  "settings.indexing.neoSignIn.description": "ホスト型埋め込みを使用するにはNeoにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはNeo Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはNeoをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある Neo Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のNeo構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのNeo構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のNeo構成ファイルを開けませんでした: {{message}}",
  "settings.config.source.xdg": "XDGグローバル構成",
  "settings.config.source.homeNeo": "Homeの.neo構成",
  "settings.config.source.homeNeocode": "Homeの.neocode構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "NEO_CONFIG環境ファイル",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectNeo": "プロジェクトの.neo構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectNeocode": "旧.neocode構成",
  ...
  "workStyle.onboarding.welcome": "Neoへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neoは作業中に一時停止し、計画を表示します。",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはneo importコマンド",
  ...
  "deviceAuth.title": "Neo Codeにサインイン",
  ...
  "settings.aboutneocode.title": "Neo Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Neo CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutneocode.status.connected": "接続済み",
  "settings.aboutneocode.status.connecting": "接続中...",
  "settings.aboutneocode.status.disconnected": "切断",
  "settings.aboutneocode.status.error": "エラー",
  "settings.aboutneocode.cliServer": "CLIサーバー",
  "settings.aboutneocode.status.label": "ステータス：",
  "settings.aboutneocode.port.label": "ポート：",
  "settings.aboutneocode.versionInfo": "バージョン情報",
  "settings.aboutneocode.version.label": "バージョン：",
  "settings.aboutneocode.extensionName": "Neo Code拡張機能",
  "settings.aboutneocode.community": "コミュニティとサポート",
  "settings.aboutneocode.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutneocode.feedback.or": "または",
  "settings.aboutneocode.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutneocode.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutneocode.resetSettings.button": "すべての設定をリセット",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "設定の移行",
  "settings.aboutneocode.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutneocode.exportSettings": "エクスポート",
  "settings.aboutneocode.importSettings": "インポート",
  "settings.aboutneocode.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutneocode.importSettings.invalidConfig": "ファイルに有効な Neo の設定が含まれていません。",
  "settings.aboutneocode.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutneocode.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Neo からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutneocode.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutneocode.telemetry.title": "テレメトリ",
  ...
  "settings.aboutneocode.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Neo Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.speechToText.description":
    "Neo Gateway経由でNeoアカウントを使用して、プロンプトフィールドでの音声入力を有効にします。",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text を使用するには、Neo プロバイダーを有効にしてサインインしてください。現在、Speech to Text は Neo Gateway でのみサポートされています。",
  "settings.models.speechToTextModel.title": "音声認識モデル",
  "settings.models.speechToTextModel.description": "音声入力に使用するNeo Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "Neo Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Neo に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。neo.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.sandboxing.enabled.description":
    "エージェントのシェルコマンドを、プロジェクトおよびNeoの状態ディレクトリへの書き込みを制限するOSレベルのサンドボックス内で実行",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Neo webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutneocode.legacyMigration.title": "レガシー移行",
  "settings.aboutneocode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたNeo Codeから設定を移行します。",
  "settings.aboutneocode.rooImport.description": "インストールしたRoo Codeから会話履歴を移行します。",
  "settings.aboutneocode.rooImport.button": "Roo Codeからセッションをインポート",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neo Codeの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのNeo製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Neo が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
