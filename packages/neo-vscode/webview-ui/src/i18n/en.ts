export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Neo does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Neo found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo could not check the available skills.",
  "agentRequirements.error.mcpStatusFailed": "Neo could not check MCP server status.",
  "agentRequirements.error.scopeMismatch": "This agent requirement check is no longer active.",
  "agentRequirements.error.requestFailed": "Neo could not check the agent requirements.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Neo",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Neo.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is enabled. Agent shell commands are confined to the project and Neo directories.",
  "prompt.action.sandbox.disabled":
    "Sandbox is disabled. Click to confine agent shell command writes to the project and Neo directories.",
  ...
  "prompt.action.sandbox.description.enabled": "Writes are limited to the project and Neo directories.",
  ...
  "speechToText.tooltip.start": "Start voice input with Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Neo to use speech input.",
  ...
  "dialog.server.description": "Switch which Neo server this app connects to.",
  ...
  "toast.update.description": "A new version of Neo ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Neo team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Neo does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Neo includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Neo",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Neo looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Neo is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Neo launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Neo.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Neo Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Neo open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Neo config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Neo config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Neo config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeNeo": "Home .neo config",
  "settings.config.source.homeNeocode": "Home .neocode config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "NEO_CONFIG environment file",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectNeo": "Project .neo config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectNeocode": "Legacy .neocode config",
  ...
  "workStyle.onboarding.welcome": "Welcome to Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or neo import command",
  ...
  "deviceAuth.title": "Sign in to Neo Code",
  ...
  "profile.action.login": "Login with Neo Code",
  ...
  "profile.pass.subscribe": "Get Neo Pass to add credits and earn bonuses",
  ...
  "settings.indexing.neoModel.title": "Neo model preset",
  "settings.indexing.neoModel.description": "Choose a supported Neo-hosted embedding model.",
  "settings.indexing.neoSignIn.title": "Neo sign-in required",
  "settings.indexing.neoSignIn.description": "Sign in to Neo to use hosted embeddings.",
  ...
  "settings.aboutneocode.title": "About Neo Code",
  ...
  "settings.aboutneocode.status.connected": "Connected",
  "settings.aboutneocode.status.connecting": "Connecting...",
  "settings.aboutneocode.status.disconnected": "Disconnected",
  ...
  "settings.aboutneocode.versionInfo": "Version Information",
  "settings.aboutneocode.version.label": "Version:",
  "settings.aboutneocode.extensionName": "Neo Code Extension",
  "settings.aboutneocode.community": "Community & Support",
  "settings.aboutneocode.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutneocode.feedback.or": "or",
  "settings.aboutneocode.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutneocode.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutneocode.resetSettings.button": "Reset All Settings",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Settings Transfer",
  ...
  "settings.aboutneocode.exportSettings": "Export",
  "settings.aboutneocode.importSettings": "Import",
  "settings.aboutneocode.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutneocode.importSettings.invalidConfig": "File does not contain valid Neo settings.",
  "settings.aboutneocode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "This file was exported from a newer version of Neo. Some settings may be ignored.",
  "settings.aboutneocode.importSettings.success": "Settings imported. Review the changes above, then click Save.",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Neo Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.speechToText.description":
    "Enable voice input in prompt fields using your Neo account through Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Enable and sign in to the Neo provider to use Speech to Text. Speech to Text is currently only supported through Neo Gateway.",
  "settings.models.speechToTextModel.title": "Speech to Text Model",
  "settings.models.speechToTextModel.description": "Choose the Neo Gateway transcription model for voice input.",
  ...
  "settings.sandboxing.enabled.description":
    "Run agent shell commands inside an OS-level sandbox that restricts writes to the project and Neo state directories",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Neo Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Neo to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in neo.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.fontSize.description": "Adjust the Neo webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Neo Gateway models whose providers may use your prompts for training.",
  ...
  "settings.aboutneocode.legacyMigration.description":
    "Migrate settings from a previous installation of Neo Code, including provider API keys and default model.",
  "settings.aboutneocode.rooImport.description": "Import conversation history from a Roo Code installation.",
  "settings.aboutneocode.rooImport.button": "Import Sessions from Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Neo product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Neo during the current session, based on per-turn snapshots. Resets when you start a new session.",
