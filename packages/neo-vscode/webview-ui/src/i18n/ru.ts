export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этом компьютере, затем вернитесь сюда. Neo не запускает установщик за вас.",
  ...
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением Neo.",
  "provider.anaconda.state.unauthorized":
    "Neo не удалось получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и при необходимости перезапустите его.",
  ...
  "provider.anaconda.state.ready":
    "Neo обнаружил исправный локальный сервер генерации текста и может импортировать его текущие настройки подключения.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активный локальный сервер и модели актуальны в Neo.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Neo не смог проверить доступные навыки.",
  "agentRequirements.error.mcpStatusFailed": "Neo не смог проверить состояние сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Эта проверка требований агента больше не активна.",
  "agentRequirements.error.requestFailed": "Neo не смог проверить требования агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Neo",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Neo.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Neo.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Neo.",
  ...
  "prompt.action.sandbox.enabled": "Песочница включена. Команды оболочки агента ограничены каталогами проекта и Neo.",
  "prompt.action.sandbox.disabled":
    "Песочница отключена. Нажмите, чтобы ограничить запись команд оболочки агента каталогами проекта и Neo.",
  ...
  "prompt.action.sandbox.description.enabled": "Запись разрешена только в каталогах проекта и Neo.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с Neo Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в Neo, чтобы использовать голосовой ввод.",
  ...
  "dialog.server.description": "Переключите сервер Neo к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Neo ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Neo",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Neo пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Neo включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Neo",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Neo выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Neo.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Neo",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Neo.",
  ...
  "settings.indexing.neoModel.title": "Предустановка модели Neo",
  "settings.indexing.neoModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в Neo.",
  "settings.indexing.neoSignIn.title": "Требуется вход в Neo",
  "settings.indexing.neoSignIn.description": "Войдите в Neo, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Neo Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Neo открытым — без привязки к поставщикам.",
  ...
  "settings.models.hidePromptTraining.description":
    "Скрывать модели Neo Gateway, поставщики которых могут использовать ваши запросы для обучения.",
  ...
  "settings.config.source.homeNeocode": "Конфигурация .neocode (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды NEO_CONFIG",
  "settings.config.source.envDir": "NEO_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectNeo": "Конфигурация .neo проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectNeocode": "Устаревшая конфигурация .neocode",
  ...
  "workStyle.onboarding.welcome": "Добро пожаловать в Neo",
  ...
  "workStyle.choice.human-in-the-loop.description": "Neo приостанавливается и показывает свой план по ходу работы.",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда neo import",
  ...
  "deviceAuth.title": "Войти в Neo Code",
  ...
  "profile.action.login": "Войти через Neo Code",
  ...
  "profile.pass.subscribe": "Оформите Neo Pass, чтобы добавить кредиты и получать бонусы",
  ...
  "settings.aboutneocode.title": "О Neo Code",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Neo Code — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutneocode.status.connected": "Подключено",
  "settings.aboutneocode.status.connecting": "Подключение...",
  "settings.aboutneocode.status.disconnected": "Отключено",
  "settings.aboutneocode.status.error": "Ошибка",
  "settings.aboutneocode.cliServer": "CLI-сервер",
  "settings.aboutneocode.status.label": "Статус:",
  "settings.aboutneocode.port.label": "Порт:",
  "settings.aboutneocode.versionInfo": "Информация о версии",
  "settings.aboutneocode.version.label": "Версия:",
  "settings.aboutneocode.extensionName": "Расширение Neo Code",
  "settings.aboutneocode.community": "Сообщество и поддержка",
  "settings.aboutneocode.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutneocode.feedback.or": "или",
  "settings.aboutneocode.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutneocode.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutneocode.resetSettings.button": "Сбросить все настройки",
  "settings.aboutneocode.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutneocode.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutneocode.exportSettings": "Экспорт",
  "settings.aboutneocode.importSettings": "Импорт",
  "settings.aboutneocode.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutneocode.importSettings.invalidConfig": "Файл не содержит допустимых настроек Neo.",
  "settings.aboutneocode.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutneocode.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Neo. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutneocode.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutneocode.telemetry.title": "Телеметрия",
  ...
  "settings.aboutneocode.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Neo Code. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Включите голосовой ввод в полях запросов, используя вашу учетную запись Neo через Neo Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Включите провайдер Neo и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с Neo Gateway.",
  "settings.models.speechToTextModel.title": "Модель речи в текст",
  "settings.models.speechToTextModel.description": "Выберите модель транскрипции Neo Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Neo Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Neo использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в neo.jsonc или попросите агента добавить их.",
  ...
  "settings.sandboxing.enabled.description":
    "Выполнять команды оболочки агента в песочнице на уровне ОС, которая ограничивает запись в каталоги состояния проекта и Neo",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Neo независимо от VS Code.",
  ...
  "settings.aboutneocode.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutneocode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Neo Code, включая API-ключи провайдеров и модель по умолчанию.",
  "settings.aboutneocode.rooImport.description": "Импорт истории переписки из установки Roo Code.",
  "settings.aboutneocode.rooImport.button": "Импортировать сеансы из Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Neo Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Neo. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Neo в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
