export type AutocompleteProviderID = "neo" | "mistral" | "inception"
export type DirectAutocompleteProviderID = Exclude<AutocompleteProviderID, "neo">
...
interface AutocompleteModelBase {
  ...
  /** Provider key to use for direct BYOK. Empty means Neo Gateway. */
...
export type AutocompleteModelDef = AutocompleteModelBase &
  (
    | {
        /** Route through `/neo/edit` using the Next Edit pipeline. */
        readonly kind: "edit"
...
const models: AutocompleteModelDef[] = [
  {
    id: "neo/mistralai/codestral-2508",
    modelID: "mistralai/codestral-2508",
    label: "Codestral",
    providerID: "neo",
    provider: "Neo Gateway",
    requestModel: "mistralai/codestral-2508",
    temperature: 0.2,
  },
  {
    id: "neo/inception/mercury-edit-2",
  ...
  {
    // Same wire-level model as `neo/inception/mercury-edit-2`, but routed
    // through the Neo Gateway's Next Edit endpoint instead of FIM. Picked by
    // users who want multi-line next-edit predictions with the jump-to-edit UX.
    id: "neo/inception/mercury-next-edit",
    ...
    temperature: 0,
    kind: "edit",
    fimModelID: "neo/inception/mercury-edit-2",
  },
  {
...
export const DEFAULT_AUTOCOMPLETE_PROVIDER_ID: AutocompleteProviderID = "neo"
...
export function getAutocompleteModel(provider?: string, model?: string): AutocompleteModelDef {
  // When provider is unset, always default to Neo Gateway. Direct-provider
