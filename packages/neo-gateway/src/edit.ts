import { NEO_API_BASE } from "./api/constants.js"
...
export type EditTarget =
  ...
  | { provider: "neo"; model: string; url: string }
...
const NEO_NEXTEDIT_URL = NEO_API_BASE + "/api/edit/completions"

/**
 * Pick the upstream edit endpoint for a (provider, model) pair. Today this is
 * either Inception's `/v1/edit/completions` (direct BYOK) or the Neo Gateway's
