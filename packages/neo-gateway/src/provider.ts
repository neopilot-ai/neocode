...
import type { NeoProvider, NeoProviderOptions } from "./types.js"
...
/**
 * Create a neocode provider instance
 *
 * This provider wraps the OpenRouter SDK with neocode-specific configuration
 * including custom authentication, headers, and base URL.
 *
 * @example
 * ```typescript
 * const provider = createNeo({
 *   neocodeToken: "your-token-here",
 ...
 * ```
 */
export function createNeo(options: NeoProviderOptions = {}): NeoProvider {
