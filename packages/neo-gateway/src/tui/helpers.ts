/**
 * TUI-specific helper functions for Neo Gateway integration
 *
...
import type { NeocodeProfile, NeocodeBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.neo.khulnasoft.com/organizations/${currentOrgId}/usage-details`
