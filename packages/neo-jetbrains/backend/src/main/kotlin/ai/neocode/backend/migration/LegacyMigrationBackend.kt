...
/**
 * Backend adapter for writing migrated data to the CLI (neo serve).
 *
...
interface LegacyMigrationBackend {
    ...
    /** POST /neocode/session-import/project — returns the project ID */
    fun importProject(project: JsonObject): String

    /** POST /neocode/session-import/session */
    fun importSession(session: JsonObject): LegacyImportResult

    /** POST /neocode/session-import/message */
    fun importMessage(message: JsonObject)

    /** POST /neocode/session-import/part */
