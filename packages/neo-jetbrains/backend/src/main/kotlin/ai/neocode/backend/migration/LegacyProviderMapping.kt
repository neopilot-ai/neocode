...
/**
 * Port of packages/neo-vscode/src/legacy-migration/provider-mapping.ts
 *
...
val PROVIDER_MAP: Map<String, ProviderMapping> = mapOf(
    ...
    "neocode" to ProviderMapping(id = "neo", key = "neocodeToken", name = "Neo (Gateway)", modelField = "neocodeModel", organizationIdField = "neocodeOrganizationId"),
