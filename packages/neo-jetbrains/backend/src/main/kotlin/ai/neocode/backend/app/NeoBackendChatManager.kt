 ...
 *
 * All JSON parsing is delegated to [NeoCliDataParser].
 */
class NeoBackendChatManager(
    ...
    private var normalizer = NeoCliDataParser.ChatEventNormalizer()
    ...
    fun stop() {
        ...
        client = null
        base = null
        normalizer = NeoCliDataParser.ChatEventNormalizer()
    ...
    suspend fun enhancePrompt(dir: String, text: String): String {
        ...
        val url = requireBase()
        val body = NeoCliDataParser.buildEnhancePromptJson(text)
        ...
        return call.await().use { response ->
            ...
            NeoCliDataParser.parseEnhancedPrompt(raw)
        }
    }
    ...
    fun prompt(id: String, dir: String, prompt: PromptDto) {
        ...
        val body = NeoCliDataParser.buildPromptJson(prompt)
    ...
    fun command(id: String, dir: String, command: String, args: String, prompt: PromptDto) {
        ...
        val body = NeoCliDataParser.buildCommandJson(command, args, prompt)
    ...
    fun compact(id: String, dir: String, model: ModelSelectionDto) {
        ...
        val http = requireClient()
        val url = requireBase()
        val body = NeoCliDataParser.buildSummarizeJson(model)
        val request = Request.Builder()
    ...
    suspend fun revert(id: String, dir: String, message: String, part: String?) {
        ...
        val body = NeoCliDataParser.buildRevertJson(message, part)
    ...
    fun messages(id: String, dir: String): List<MessageWithPartsDto> {
        ...
        return http.newCall(request).execute().use { response ->
            ...
            val parsed = NeoCliDataParser.parseMessages(raw)
    ...
    fun updateConfig(dir: String, update: ConfigUpdateDto) {
        ...
        val partial = NeoCliDataParser.buildConfigPartial(update)
    ...
    fun replyPermission(requestId: String, dir: String, reply: PermissionReplyDto) {
        ...
        val body = NeoCliDataParser.buildPermissionReplyJson(reply)
    ...
    fun savePermissionRules(requestId: String, dir: String, rules: PermissionAlwaysRulesDto) {
        ...
        val body = NeoCliDataParser.buildPermissionAlwaysRulesJson(rules)
    ...
    fun replyQuestion(requestId: String, dir: String, answers: QuestionReplyDto) {
        ...
        val body = NeoCliDataParser.buildQuestionReplyJson(answers)
    ...
    fun pendingPermissions(dir: String): List<PermissionRequestDto> {
        ...
        val parsed = NeoCliDataParser.parsePermissionRequests(raw)
    ...
    fun pendingQuestions(dir: String): List<QuestionRequestDto> {
        ...
        val parsed = NeoCliDataParser.parseQuestionRequests(raw)
