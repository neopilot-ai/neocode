 ...
 * [ai.neocode.jetbrains.api.model.*] serialize/deserialize correctly
 ...
 * spec — not our handwritten RPC DTOs in [ai.neocode.rpc.dto.*].
 *
 * Tests here protect against:
 * - OpenAPI generator/schema drift producing incompatible Kotlin classes
 * - Generated enum mappings breaking (e.g. [ai.neocode.jetbrains.api.model.Model.Status])
 * - Unknown CLI response fields causing deserialization failures
 * - Nested generated structures like model [ai.neocode.jetbrains.api.model.Model.capabilities]
 *   not matching expected shapes
 *
 * Do not add assertions for Neo-specific fields here unless those fields
 ...
 * [NeoCliDataParserTest] or workspace mapping tests.
 */
