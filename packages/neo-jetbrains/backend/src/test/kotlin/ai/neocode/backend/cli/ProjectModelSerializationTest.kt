...
import ai.neocode.jetbrains.api.model.AppSkills200ResponseInner
import ai.neocode.jetbrains.api.model.Command
import ai.neocode.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.neocode.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
