...
import ai.neocode.rpc.dto.AgentConfigPatchDto
...
import ai.neocode.rpc.dto.PermissionRuleDto
import ai.neocode.rpc.dto.ModelSelectionDto
import ai.neocode.rpc.dto.ModelStateDto
import ai.neocode.rpc.dto.PartSourceDto
import ai.neocode.rpc.dto.PartSourceTextDto
import ai.neocode.rpc.dto.PromptDto
import ai.neocode.rpc.dto.PromptPartDto
import ai.neocode.rpc.dto.QuestionReplyDto
import ai.neocode.rpc.dto.SkillsPatchDto
...
/**
 * Pure unit tests for [NeoCliDataParser].
 *
...
class NeoCliDataParserTest {
    ...
    inner class SseEvents {
        ...
        fun `extractEventType - parses type from JSON data`() {
            val result = NeoCliDataParser.extractEventType(
        ...
        fun `extractEventType - returns unknown for missing type`() {
            assertEquals("unknown", NeoCliDataParser.extractEventType("""{"data":"something"}"""))
        }

        @Test
        fun `extractEventType - returns unknown for empty string`() {
            assertEquals("unknown", NeoCliDataParser.extractEventType(""))
        }
        ...
        fun `parseChatEvent - message updated with GlobalEvent wrapper`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.updated", data)
        ...
        fun `parseChatEvent - message part delta`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.part.delta", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part updated`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.part.updated", data)
            assertNotNull(result)
        ...
        fun `ChatEventNormalizer - user part updated sanitizes text`() {
            val norm = NeoCliDataParser.ChatEventNormalizer()
        ...
        fun `parseChatEvent - todowrite part parses typed todo metadata`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.part.updated", data) as ChatEventDto.PartUpdated
        ...
        fun `parseChatEvent - turn open`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.turn.open", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - turn close`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.turn.close", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.error", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error preserves nested named error details`() {
            val data = globalEvent("""
                ...
                "properties": {
                    ...
                    "error": {
                        "name": "UnknownError",
                        "data": {
                            "message": "Cannot find module '@neocode/plugin' from '/workspace/.opencode/tool/github-triage.ts'",
                            "ref": "err_123"
                        }
                    }
                }
            ...
            assertEquals("Cannot find module '@neocode/plugin' from '/workspace/.opencode/tool/github-triage.ts'", result.error?.message)
        ...
        fun `parseChatEvent - message removed`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part removed`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("message.part.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session idle`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = NeoCliDataParser.parseChatEvent("session.idle", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session compacted`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = NeoCliDataParser.parseChatEvent("session.compacted", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session updated`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session created`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.created", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.diff", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff clamps large counts`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.diff", data) as ChatEventDto.SessionDiffChanged
        ...
        fun `parseChatEvent - todo updated`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("todo.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session status idle`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("session.status", data) as ChatEventDto.SessionStatusChanged
        ...
        fun `parseChatEvent - permission asked`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("permission.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - permission replied`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("permission.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question asked`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("question.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question replied`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("question.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question rejected`() {
            ...
            val result = NeoCliDataParser.parseChatEvent("question.rejected", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - unknown type returns null`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            assertNull(NeoCliDataParser.parseChatEvent("some.unknown.event", data))
        }

        @Test
        fun `parseChatEvent - malformed JSON returns null`() {
            assertNull(NeoCliDataParser.parseChatEvent("message.updated", "not json"))
        }

        @Test
        fun `parseChatEvent - missing properties returns null`() {
            assertNull(NeoCliDataParser.parseChatEvent("message.updated", """{"payload":{"type":"x"}}"""))
        }
        ...
        fun `parseChatEvent - missing sessionID returns null`() {
            ...
            """)
            assertNull(NeoCliDataParser.parseChatEvent("message.updated", data))
        }
        ...
        fun `parseSessionStatus - valid status event`() {
            ...
            val result = NeoCliDataParser.parseSessionStatus(data)
            assertNotNull(result)
        ...
        fun `parseSessionStatus - missing sessionID returns null`() {
            ...
            assertNull(NeoCliDataParser.parseSessionStatus(data))
        }
        ...
        fun `parsePermissionRequests - parses list`() {
            ...
            val result = NeoCliDataParser.parsePermissionRequests(raw)
        ...
        fun `parsePermissionRequests - empty list`() {
            assertEquals(emptyList(), NeoCliDataParser.parsePermissionRequests("[]"))
        }
        ...
        fun `parseQuestionRequests - parses list`() {
            ...
            val result = NeoCliDataParser.parseQuestionRequests(raw)
            assertEquals(1, result.size)
    ...
    inner class HttpResponses {
        ...
        fun `parseConfig - local mcp server`() {
            val cfg = NeoCliDataParser.parseConfig(
        ...
        fun `parseConfig - disabled mcp form remains present`() {
            val cfg = NeoCliDataParser.parseConfig("""{"mcp":{"sample":{"enabled":false}}}""")
            val mcp = cfg.mcp["sample"]
        ...
        fun `parseConfig - scalars instructions and skills`() {
            val cfg = NeoCliDataParser.parseConfig(
                """{
                    ...
                    "skills":{"paths":[".neo/skills"],"urls":["https://example.test/skill.md"]}
                }"""
            )
            ...
            assertEquals(listOf(".neo/skills"), cfg.skills?.paths)
        ...
        fun `parseConfig - malformed body returns empty config`() {
            assertEquals(ConfigDto(), NeoCliDataParser.parseConfig("not json"))
            assertEquals(ConfigDto(), NeoCliDataParser.parseConfig("[]"))
        }
            ...
            val cfg = NeoCliDataParser.parseConfig(
                """{
                    ...
                    "mcp":{
                        "sample":{
                            "type":"local",
                            "command":["node",".neo/mcp/sample-server.js"],
                            "environment":{"TOKEN":"x"},
                            "enabled":true,
                            "timeout":12000
                        }
        ...
        fun `parseSession - full session response`() {
            ...
            val result = NeoCliDataParser.parseSession(raw)
        ...
        fun `parseMessages - empty array`() {
            assertEquals(emptyList(), NeoCliDataParser.parseMessages("[]"))
        }
        ...
        fun `parseMessages - user and assistant messages`() {
            ...
            val result = NeoCliDataParser.parseMessages(raw)
        ...
        fun `parseMessages - preserves synthetic and source metadata`() {
            ...
            val result = NeoCliDataParser.parseMessages(raw).single()
        ...
        fun `parseMessages - step finish part with tokens`() {
            ...
            val part = NeoCliDataParser.parseMessages(raw)[0].parts[0]
        ...
        fun `parseMessages - malformed JSON returns empty`() {
            assertEquals(emptyList(), NeoCliDataParser.parseMessages("not json"))
        }
        ...
        fun `parseCloudSessions maps cloud session list`() {
            ...
            val result = NeoCliDataParser.parseCloudSessions(raw)
        ...
        fun `parseCloudSessions tolerates malformed response`() {
            assertEquals(emptyList(), NeoCliDataParser.parseCloudSessions("not json").sessions)
            assertNull(NeoCliDataParser.parseCloudSessions("{}").nextCursor)
        }
        ...
        fun `parseProviders - maps provider id, name, source, connected, and defaults`() {
            ...
            val result = NeoCliDataParser.parseProviders(raw)
        ...
        fun `parseProviders - maps model capabilities, limit, and recommendedIndex`() {
            ...
            val provider = NeoCliDataParser.parseProviders(raw).providers[0]
        ...
        fun `parseProviders - maps model preview metadata`() {
            val raw = """{
                "all": [{
                    "id": "neo", "name": "Neo", "source": "api", "env": [], "options": {},
                    "models": {
                        "auto": {
                            "id": "auto",
                            "name": "Neo Auto",
            ...
            val model = NeoCliDataParser.parseProviders(raw).providers.single().models.getValue("auto")
        ...
        fun `parseProviders - malformed optional preview metadata is ignored`() {
            ...
            val model = NeoCliDataParser.parseProviders(raw).providers.single().models.getValue("m")
        ...
        fun `parseProviders - orders variants by effort rank then name`() {
            ...
            val model = NeoCliDataParser.parseProviders(raw).providers[0].models["m"]
            assertNotNull(model)
        ...
        fun `parseProviders - missing collections default to empty`() {
            val result = NeoCliDataParser.parseProviders("""{"all":[],"default":{},"connected":[]}""")
        ...
        fun `parseProviderSettingsProviders - preserves provider metadata and unknown fields`() {
            ...
            val result = NeoCliDataParser.parseProviderSettingsProviders(raw)
        ...
        fun `parseProviderSettingsProviders - malformed metadata becomes null`() {
            ...
            val provider = NeoCliDataParser.parseProviderSettingsProviders(raw).first.single()
        ...
        fun `parseProviders - throws for malformed JSON`() {
            assertFailsWith<Exception> {
                NeoCliDataParser.parseProviders("not json")
            }
        }
        ...
        fun `parseProviders - throws for non-object JSON`() {
            assertFailsWith<Exception> {
                NeoCliDataParser.parseProviders("""[1,2,3]""")
            }
        }
        ...
        fun `parseProviderAuth - maps structured select options`() {
            ...
            val prompt = NeoCliDataParser.parseProviderAuth(raw).getValue("azure").single().prompts.single()
        ...
        fun `parseCommands - maps name, description, source, and hints`() {
            ...
            val result = NeoCliDataParser.parseCommands(raw)
        ...
        fun `parseCommands - empty array`() {
            assertEquals(emptyList<CommandInfo>(), NeoCliDataParser.parseCommands("[]"))
        }
        ...
        fun `parsePathState - extracts state from valid path response`() {
            val raw = """{"home":"/home/user","state":"/home/user/.local/state/neo","config":"/home/user/.config/neo","worktree":"/project","directory":"/project"}"""
            assertEquals("/home/user/.local/state/neo", NeoCliDataParser.parsePathState(raw))
        }

        @Test
        fun `parsePathState - returns null for missing state field`() {
            assertNull(NeoCliDataParser.parsePathState("""{"home":"/home/user"}"""))
        }

        @Test
        fun `parsePathState - returns null for malformed JSON`() {
            assertNull(NeoCliDataParser.parsePathState("not json"))
        }

        @Test
        fun `parsePathState - returns null for non-string state value`() {
            assertNull(NeoCliDataParser.parsePathState("""{"state":42}"""))
            assertNull(NeoCliDataParser.parsePathState("""{"state":null}"""))
            assertNull(NeoCliDataParser.parsePathState("""{"state":{}}"""))
        }
    }
    ...
    inner class RequestBuilders {
        ...
        fun `buildPromptJson - text only`() {
            ...
            val result = NeoCliDataParser.buildPromptJson(prompt)
        ...
        fun `buildProviderOAuthJson - numeric method index`() {
            val result = NeoCliDataParser.buildProviderOAuthJson("0", mapOf("deploymentType" to "github.com"))
        ...
        fun `buildCommandJson - file part includes source metadata`() {
            ...
            val result = NeoCliDataParser.buildCommandJson("review", "", prompt)
        ...
        fun `buildCommandJson - includes agent variant model and arguments`() {
            ...
            val result = NeoCliDataParser.buildCommandJson("review", "src/", prompt)

            assertEquals(
                """{"command":"review","arguments":"src/","agent":"code","variant":"high","model":"neo/gpt-5"}""",
                result,
            )
        }
        ...
        fun `buildSummarizeJson - writes provider and model`() {
            val result = NeoCliDataParser.buildSummarizeJson(ModelSelectionDto("anthropic", "claude-4"))
        ...
        fun `buildRevertJson - writes message only`() {
            val result = NeoCliDataParser.buildRevertJson("m1", null)
            assertEquals("""{"messageID":"m1"}""", result)
        }

        @Test
        fun `buildRevertJson - writes message and part`() {
            val result = NeoCliDataParser.buildRevertJson("m1", "p1")
            assertEquals("""{"messageID":"m1","partID":"p1"}""", result)
        }

        @Test
        fun `buildRevertJson - escapes ids`() {
            val result = NeoCliDataParser.buildRevertJson("m\"\\1", "p\"\\1")
        ...
        fun `buildConfigPartial - model only`() {
            val result = NeoCliDataParser.buildConfigPartial(ConfigUpdateDto(model = "anthropic/claude-4"))
            assertEquals("""{"model":"anthropic/claude-4"}""", result)
        }

        @Test
        fun `buildConfigPartial - agent and temperature`() {
            val result = NeoCliDataParser.buildConfigPartial(
        ...
        fun `buildConfigPartial - empty update`() {
            val result = NeoCliDataParser.buildConfigPartial(ConfigUpdateDto())
            assertEquals("{}", result)
        }
        ...
        fun `buildConfigPatch - top-level model set`() {
            ...
            assertEquals("{\"model\":\"anthropic/claude\"}", NeoCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - top-level model clear emits null`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to null))
            assertEquals("{\"model\":null}", NeoCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - small and subagent values`() {
            val patch = ConfigPatchDto(values = linkedMapOf("small_model" to "neo/auto-small", "subagent_model" to null, "subagent_variant" to null))
            assertEquals("{\"small_model\":\"neo/auto-small\",\"subagent_model\":null,\"subagent_variant\":null}", NeoCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - per-agent model set`() {
            val patch = ConfigPatchDto(agents = linkedMapOf("code" to AgentConfigPatchDto(model = "neo/gpt-5")))
            assertEquals("{\"agent\":{\"code\":{\"model\":\"neo/gpt-5\"}}}", NeoCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent model clear emits null`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"model\":null}}}", NeoCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent description patch does not clear model`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"description\":\"New description\"}}}", NeoCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - agent behavior top-level fields`() {
            val patch = ConfigPatchDto(
                ...
                skills = SkillsPatchDto(paths = listOf(".neo/skills"), urls = listOf("https://example.com/skill")),
            )

            assertEquals(
                "{\"default_agent\":\"build\",\"instructions\":[\"AGENTS.md\"],\"skills\":{\"paths\":[\".neo/skills\"],\"urls\":[\"https://example.com/skill\"]}}",
                NeoCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - full agent permission object`() {
            ...
            assertEquals(
                "{\"agent\":{\"custom\":{\"model\":\"neo/gpt-5\",\"mode\":\"primary\",\"hidden\":false,\"temperature\":0.2,\"top_p\":0.9,\"steps\":12,\"permission\":{\"bash\":{\"*\":\"ask\",\"npm test\":\"allow\"},\"read\":null}}}}",
                NeoCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - empty patch`() {
            assertEquals("{}", NeoCliDataParser.buildConfigPatch(ConfigPatchDto()))
        }

        @Test
        fun `buildConfigPatch - escapes special characters`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to "neo/a\\b\"c"))
            assertEquals("{\"model\":\"neo/a\\\\b\\\"c\"}", NeoCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPartial - temperature without agent defaults to ask`() {
            val result = NeoCliDataParser.buildConfigPartial(ConfigUpdateDto(temperature = 0.5))
        ...
        fun `buildPermissionReplyJson - once reply`() {
            val result = NeoCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once"))
            assertEquals("""{"reply":"once"}""", result)
        }

        @Test
        fun `buildPermissionReplyJson - always reply with message`() {
            val result = NeoCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "always", message = "approved"))
        ...
        fun `buildPermissionAlwaysRulesJson - approved list`() {
            val result = NeoCliDataParser.buildPermissionAlwaysRulesJson(
        ...
        fun `buildQuestionReplyJson - single question single answer`() {
            val result = NeoCliDataParser.buildQuestionReplyJson(QuestionReplyDto(answers = listOf(listOf("A"))))
            assertEquals("""{"answers":[["A"]]}""", result)
        }

        @Test
        fun `buildQuestionReplyJson - multiple questions`() {
            val result = NeoCliDataParser.buildQuestionReplyJson(
        ...
        fun `parseModelState - parses favorites`() {
            val result = NeoCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"neo","modelID":"auto"},{"providerID":"openai","modelID":"gpt"}]}""",
            )
            assertEquals(listOf("neo/auto", "openai/gpt"), result.favorite.map { "${it.providerID}/${it.modelID}" })
        }
        ...
        fun `parseModelState - parses model selections and variants`() {
            val result = NeoCliDataParser.parseModelState(
                """{"model":{"code":{"providerID":"neo","modelID":"auto"}},"variant":{"neo/auto":"medium"}}""",
            )
            assertEquals("neo", result.model["code"]?.providerID)
            assertEquals("auto", result.model["code"]?.modelID)
            assertEquals("medium", result.variant["neo/auto"])
        }

        @Test
        fun `parseModelState - drops malformed favorites`() {
            val result = NeoCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"neo"},false,{"providerID":"openai","modelID":"gpt"}]}""",
            )
        ...
        fun `parseModelState - malformed inputs return empty favorites`() {
            for (raw in listOf("", "not-json", "[]", "42", "null")) {
                assertTrue(NeoCliDataParser.parseModelState(raw).favorite.isEmpty(), raw)
            }
        }
        ...
        fun `parseModelState - drops malformed model selections and variants`() {
            val result = NeoCliDataParser.parseModelState(
                """{"model":{"bad":false,"ok":{"providerID":"neo","modelID":"auto"}},"variant":{"":"low","neo/auto":false,"openai/gpt":"high"}}""",
            )
        ...
        fun `buildModelStateJson - preserves unrelated keys and replaces favorites`() {
            val raw = """{"model":{"code":{"providerID":"neo","modelID":"auto"}},"recent":[{"providerID":"old","modelID":"recent"}],"variant":{"neo/auto":"fast"},"extra":true,"favorite":[]}"""
            val result = NeoCliDataParser.buildModelStateJson(raw, listOf(ModelSelectionDto("anthropic", "claude")))
            ...
            assertEquals(listOf("anthropic/claude"), NeoCliDataParser.parseModelState(result).favorite.map { "${it.providerID}/${it.modelID}" })
        }

        @Test
        fun `buildModelStateJson - writes model selections and variants`() {
            val raw = """{"recent":[],"extra":true}"""
            val result = NeoCliDataParser.buildModelStateJson(
                raw,
                ModelStateDto(
                    model = mapOf("code" to ModelSelectionDto("neo", "auto")),
                    variant = mapOf("neo/auto" to "medium"),
                    recent = listOf(ModelSelectionDto("anthropic", "claude")),
                ),
            )

            val state = NeoCliDataParser.parseModelState(result)
    ...
    fun `sanitizeUserPromptText - removes read payload lines`() {
        ...
        assertEquals("before\nafter", NeoCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - preserves ordinary prose without path key`() {
        ...
        assertEquals(text, NeoCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - collapses only blanks introduced by payload removal`() {
        ...
        assertEquals("before\n\nafter\n\n\nkeep", NeoCliDataParser.sanitizeUserPromptText(text))
    }
