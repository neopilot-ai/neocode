...
import ai.neocode.jetbrains.api.infrastructure.Serializer
import ai.neocode.jetbrains.api.model.Config
import ai.neocode.jetbrains.api.model.GlobalHealth200Response
import ai.neocode.jetbrains.api.model.NeoNotifications200ResponseInner
import ai.neocode.jetbrains.api.model.NeoNotifications200ResponseInnerAction
import ai.neocode.jetbrains.api.model.NeoProfile200Response
import ai.neocode.jetbrains.api.model.NeoProfile200ResponseBalance
import ai.neocode.jetbrains.api.model.NeoProfile200ResponseProfile
import ai.neocode.jetbrains.api.model.NeoProfile200ResponseProfileOrganizationsInner
...
class ApiModelSerializationTest {
    ...
    @Test
    fun `NeoNotifications200ResponseInner with action`() {
        val src = """{
            "id": "notif-1",
        ...
        val obj = json.decodeFromString<NeoNotifications200ResponseInner>(src)
    ...
    @Test
    fun `NeoNotifications200ResponseInner without action`() {
    ...
    @Test
    fun `NeoNotifications200ResponseInner with showIn and suggestModelId`() {
        val src = """{
            "id": "n3",
            "title": "Try new model",
    ...
    fun `empty notifications array`() {
        val list = json.decodeFromString<List<NeoNotifications200ResponseInner>>("[]")
        assertTrue(list.isEmpty())
    }

    @Test
    fun `NeoProfile200Response with balance`() {
        val src = """{
        ...
        val obj = json.decodeFromString<NeoProfile200Response>(src)
    ...
    @Test
    fun `NeoProfile200Response with null balance`() {
        val src = """{
    ...
    @Test
    fun `NeoProfile200Response with organizations`() {
        val src = """{
            "profile": {
                "email": "user@test.com",
                "organizations": [
    ...
    @Test
    fun `NeoProfile200Response with neo pass`() {
        val src = """{
            "profile": {"email": "user@test.com"},
        ...
        val obj = json.decodeFromString<NeoProfile200Response>(src)
        assertNotNull(obj.neoPass)
        assertEquals(199.0, obj.neoPass!!.currentPeriodBaseCreditsUsd)
        assertEquals(73.27, obj.neoPass!!.currentPeriodUsageUsd)
        assertEquals(99.5, obj.neoPass!!.currentPeriodBonusCreditsUsd)
        assertEquals("2026-07-01T00:00:00.000Z", obj.neoPass!!.nextBillingAt)
    }
