package ai.neocode.client.session.ui.mode

import ai.neocode.client.plugin.NeoBundle
import ai.neocode.client.session.ui.PickerRow
...
internal class ModePickerRenderer(
    ...
    private val badge = JBLabel(FilledBadgeIcon(NeoBundle.message("mode.picker.deprecated"), UiStyle.Badge.Alert)).apply {
