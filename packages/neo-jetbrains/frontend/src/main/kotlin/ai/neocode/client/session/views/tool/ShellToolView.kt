...
import ai.neocode.client.session.ui.popup.HeaderPopupBody
...
import ai.neocode.client.session.views.base.SecondarySessionPartView
import ai.neocode.client.ui.UiStyle
import ai.neocode.client.ui.md.MdCodeBlockBorder
import ai.neocode.client.ui.md.MdCodeBlockFactory
import ai.neocode.client.ui.md.MdCodeBlockOptions
import ai.neocode.client.ui.md.MdViewFactory
import ai.neocode.client.ui.md.hybrid.MdTerminal
...
private data class ShellContent(
    ...
    val markdown: String = buildString {
        section(NeoBundle.message("session.part.tool.shell.command"), command, "shell-command")
        section(NeoBundle.message("session.part.tool.shell.output"), rawOutput, outputLang(rawOutput))
        section(NeoBundle.message("session.part.tool.shell.error"), rawError, "ansi-stderr")
    }
}
