package ai.neocode.client.session.ui.editor
...
internal open class SessionEditorTextField(
    ...
    private val undo = action(NeoBundle.message("session.editor.undo"), true)
    private val redo = action(NeoBundle.message("session.editor.redo"), false)
