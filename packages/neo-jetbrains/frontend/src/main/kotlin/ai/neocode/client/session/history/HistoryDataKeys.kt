...
object HistoryDataKeys {
    val SELECTION: DataKey<HistorySelection> = DataKey.create("ai.neocode.client.session.history.HistorySelection")
    val CONTROLLER: DataKey<HistoryController> = DataKey.create("ai.neocode.client.session.history.HistoryController")
}
