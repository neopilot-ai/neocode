...
class NeoVirtualFile(
    ...
    override fun getFileSystem(): NeoVirtualFileSystem = NeoVirtualFileSystem.getInstance()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is NeoVirtualFile) return false
        return path == other.path
    }

    override fun hashCode(): Int = path.hashCode()

    private fun kind(): NeoVirtualFileKind? = service<NeoVirtualFileKindRegistry>().get(path.kind)
}
