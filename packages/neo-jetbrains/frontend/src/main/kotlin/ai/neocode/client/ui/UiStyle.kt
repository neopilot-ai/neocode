    ...
    object Badge {
        ...
        object Primary : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Neo.History.activityBadgeBackground",
                JBUI.CurrentTheme.Link.Foreground.ENABLED,
            )

            override fun fg(): Color = JBColor.namedColor(
                "Neo.History.activityBadgeForeground",
                Color.WHITE,
            )
        }
        ...
        object Highlight : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Neo.ModelPicker.freeBadgeBackground",
                JBColor(0x95D6AC, 0x7FCA99),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Neo.ModelPicker.freeBadgeForeground",
                JBColor.WHITE,
            )
        }
        ...
        object Alert : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Neo.History.runningBadgeBackground",
                JBColor(0xF5C542, 0x7A5A00),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Neo.History.runningBadgeForeground",
