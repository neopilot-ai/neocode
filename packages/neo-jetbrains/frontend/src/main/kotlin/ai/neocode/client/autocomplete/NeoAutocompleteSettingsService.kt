package ai.neocode.client.autocomplete
...
@State(
    name = "NeoAutocompleteSettings",
    storages = [Storage("neoAutocompleteSettings.xml")],
)
class NeoAutocompleteSettingsService : PersistentStateComponent<NeoAutocompleteSettingsService.State> {
    ...
    companion object {
        fun getInstance(): NeoAutocompleteSettingsService = service()
    }
}
