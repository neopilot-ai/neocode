 ...
 *
 * Both [ai.neocode.client.session.views.question.QuestionView] and
 * [ai.neocode.client.session.views.LoginRequiredView] use this as their
...
class BaseQuestionView(
     ...
     * [ai.neocode.client.session.views.question.QuestionView]). Calling with
