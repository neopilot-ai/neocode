 ...
 * driven by [ai.neocode.client.session.ui.SessionLayout] so that each
 ...
 * messages is owned by [ai.neocode.client.session.ui.SessionLayout].
 */
class MessageView(
    val msg: Message,
...
) : ai.neocode.client.session.ui.SessionLayoutPanel(
