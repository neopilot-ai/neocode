package ai.neocode.client.session.scroll
...
internal class SessionScroll(
    ...
    init {
        jump = JBLabel(ScrollButtonIcon.create()).apply {
            ...
            toolTipText = NeoBundle.message("session.scroll.bottom")
            isVisible = false
    ...
    private fun syncIcon() {
        ...
        jump.toolTipText = NeoBundle.message(if (question) "session.scroll.question" else "session.scroll.bottom")
    }
