...
/**
 * Toolbar action that opens the Neo User Profile settings page.
 *
...
class ShowProfileAction : DumbAwareAction(
    NeoBundle.message("action.Neo.ShowProfile.text"),
    NeoBundle.message("action.Neo.ShowProfile.description"),
