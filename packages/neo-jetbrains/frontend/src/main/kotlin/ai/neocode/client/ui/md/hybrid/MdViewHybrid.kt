package ai.neocode.client.ui.md.hybrid
...
import ai.neocode.client.ui.md.MdCommon
import ai.neocode.client.ui.md.MdStyle
...
internal open class MdViewHybrid(
    ...
    companion object {
        private val LOG = NeoLog.create(MdViewHybrid::class.java)
    }
