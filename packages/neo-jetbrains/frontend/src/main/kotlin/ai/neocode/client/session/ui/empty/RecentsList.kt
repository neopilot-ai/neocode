...
import ai.neocode.client.session.history.HistoryActivitySnapshot
import ai.neocode.client.session.history.HistoryTime
import ai.neocode.client.session.history.LocalHistoryItem
import ai.neocode.client.session.history.itemAt
...
internal class RecentsList(
    ...
    private val title = JBLabel(NeoBundle.message("session.empty.recent")).apply {
