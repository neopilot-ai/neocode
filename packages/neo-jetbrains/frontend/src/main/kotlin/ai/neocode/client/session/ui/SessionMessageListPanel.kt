...
class SessionMessageListPanel(
    ...
    private val openAttachment: (String, FileAttachment) -> Unit = { _, item -> ai.neocode.client.session.views.AttachmentView.openDefault(item, openFile, openUrl) },
    ...
    private fun onTurnAdded(turn: ai.neocode.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.neocode.client.session.model.Turn) {
