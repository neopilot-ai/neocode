...
class ReadToolViewTest : BasePlatformTestCase() {
    ...
    fun `test read file output renders filename hyperlink`() {
        ...
        val path = "/Users/kirillk/work/neocode/.neo/worktrees/agreeable-marlin/packages/neo-jetbrains/frontend/src/test/kotlin/ai/neocode/client/session/SessionUiLayoutTest.kt"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>file</type>
    ...
    fun `test read directory output remains plain text`() {
        val path = "/Users/kirillk/work/neocode/packages/neo-jetbrains"
        val t = tool().also {
            it.output = """
                <path>$path</path>
                <type>directory</type>
