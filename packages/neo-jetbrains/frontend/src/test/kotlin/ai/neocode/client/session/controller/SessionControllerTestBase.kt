...
/**
 * Base class for [ai.neocode.client.session.controller.SessionController] tests.
 *
...
abstract class SessionControllerTestBase : BasePlatformTestCase() {
    ...
    protected data class Snapshot(
        ...
        val diff: List<ai.neocode.rpc.dto.DiffFileDto>,
        val todos: List<ai.neocode.rpc.dto.TodoDto>,
        val compacted: Int,
    ) {
    ...
    protected lateinit var sessions: NeoSessionService
    protected lateinit var app: NeoAppService
    protected lateinit var workspaces: NeoWorkspaceService
    ...
    override fun setUp() {
        ...
        app = NeoAppService(scope, appRpc)
        workspaces = NeoWorkspaceService(scope, projectRpc)
    ...
    protected fun controller(
        ...
        val m = SessionController(
            ...
            timers = timers,
            log = log ?: NeoLog.create(SessionController::class.java),
        )
        controllers.add(m)
        roots[m] = root
        return m
    ...
    protected fun assertQuestionReply(expected: String, replies: List<Triple<String, String, ai.neocode.rpc.dto.QuestionReplyDto>>) {
    ...
    protected fun workspaceReady(
        ...
        connected: List<String> = listOf("neo"),
        defaults: Map<String, String> = emptyMap(),
    ) = NeoWorkspaceStateDto(
