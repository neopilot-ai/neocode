...
/**
 * Fake [NeoWorkspaceRpcApi] for testing.
 *
 ...
 */
class FakeWorkspaceRpcApi : NeoWorkspaceRpcApi {

    var directory = "/test"
    val state = MutableStateFlow(NeoWorkspaceStateDto(NeoWorkspaceStatusDto.PENDING))
    var reloads = 0
        private set
    ...
    var openResult = true
    var localConfigPath = "/test/.neo/neo.jsonc"
    var globalConfigPath = "/config/neo.jsonc"
