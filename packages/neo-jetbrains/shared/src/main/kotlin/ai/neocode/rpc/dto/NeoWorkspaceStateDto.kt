...
@Serializable
enum class NeoWorkspaceStatusDto {
    PENDING,
    LOADING,
    READY,
    ERROR,
...
@Serializable
data class NeoWorkspaceLoadProgressDto(
...
@Serializable
data class NeoWorkspaceStateDto(
    val status: NeoWorkspaceStatusDto,
    val progress: NeoWorkspaceLoadProgressDto? = null,
