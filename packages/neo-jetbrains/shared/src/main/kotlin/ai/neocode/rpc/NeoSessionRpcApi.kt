 ...
 */
@Rpc
interface NeoSessionRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): NeoSessionRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<NeoSessionRpcApi>())
        }
    }
