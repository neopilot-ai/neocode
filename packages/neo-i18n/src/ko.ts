export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway는 코딩 에이전트를 위한 신뢰할 수 있는 최적화된 모델 세트를 제공합니다.",
  "provider.connect.neoGateway.line2": "하나의 API 키로 Claude, GPT, Gemini, GLM 등의 모델을 사용할 수 있습니다.",
  "provider.connect.neoGateway.visit.prefix": "",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": "를 방문하여 API 키를 받으세요.",
  "provider.connect.neoGateway.byok.prefix": "더 많은 사용 통계를 보려면 ",
  "provider.connect.neoGateway.byok.link": "Neo's Gateway를 통해 BYOK",
  "provider.connect.neoGateway.byok.suffix": "를 사용하세요.",

  // Provider settings translations
  "settings.providers.group.recommended": "추천",
  "settings.providers.note.neo": "500개 이상의 AI 모델 이용 가능",
  ...
  "marketplace.install.about.mcp":
    "MCP 서버는 외부 서비스나 로컬 프로그램과 작업할 수 있는 추가 도구를 Neo에 제공합니다.",
  "marketplace.install.about.agent": "에이전트는 자체 지침과 권한을 가진 재사용 가능한 역할을 추가합니다.",
  "marketplace.install.about.skill":
    "스킬은 필요할 때 Neo가 불러올 수 있는 작업별 지침과 리소스를 추가합니다.",
  "marketplace.install.mcp.warning":
    "MCP 서버는 로컬 명령을 실행하거나 외부 서비스에 연결할 수 있습니다. 권한 설정에서 자동으로 허용하지 않는 한 Neo는 도구를 사용하기 전에 권한을 요청합니다.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "이 프로젝트의 Neo 스냅샷을 끕니다. Neo 변경에 대한 실행 취소/다시 실행은 사용할 수 없지만 git은 여전히 모든 것을 추적합니다.",
