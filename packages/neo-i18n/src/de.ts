export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway bietet Ihnen Zugang zu einer kuratierten Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Besuchen Sie ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.neoGateway.byok.prefix": "Für weitere Nutzungsstatistiken ",
  "provider.connect.neoGateway.byok.link": "BYOK via Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": " nutzen.",

  // Provider settings translations
  "settings.providers.group.recommended": "Empfohlen",
  "settings.providers.note.neo": "Zugriff auf 500+ KI-Modelle",
  ...
  "marketplace.install.about.mcp":
    "Ein MCP-Server stellt Neo zusätzliche Werkzeuge für die Arbeit mit externen Diensten oder lokalen Programmen bereit.",
  ...
  "marketplace.install.about.skill":
    "Ein Skill fügt aufgabenspezifische Anweisungen und Ressourcen hinzu, die Neo bei Bedarf laden kann.",
  "marketplace.install.mcp.warning":
    "MCP-Server können lokale Befehle ausführen oder eine Verbindung zu externen Diensten herstellen. Neo fragt vor der Verwendung ihrer Werkzeuge um Erlaubnis, sofern Ihre Berechtigungen dies nicht automatisch erlauben.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Neo-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für Neo-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
