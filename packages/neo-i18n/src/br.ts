export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "O Neo Gateway oferece acesso a um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação.",
  "provider.connect.neoGateway.line2":
    "Com uma única chave de API, você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.neoGateway.visit.prefix": "Visite ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " para obter sua chave de API.",
  "provider.connect.neoGateway.byok.prefix": "Para mais estatísticas de uso, utilize ",
  ...
  "settings.providers.note.neo": "Acesso a mais de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Um servidor MCP fornece ao Neo ferramentas adicionais para trabalhar com serviços externos ou programas locais.",
  "marketplace.install.about.agent": "Um agente adiciona uma função reutilizável com instruções e permissões próprias.",
  "marketplace.install.about.skill":
    "Uma habilidade adiciona instruções e recursos específicos para tarefas que o Neo pode carregar quando necessário.",
  "marketplace.install.mcp.warning":
    "Servidores MCP podem executar comandos locais ou se conectar a serviços externos. O Neo solicitará permissão antes de usar suas ferramentas, a menos que suas permissões permitam isso automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do Neo para este projeto. Você perde desfazer/refazer das mudanças feitas pelo Neo, mas o git continua rastreando tudo.",
