export const dict = {
  ...
  "provider.connect.neoGateway.line1": "Neo Gateway 为您提供一组精选的可靠优化模型，专为编码代理设计。",
  "provider.connect.neoGateway.line2": "只需一个 API 密钥，您就可以使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.neoGateway.visit.prefix": "访问 ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " 获取您的 API 密钥。",
  "provider.connect.neoGateway.byok.prefix": "如需更多使用统计信息，请",
  "provider.connect.neoGateway.byok.link": "通过 Neo's Gateway 进行 BYOK",
  "provider.connect.neoGateway.byok.suffix": "。",

  // Provider settings translations
  "settings.providers.group.recommended": "推荐",
  "settings.providers.note.neo": "访问 500+ AI 模型",
  ...
  "marketplace.install.about.mcp":
    "MCP 服务器为 Neo 提供用于处理外部服务或本地程序的额外工具。",
  "marketplace.install.about.agent": "智能体会添加一个具有专属指令和权限的可复用角色。",
  "marketplace.install.about.skill": "技能会添加特定任务的指令和资源，Neo 可在需要时加载它们。",
  "marketplace.install.mcp.warning":
    "MCP 服务器可以运行本地命令或连接外部服务。除非你的权限允许自动使用，否则 Neo 会在使用其工具前请求许可。",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "关闭本项目的 Neo 快照。你将失去对 Neo 更改的撤销/重做，但 git 仍会追踪所有内容。",
