export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway gir deg tilgang til et utvalgt sett med pålitelige, optimaliserte modeller for kodingsagenter.",
  "provider.connect.neoGateway.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.neoGateway.visit.prefix": "Besøk ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.neoGateway.byok.prefix": "For mer bruksstatistikk, bruk ",
  ...
  "settings.providers.note.neo": "Tilgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server gir Neo flere verktøy for å arbeide med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent legger til en gjenbrukbar rolle med egne instruksjoner og tillatelser.",
  "marketplace.install.about.skill":
    "En ferdighet legger til oppgavespesifikke instruksjoner og ressurser som Neo kan laste inn ved behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan kjøre lokale kommandoer eller koble til eksterne tjenester. Neo ber om tillatelse før verktøyene brukes, med mindre tillatelsene dine automatisk tillater det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå av Neos snapshots for dette prosjektet. Du mister angre/gjør om for Neo-endringer, men git fortsetter å spore alt.",
