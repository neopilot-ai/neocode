// Neo-specific translations and overrides
// Keys here will override any matching keys from upstream translations
export const dict = {
  // Neo Gateway provider translations
  "provider.connect.neoGateway.line1":
    "Neo Gateway gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.neoGateway.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.neoGateway.visit.prefix": "Visit ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " to collect your API key.",
  "provider.connect.neoGateway.byok.prefix": "For more usage stats, ",
  "provider.connect.neoGateway.byok.link": "BYOK via Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recommended",
  "settings.providers.note.neo": "Access 500+ AI models",
  ...
  "marketplace.install.about.mcp":
    "An MCP server gives Neo additional tools for working with external services or local programs.",
  "marketplace.install.about.agent": "An agent adds a reusable role with its own instructions and permissions.",
  "marketplace.install.about.skill": "A skill adds task-specific instructions and resources that Neo can load when needed.",
  "marketplace.install.mcp.warning":
    "MCP servers can run local commands or connect to external services. Neo will ask for permission before using their tools unless your permissions allow them automatically.",
  ...
  // are still what the backend matches on (see packages/opencode/src/neocode/plan-followup.ts).
  ...
  // packages/opencode/src/neocode/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Neo's snapshots for this project. You will lose undo/redo of Neo file changes, but git still tracks everything.",
