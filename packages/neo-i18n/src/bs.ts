export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway omogućava pristup pažljivo odabranom skupu pouzdanih modela optimizovanih za rad sa agentima za kodiranje.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Posjetite ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " da preuzmete svoj API ključ.",
  "provider.connect.neoGateway.byok.prefix": "Za više statistika korištenja, koristite ",
  "provider.connect.neoGateway.byok.link": "BYOK putem Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Preporučeno",
  "settings.providers.note.neo": "Pristup za 500+ AI modela",
  ...
  "marketplace.install.about.skill":
    "Vještina dodaje upute i resurse za određene zadatke koje Neo može učitati kada su potrebni.",
  "marketplace.install.mcp.warning":
    "MCP serveri mogu pokretati lokalne naredbe ili se povezivati s vanjskim servisima. Neo će zatražiti dozvolu prije korištenja njihovih alata, osim ako vaše dozvole to automatski dopuštaju.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi Neo snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi Neo, ali git i dalje prati sve.",
