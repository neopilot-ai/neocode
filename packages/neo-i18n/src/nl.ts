...
export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway geeft je toegang tot een gecureerde set van betrouwbare, geoptimaliseerde modellen voor coding agents.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Bezoek ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " om je API key op te halen.",
  "provider.connect.neoGateway.byok.prefix": "Voor meer gebruiksstatistieken, gebruik ",
  ...
  "settings.providers.note.neo": "Toegang tot 500+ AI modellen",
  ...
  "marketplace.install.about.mcp":
    "Een MCP-server geeft Neo extra hulpmiddelen om met externe diensten of lokale programma's te werken.",
  "marketplace.install.about.agent": "Een agent voegt een herbruikbare rol toe met eigen instructies en machtigingen.",
  "marketplace.install.about.skill":
    "Een vaardigheid voegt taakspecifieke instructies en bronnen toe die Neo indien nodig kan laden.",
  "marketplace.install.mcp.warning":
    "MCP-servers kunnen lokale opdrachten uitvoeren of verbinding maken met externe diensten. Neo vraagt toestemming voordat hun hulpmiddelen worden gebruikt, tenzij je machtigingen dit automatisch toestaan.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Zet Neo-snapshots uit voor dit project. Je verliest ongedaan maken/opnieuw doen van Neo-wijzigingen, maar git blijft alles volgen.",
