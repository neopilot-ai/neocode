export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway ให้คุณเข้าถึงชุดโมเดลที่คัดสรรมาอย่างดีและเชื่อถือได้สำหรับตัวแทนเขียนโค้ด",
  "provider.connect.neoGateway.line2":
    "ด้วย API key เดียว คุณจะสามารถเข้าถึงโมเดลต่างๆ เช่น Claude, GPT, Gemini, GLM และอื่นๆ",
  "provider.connect.neoGateway.visit.prefix": "เยี่ยมชม ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " เพื่อรับ API key ของคุณ",
  "provider.connect.neoGateway.byok.prefix": "สำหรับสถิติการใช้งานเพิ่มเติม โปรดใช้ ",
  "provider.connect.neoGateway.byok.link": "BYOK ผ่าน Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": "",

  // Provider settings translations
  "settings.providers.group.recommended": "แนะนำ",
  "settings.providers.note.neo": "เข้าถึงโมเดล AI มากกว่า 500 รายการ",
  ...
  "marketplace.install.about.mcp":
    "เซิร์ฟเวอร์ MCP เพิ่มเครื่องมือให้ Neo สำหรับทำงานกับบริการภายนอกหรือโปรแกรมในเครื่อง",
  "marketplace.install.about.agent": "เอเจนต์เพิ่มบทบาทที่นำกลับมาใช้ใหม่ได้พร้อมคำสั่งและสิทธิ์ของตนเอง",
  "marketplace.install.about.skill":
    "ทักษะเพิ่มคำสั่งและทรัพยากรเฉพาะงานที่ Neo สามารถโหลดได้เมื่อจำเป็น",
  "marketplace.install.mcp.warning":
    "เซิร์ฟเวอร์ MCP สามารถเรียกใช้คำสั่งในเครื่องหรือเชื่อมต่อกับบริการภายนอกได้ Neo จะขออนุญาตก่อนใช้เครื่องมือ เว้นแต่สิทธิ์ของคุณจะอนุญาตโดยอัตโนมัติ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "ปิดสแน็ปช็อตของ Neo สำหรับโปรเจกต์นี้ คุณจะสูญเสียการยกเลิก/ทำซ้ำสำหรับการเปลี่ยนแปลงของ Neo แต่ git ยังคงติดตามทุกอย่าง",
