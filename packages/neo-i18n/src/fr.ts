export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway vous donne accès à une sélection de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Visitez ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " pour obtenir votre clé API.",
  "provider.connect.neoGateway.byok.prefix": "Pour plus de statistiques d'utilisation, utilisez ",
  ...
  "settings.providers.note.neo": "Accès à plus de 500 modèles d'IA",
  ...
  "marketplace.install.about.mcp":
    "Un serveur MCP fournit à Neo des outils supplémentaires pour interagir avec des services externes ou des programmes locaux.",
  "marketplace.install.about.agent":
    "Un agent ajoute un rôle réutilisable avec ses propres instructions et autorisations.",
  "marketplace.install.about.skill":
    "Une compétence ajoute des instructions et des ressources propres à une tâche que Neo peut charger en cas de besoin.",
  "marketplace.install.mcp.warning":
    "Les serveurs MCP peuvent exécuter des commandes locales ou se connecter à des services externes. Neo demandera votre autorisation avant d'utiliser leurs outils, sauf si vos autorisations le permettent automatiquement.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Désactivez les instantanés Neo pour ce projet. Vous perdez l'annulation/restauration des modifications faites par Neo, mais git continue de tout suivre.",
