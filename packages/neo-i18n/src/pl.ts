export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway zapewnia dostęp do wyselekcjonowanego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodowania.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Odwiedź ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": ", aby otrzymać swój klucz API.",
  "provider.connect.neoGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.neoGateway.byok.link": "BYOK przez Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Polecane",
  "settings.providers.note.neo": "Dostęp do ponad 500 modeli AI",
  ...
  "marketplace.install.about.mcp":
    "Serwer MCP zapewnia Neo dodatkowe narzędzia do pracy z usługami zewnętrznymi lub programami lokalnymi.",
  "marketplace.install.about.agent": "Agent dodaje rolę wielokrotnego użytku z własnymi instrukcjami i uprawnieniami.",
  "marketplace.install.about.skill":
    "Umiejętność dodaje instrukcje i zasoby dotyczące określonych zadań, które Neo może wczytać w razie potrzeby.",
  "marketplace.install.mcp.warning":
    "Serwery MCP mogą uruchamiać lokalne polecenia lub łączyć się z usługami zewnętrznymi. Neo poprosi o pozwolenie przed użyciem ich narzędzi, chyba że uprawnienia zezwalają na to automatycznie.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty Neo dla tego projektu. Stracisz cofanie/przywracanie zmian Neo, ale git nadal śledzi wszystko.",
