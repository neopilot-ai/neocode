export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway, kodlama ajanları için optimize edilmiş güvenilir modellere erişim sağlar.",
  ...
  "provider.connect.neoGateway.visit.prefix": "API anahtarınızı almak için ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " adresini ziyaret edin.",
  "provider.connect.neoGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.neoGateway.byok.link": "Neo's Gateway üzerinden BYOK",
  "provider.connect.neoGateway.byok.suffix": " kullanın.",

  // Provider settings translations
  "settings.providers.group.recommended": "Önerilen",
  "settings.providers.note.neo": "500+ AI modeline erişim",
  ...
  "marketplace.install.about.mcp":
    "Bir MCP sunucusu, harici hizmetler veya yerel programlarla çalışmak için Neo'ya ek araçlar sağlar.",
  "marketplace.install.about.agent": "Bir ajan, kendi talimatları ve izinleri olan yeniden kullanılabilir bir rol ekler.",
  "marketplace.install.about.skill":
    "Bir yetenek, Neo'nun gerektiğinde yükleyebileceği göreve özel talimatlar ve kaynaklar ekler.",
  "marketplace.install.mcp.warning":
    "MCP sunucuları yerel komutları çalıştırabilir veya harici hizmetlere bağlanabilir. İzinleriniz otomatik olarak izin vermediği sürece Neo, araçlarını kullanmadan önce izin ister.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için Neo anlık görüntülerini kapat. Neo değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
