export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "يمنحك Neo Gateway الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسّنة لوكلاء البرمجة.",
  "provider.connect.neoGateway.line2":
    "بمفتاح API واحد، ستحصل على إمكانية الوصول إلى نماذج مثل Claude وGPT وGemini وGLM والمزيد.",
  "provider.connect.neoGateway.visit.prefix": "قم بزيارة ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.neoGateway.byok.prefix": "للحصول على المزيد من إحصائيات الاستخدام، استخدم ",
  "provider.connect.neoGateway.byok.link": "BYOK عبر Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "موصى به",
  "settings.providers.note.neo": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
  ...
  "marketplace.install.about.mcp":
    "يمنح خادم MCP منصة Neo أدوات إضافية للعمل مع الخدمات الخارجية أو البرامج المحلية.",
  "marketplace.install.about.agent": "يضيف الوكيل دورًا قابلاً لإعادة الاستخدام بتعليماته وأذوناته الخاصة.",
  "marketplace.install.about.skill": "تضيف المهارة تعليمات وموارد خاصة بمهام معينة يمكن لـ Neo تحميلها عند الحاجة.",
  "marketplace.install.mcp.warning":
    "يمكن لخوادم MCP تشغيل أوامر محلية أو الاتصال بخدمات خارجية. ستطلب Neo الإذن قبل استخدام أدواتها ما لم تسمح أذوناتك بذلك تلقائيًا.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "أوقف لقطات Neo لهذا المشروع. ستفقد ميزة التراجع/الإعادة لتعديلات Neo، لكن git سيستمر في تتبع كل شيء.",
