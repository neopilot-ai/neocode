export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway предоставляет доступ к подборке надёжных оптимизированных моделей для агентов кодирования.",
  "provider.connect.neoGateway.line2":
    "С одним API-ключом вы получите доступ к моделям Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.neoGateway.visit.prefix": "Посетите ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": ", чтобы получить ваш API-ключ.",
  "provider.connect.neoGateway.byok.prefix": "Для получения дополнительной статистики использования используйте ",
  "provider.connect.neoGateway.byok.link": "BYOK через Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Рекомендуемые",
  "settings.providers.note.neo": "Доступ к 500+ моделям ИИ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер предоставляет Neo дополнительные инструменты для работы с внешними сервисами или локальными программами.",
  ...
  "marketplace.install.about.skill":
    "Навык добавляет инструкции и ресурсы для определённых задач, которые Neo может загрузить при необходимости.",
  "marketplace.install.mcp.warning":
    "MCP-серверы могут выполнять локальные команды или подключаться к внешним сервисам. Neo запросит разрешение перед использованием их инструментов, если только ваши разрешения не допускают это автоматически.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки Neo для этого проекта. Вы потеряете отмену/повтор изменений Neo, но git по-прежнему отслеживает всё.",
