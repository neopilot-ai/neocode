export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway надає доступ до добірки надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.neoGateway.visit.prefix": "Відвідайте ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " щоб отримати свій API-ключ.",
  "provider.connect.neoGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  ...
  "settings.providers.note.neo": "Доступ до 500+ моделей ШІ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер надає Neo додаткові інструменти для роботи із зовнішніми сервісами або локальними програмами.",
  "marketplace.install.about.agent":
    "Агент додає багаторазову роль із власними інструкціями та дозволами.",
  "marketplace.install.about.skill":
    "Навичка додає інструкції та ресурси для певних завдань, які Neo може завантажити за потреби.",
  "marketplace.install.mcp.warning":
    "MCP-сервери можуть виконувати локальні команди або підключатися до зовнішніх сервісів. Neo запитає дозвіл перед використанням їхніх інструментів, якщо ваші дозволи не дають змоги робити це автоматично.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки Neo для цього проєкту. Ви втратите скасування/повторення для змін Neo, але git продовжить відстежувати все.",
