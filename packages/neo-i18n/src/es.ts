export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway te da acceso a un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación.",
  ...
  "provider.connect.neoGateway.visit.suffix": " para obtener tu clave API.",
  "provider.connect.neoGateway.byok.prefix": "Para más estadísticas de uso, utiliza ",
  "provider.connect.neoGateway.byok.link": "BYOK a través de Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recomendados",
  "settings.providers.note.neo": "Acceso a más de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Un servidor MCP proporciona a Neo herramientas adicionales para trabajar con servicios externos o programas locales.",
  "marketplace.install.about.agent":
    "Un agente añade un rol reutilizable con sus propias instrucciones y permisos.",
  "marketplace.install.about.skill":
    "Una habilidad añade instrucciones y recursos específicos para tareas que Neo puede cargar cuando sea necesario.",
  "marketplace.install.mcp.warning":
    "Los servidores MCP pueden ejecutar comandos locales o conectarse a servicios externos. Neo pedirá permiso antes de usar sus herramientas, a menos que tus permisos lo permitan automáticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de Neo para este proyecto. Perderás deshacer/rehacer de los cambios de Neo, pero git seguirá rastreando todo.",
