...
export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway ti offre una selezione curata di modelli affidabili e ottimizzati per agenti di coding.",
  "provider.connect.neoGateway.line2":
    "Con una sola API key puoi accedere a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.neoGateway.visit.prefix": "Visita ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " per ottenere la tua API key.",
  "provider.connect.neoGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.neoGateway.byok.link": "BYOK tramite Neo's Gateway",
  "provider.connect.neoGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Consigliati",
  "settings.providers.note.neo": "Accesso a oltre 500 modelli AI",
  ...
  "marketplace.install.about.mcp":
    "Un server MCP fornisce a Neo strumenti aggiuntivi per interagire con servizi esterni o programmi locali.",
  "marketplace.install.about.agent":
    "Un agente aggiunge un ruolo riutilizzabile con istruzioni e autorizzazioni proprie.",
  "marketplace.install.about.skill":
    "Una skill aggiunge istruzioni e risorse specifiche per un'attività che Neo può caricare quando necessario.",
  "marketplace.install.mcp.warning":
    "I server MCP possono eseguire comandi locali o connettersi a servizi esterni. Neo chiederà l'autorizzazione prima di usare i loro strumenti, a meno che le tue autorizzazioni non lo consentano automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di Neo per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da Neo, ma git continuerà a tracciare tutto.",
