export const dict = {
  ...
  "provider.connect.neoGateway.line1":
    "Neo Gateway giver dig adgang til et udvalgt sæt pålidelige, optimerede modeller til kodningsagenter.",
  "provider.connect.neoGateway.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.neoGateway.visit.prefix": "Besøg ",
  "provider.connect.neoGateway.visit.link": "neo.khulnasoft.com",
  "provider.connect.neoGateway.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.neoGateway.byok.prefix": "For flere brugsstatistikker, brug ",
  ...
  "settings.providers.note.neo": "Adgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server giver Neo yderligere værktøjer til at arbejde med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent tilføjer en genanvendelig rolle med egne instruktioner og tilladelser.",
  "marketplace.install.about.skill":
    "En færdighed tilføjer opgavespecifikke instruktioner og ressourcer, som Neo kan indlæse efter behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan køre lokale kommandoer eller oprette forbindelse til eksterne tjenester. Neo beder om tilladelse, før deres værktøjer bruges, medmindre dine tilladelser automatisk tillader det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå Neos snapshots fra for dette projekt. Du mister fortryd/gentag for Neo-ændringer, men git sporer stadig alt.",
