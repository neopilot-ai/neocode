...
export const Action = Schema.NullOr(Schema.Literals(["ask", "allow", "deny"])) // neocode_change - nullable allows null as a delete sentinel
...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    agent_manager: Schema.optional(Rule), // neocode_change
...
const normalizeInput = (input: Schema.Schema.Type<typeof InputSchema>): Schema.Schema.Type<typeof InputObject> =>
  input === null || typeof input === "string" ? { "*": input } : input // neocode_change
