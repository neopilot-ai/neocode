...
// neocode_change start - report images rejected before native decode allocation
...
export interface Interface {
  readonly normalize: (
    ...
    ResizerUnavailableError | DecodeError | SizeError | PixelLimitError // neocode_change
  >
}
