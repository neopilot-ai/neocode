...
export type Definition<Type extends string = string, DataSchema extends Schema.Top = Schema.Top> = {
  ...
  readonly sync?: {
    ...
    readonly codec?: Schema.Codec<unknown, unknown, never, never> // neocode_change - storage-only compatibility decoder
  }
...
// neocode_change - keep persistence compatibility codecs out of public event schemas
...
export function define<const Type extends string, Fields extends Schema.Struct.Fields>(input: {
  ...
  readonly sync?: {
    readonly version: number
    readonly aggregate: string
    readonly codec?: Schema.Codec<unknown, unknown, never, never> // neocode_change
  }
