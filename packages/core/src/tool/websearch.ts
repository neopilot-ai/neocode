...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.NEO_WEBSEARCH_PROVIDER === "exa" || process.env.NEO_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.NEO_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("NEO_EXPERIMENTAL") || truthy("NEO_ENABLE_EXA") || truthy("NEO_EXPERIMENTAL_EXA"),
    enableParallel: truthy("NEO_ENABLE_PARALLEL") || truthy("NEO_EXPERIMENTAL_PARALLEL"),
