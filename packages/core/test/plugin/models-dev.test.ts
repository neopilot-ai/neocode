  ...
  it.effect("registers key methods for providers with environment variables", () =>
    Effect.acquireUseRelease(
      Effect.sync(() => {
        ...
        Flag.NEO_MODELS_PATH = path.join(import.meta.dir, "fixtures", "models-dev.json")
      ...
      (previous) =>
        Effect.sync(() => {
          Flag.NEO_MODELS_PATH = previous.path
          Flag.NEO_DISABLE_MODELS_FETCH = previous.disabled
        }),
    ),
  )
})
