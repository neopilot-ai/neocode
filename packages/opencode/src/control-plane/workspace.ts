...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NEO_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NEO_WORKSPACE_ID: config.id,
        NEO_EXPERIMENTAL_WORKSPACES: "true",
...
// neocode_change start - prevent Neo runtime cycles from erasing layer requirements
