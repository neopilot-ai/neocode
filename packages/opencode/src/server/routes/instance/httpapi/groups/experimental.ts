...
export const ExperimentalPaths = {
  ...
  worktreeDiff: "/experimental/worktree/diff", // neocode_change
  worktreeDiffFile: "/experimental/worktree/diff/file", // neocode_change
  worktreeDiffSummary: "/experimental/worktree/diff/summary", // neocode_change
      ...
      .add(
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local Neo state.", // neocode_change
          }),
        ),
        ...
        HttpApiEndpoint.get("worktree", ExperimentalPaths.worktree, {
          query: WorkspaceRoutingQuery,
          success: described(WorktreeList, "List of worktrees"), // neocode_change
          error: WorktreeApiError,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "worktree.list",
            summary: "List worktrees",
            description: "List all git worktrees for the current project and whether Neo manages them.", // neocode_change
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all Neo sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.", // neocode_change
          }),
        ),
