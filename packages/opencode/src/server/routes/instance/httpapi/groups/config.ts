...
import { Schema } from "effect" // neocode_change
      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current Neo configuration settings and preferences.", // neocode_change
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update Neo configuration settings and preferences.", // neocode_change
          }),
        ),
        // neocode_change start
