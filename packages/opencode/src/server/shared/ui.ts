...
import { ConsoleAssets } from "@/neocode/console/assets" // neocode_change
...
export function serveUIEffect(
  ...
  return Effect.gen(function* () {
    ...
    // neocode_change start - serve Neo Console under /console
    ...
    // neocode_change - no proxy fallback to app.opencode.ai; embedded UI only
    return notFound()
  })
}
