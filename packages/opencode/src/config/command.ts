...
import { SchemaIssue } from "effect" // neocode_change - preserve Effect issue details in Neo warnings
...
export async function load(
  ...
  for (const item of await Glob.scan("{command,commands}/**/*.md", {
    ...
    await NeocodeConfig.handleInvalid("command", item, issues, cause, warnings)
    // neocode_change end
  }
  return result
}
