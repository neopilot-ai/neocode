...
const disabled = process.env["NEO_DISABLE_SHARE"] === "true" || process.env["NEO_DISABLE_SHARE"] === "1"
...
// neocode_change start - preserve the share transport contract when stored legacy summary diffs omit file details
