...
import { NeoAuthPlugin } from "@neocode/neo-gateway" // neocode_change
import { AtomicChatPlugin } from "@neocode/plugin-atomic-chat" // neocode_change
import { AnacondaDesktopPlugin } from "@/neocode/anaconda-desktop/provider" // neocode_change
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  return [
    NeoAuthPlugin, // neocode_change
    AtomicChatPlugin, // neocode_change
    AnacondaDesktopPlugin, // neocode_change
    ...
    // neocode_change - external auth plugins ship against @opencode-ai/plugin; bridge to our @neocode/plugin types
...
function getLegacyPlugins(mod: Record<string, unknown>) {
  ...
  for (const entry of Object.values(mod)) {
    ...
    // neocode_change: skip named exports (e.g. constants from @neocode/plugin-atomic-chat)
    if (!plugin) continue // neocode_change
    result.push(plugin)
  }
