...
export function alreadyInstalled() {
  return process.env["NEO_CALLER"] === "vscode" || process.env["NEO_CALLER"] === "vscode-insiders"
}

// neocode_change start - Neo's VS Code extension bundles the CLI; auto-install from CLI is not applicable
