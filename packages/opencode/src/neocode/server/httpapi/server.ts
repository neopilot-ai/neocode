...
import * as AnacondaDesktop from "@/neocode/anaconda-desktop/service"
...
import { neoGatewayHandlers } from "./handlers/neo-gateway"
import { neocodeHandlers } from "./handlers/neocode"
...
export function provideListener(opts?: CorsOptions) {
  ...
  return Layer.provide([
    ...
    fenceLayer,
    cors,
    NeoViewers.defaultLayer, // neocode_change
