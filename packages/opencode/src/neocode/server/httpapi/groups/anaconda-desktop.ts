...
import { ReadyStatus, Status } from "@/neocode/anaconda-desktop/domain"
...
const root = "/neocode/anaconda-desktop"
      ...
      .add(
        ...
        HttpApiEndpoint.post("sync", AnacondaDesktopPaths.sync, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Discover the active local inference server and replace Neo provider authentication metadata.",
          }),
        ),
      )
      .annotateMerge(
