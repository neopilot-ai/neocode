...
const root = "/neocode/session-import"

const ResultSchema = Schema.Struct({
  ok: Schema.Boolean,
  id: Schema.String,
  skipped: Schema.optional(Schema.Boolean),
}).annotate({ identifier: "NeocodeSessionImportResult" })
    ...
    HttpApiGroup.make("session-import")
      .add(
        HttpApiEndpoint.post("project", SessionImportPaths.project, {
          ...
          OpenApi.annotations({
            identifier: "neocode.sessionImport.project",
        ...
        HttpApiEndpoint.post("session", SessionImportPaths.session, {
          ...
          OpenApi.annotations({
            identifier: "neocode.sessionImport.session",
        ...
        HttpApiEndpoint.post("message", SessionImportPaths.message, {
          ...
          OpenApi.annotations({
            identifier: "neocode.sessionImport.message",
        ...
        HttpApiEndpoint.post("part", SessionImportPaths.part, {
          ...
          OpenApi.annotations({
            identifier: "neocode.sessionImport.part",
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          description: "Neo legacy session import routes.",
        }),
      )
