...
import { Result as AgentRequirementResult } from "@/neocode/agent-requirements"
import {
...
export const NeocodeApi = HttpApi.make("neocode")
  .add(
    HttpApiGroup.make("neocode")
      .add(
        HttpApiEndpoint.post("heapSnapshot", NeocodePaths.heapSnapshot, {
          query: WorkspaceRoutingQuery,
          success: described(Schema.String, "Heap snapshot file path"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "neocode.heap.snapshot",
            summary: "Write heap snapshot",
            description: "Write a heap snapshot for the CLI process to the log directory.",
          }),
        ),
        HttpApiEndpoint.get("agentRequirements", NeocodePaths.agentRequirements, {
          query: AgentRequirementQuery,
          success: described(AgentRequirementResult, "Agent requirement status"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "neocode.agentRequirements",
        ...
        HttpApiEndpoint.post("removeSkill", NeocodePaths.removeSkill, {
          query: WorkspaceRoutingQuery,
        ...
        HttpApiEndpoint.post("removeAgent", NeocodePaths.removeAgent, {
          ...
          OpenApi.annotations({
            identifier: "neocode.removeAgent",
        ...
        HttpApiEndpoint.post("agentManagerReply", NeocodePaths.agentManagerReply, {
          ...
          OpenApi.annotations({
            identifier: "neocode.agentManager.reply",
        ...
        HttpApiEndpoint.post("agentManagerReject", NeocodePaths.agentManagerReject, {
          params: { requestID: AgentManagerRequestID },
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "neocode.agentManager.reject",
        ...
        HttpApiEndpoint.get("sessionModelUsage", NeocodePaths.sessionModelUsage, {
          ...
          OpenApi.annotations({
            identifier: "neocode.sessionModelUsage",
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "neocode",
          description: "Neo-specific routes.",
        }),
      )
