 ...
 * prompts (plain `neo run`). Permission asks originating from their child
...
export namespace NeoHeadless {
  ...
  export const denies = Effect.fn("NeoHeadless.denies")(function* (id: string) {
