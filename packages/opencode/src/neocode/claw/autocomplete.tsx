/**
 * NeoClaw chat slash-command autocomplete.
 *
 ...
 * with neoclaw's own `/new` for conversations.
 *
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "NeoClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "NeoClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "NeoClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "NeoClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "NeoClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "NeoClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "NeoClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
