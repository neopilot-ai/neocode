 ...
 * and a textarea for chatting with the NeoClaw bot via Neo Chat.
...
export function ClawChat(props: {
  ...
  // `bot:neoclaw:{sandboxId}` — the bot is the only non-self member in 1:1
  // chats, so we resolve bot ids to the user-configured `botName` (which
  // falls back to "NeoClaw" upstream) and render any human collaborators
