...
/**
 * NeoClaw TUI types — Neo Chat protocol.
 *
 * Mirrors `@neocode/neo-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the NeoClaw bot, set during onboarding via the
  ...
  // literal string "NeoClaw" when null.
  botName?: string | null
}
