...
import { fmtAttemptCost, fmtScore } from "@/neocode/components/model-info-panel-utils"
import {
  failed,
  formatCost,
  formatCount,
  ...
  select,
  type UsageResult,
} from "@/neocode/plugins/model-usage"
import { ModelRow, UsageRow } from "@/neocode/plugins/sidebar-usage-row"

const id = "internal:neo-sidebar-usage"
...
function View(props: { api: TuiPluginApi; session_id: string }) {
  ...
  const [result, { refetch }] = createResource(
    ...
    (sessionID): Promise<UsageResult> =>
      props.api.client.neocode.sessionModelUsage({ sessionID }).then(
