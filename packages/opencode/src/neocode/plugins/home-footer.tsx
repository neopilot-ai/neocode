...
/**
 * Neo-specific home footer plugin.
 *
...
import { RemoteIndicator } from "@/neocode/remote-tui"

const id = "internal:neo-home-footer"

// ---------------------------------------------------------------------------
// Sub-components (mirror upstream home/footer with neo additions)
// ---------------------------------------------------------------------------
...
function View(props: { api: TuiPluginApi }) {
  const neo = createMemo(() => props.api.state.provider.some((p) => p.id === "neo"))
