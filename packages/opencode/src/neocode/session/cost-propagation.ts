...
export namespace NeoCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("NeoCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("NeoCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
