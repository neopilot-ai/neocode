...
import { NeoSessionOverflow } from "./overflow"

const SAFETY = 2048
const MIN_OUTPUT = 1024

export namespace NeoLLM {
  ...
  export function capOutputTokens(input: {
    ...
    usage?: ReturnType<typeof NeoSessionOverflow.measure>
    reported?: number
  }): number | undefined {
    ...
    const estimated =
      ...
      NeoSessionOverflow.measure({ messages: input.messages, tools: input.tools }).normalized
