/**
 * Neo Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@neocode/neo-gateway/tui"
...
interface DialogNeoOrganizationProps {
...
export function DialogNeoOrganization(props: DialogNeoOrganizationProps) {
    ...
    <DialogSelect
      ...
      onSelect={async (option: any) => {
        try {
          ...
          await sdk.client.neo.organization.set({
