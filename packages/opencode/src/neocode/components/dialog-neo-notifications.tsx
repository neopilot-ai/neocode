/**
 * Neo Notifications Dialog
 *
 * Displays all notifications from Neo API in a scrollable dialog.
...
import type { NeocodeNotification } from "@neocode/neo-gateway"

interface DialogNeoNotificationsProps {
  notifications: NeocodeNotification[]
}

export function DialogNeoNotifications(props: DialogNeoNotificationsProps) {
