...
const TIPS = [
  ...
  "Neo can {highlight}configure itself{/highlight} if you ask it",
  "Ask Neo to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Neo to {highlight}create a review agent for this project{/highlight}",
  "Ask Neo to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Neo to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Neo to {highlight}make my review agent read-only{/highlight}",
  "Ask Neo to {highlight}require approval before git push{/highlight}",
  "Ask Neo to {highlight}turn off auto-formatting{/highlight}",
  "Ask Neo to {highlight}block access to .env files{/highlight}",
  "Ask Neo to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Neo to {highlight}match my terminal theme{/highlight}",
  "Ask Neo to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Neo to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Neo to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Neo to {highlight}save this workflow as a /command{/highlight}",
  "Neo auto-handles OAuth for remote MCP servers requiring auth",
  "Neo auto-formats files using prettier, gofmt, ruff, and more",
  "Neo uses LSP servers for intelligent code analysis",
