/**
 * Custom OAuth handler for Neo Gateway
 *
...
import { DialogNeoOrganization } from "./dialog-neopilot-aianization.js"
...
export function NeoAutoMethod(props: NeoAutoMethodProps) {
  ...
  onMount(async () => {
    try {
      ...
      const profileResponse = await sdk.client.neo.profile()
      ...
      console.warn("Failed to fetch Neo profile, using personal account:", error)
      setStatus("error")
