...
import type { NeocodeProfile, NeocodeBalance } from "@neocode/neo-gateway"

interface DialogNeoProfileProps {
  profile: NeocodeProfile
  balance: NeocodeBalance | null
  currentOrgId?: string | null
}

export function DialogNeoProfile(props: DialogNeoProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.neo.khulnasoft.com/organizations/${props.currentOrgId}/usage-details`
    : "https://app.neo.khulnasoft.com/usage"
