...
import { assertNetwork, assertSandbox, networkHttpLayer } from "@neocode/sandbox"
import { host, opaque } from "./network-tools"

const Builtin = Symbol("neo.sandbox.builtinTool")
const Remote = Symbol("neo.sandbox.remoteMcp")
