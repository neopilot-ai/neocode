...
const TABLE_PATH = root + "packages/neo-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/neo-docs/pages/code-with-ai/platforms/cli-reference.md"
...
// them here as well to keep neo.khulnasoft.com/docs in sync with the shipped binary.
