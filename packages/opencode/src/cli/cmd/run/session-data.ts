...
import type { Part, PermissionRequest, QuestionRequest, ToolPart } from "@neocode/sdk/v2"
...
export type SessionData = {
  ...
  terminal?: RunInteractiveTerminalSnapshot // neocode_change
...
function pickSessionView(data: SessionData): FooterView {
  return pickBlockerView({
    terminal: data.terminal, // neocode_change
...
export function reduceSessionData(input: SessionDataInput): SessionDataOutput {
  ...
  // neocode_change start - direct interactive mode terminal footer
