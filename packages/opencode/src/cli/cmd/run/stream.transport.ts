...
import type { GlobalEvent, NeoClient } from "@neocode/sdk/v2"
...
function sid(event: Event): string | undefined {
  ...
  if (event.type === "interactive_terminal.updated") return event.properties.info.sessionID // neocode_change
  ...
  if (
    ...
    event.type === "interactive_terminal.data" || // neocode_change
    event.type === "interactive_terminal.deleted" || // neocode_change
