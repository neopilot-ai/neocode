// Per-tool display rules shared across `neo run` output paths. // neocode_change
//
...
import type { ToolPart } from "@neocode/sdk/v2"
...
import type { InteractiveTerminalTool } from "@/neocode/tool/interactive-terminal" // neocode_change
...
type ToolDefs = {
  ...
  interactive_terminal: typeof InteractiveTerminalTool // neocode_change
