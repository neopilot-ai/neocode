...
const cache = process.env.NEO_BWRAP_CACHE ?? path.join(os.tmpdir(), "neo-bubblewrap", commit)
...
#define PACKAGE_STRING "bubblewrap ${version} for Neo"
...
Neo distributes Bubblewrap as a separate executable. The complete license text is
