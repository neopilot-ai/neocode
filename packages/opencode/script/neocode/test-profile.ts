  ...
  const profiles = {
    darwin: {
      ...
      groups: {
        ...
        neo: [
          "neocode/{background-process,daemon,diff-full,external-directory-boundary,indexing-worker,indexing-worktree,interactive-terminal,mcp-oauth-callback,primary-worktree,project-id,read-directory,session-diff-restore,snapshot-cache,snapshot-freeze-repro,snapshot-revert-move,snapshot-seed,task-nesting}.test.ts",
          "neocode/cli/cmd/serve.test.ts",
          "neocode/cli/install-artifact.test.ts",
          "neocode/config/config.test.ts",
          "neocode/core-watcher.test.ts",
          "neocode/sandbox/*.test.ts",
          "neocode/server/{config-overlay,listener-runtime,tui-config,worktree-list}.test.ts",
          "neocode/session-export/{e2e,sequence,worker,workspace-provider}.test.ts",
          "neocode/session-export/worker/{storage,zstd}.test.ts",
          "neocode/tool/repo_clone.test.ts",
          "neocode/worktree*.test.ts",
        ],
