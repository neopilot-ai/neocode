...
// neocode_change start - review follow-up uses non-blocking question prompts
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      if (Exit.isFailure(exit)) {
        ...
        // neocode_change start - preserve upstream unknown-request failure behavior during facade migration
