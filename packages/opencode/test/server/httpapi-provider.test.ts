...
import { preparePluginDependencies } from "../neocode/plugin-dependencies" // neocode_change
...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => preparePluginDependencies(dir)) // neocode_change

    yield* fs.writeWithDirs(
      path.join(dir, ".neo", "plugin", "provider-oauth-parity.ts"), // neocode_change
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".neo", "plugin", "provider-oauth-validation.ts"), // neocode_change
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".neo", "plugin", "provider-function-options.ts"), // neocode_change
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".neo", "plugin", "provider-models-mutation.ts"), // neocode_change
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* request("/api/provider/missing", {
        headers: { "x-neo-directory": directory },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      const directory = (yield* TestInstance).directory
      const headers = { "x-neo-directory": directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-neo-directory": directory }
