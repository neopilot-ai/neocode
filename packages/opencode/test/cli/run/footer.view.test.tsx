...
import type { QuestionRequest } from "@neocode/sdk/v2"
...
// neocode_change start - cover direct-mode Neo skill picker transitions
    ...
    return (
      <OpencodeKeymapProvider keymap={keymap}>
        <RunFooterView
          ...
          onLayout={() => {}}
          onStatus={() => {}}
          onTerminalWrite={async () => {}} // neocode_change
          onTerminalResize={async () => {}} // neocode_change
          onTerminalClose={async () => {}} // neocode_change
          onQueuedRemove={async () => true}
        />
      </OpencodeKeymapProvider>
    )
