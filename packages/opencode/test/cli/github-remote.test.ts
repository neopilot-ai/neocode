...
// neocode_change start: rebrand fixtures off upstream repo path
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Neopilot-Ai/neocode.git")).toEqual({
    owner: "Neopilot-Ai",
    repo: "neocode",
  })
})
...
test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Neopilot-Ai/neocode.git")).toEqual({
    owner: "Neopilot-Ai",
    repo: "neocode",
  })
})
