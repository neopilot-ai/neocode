...
describe("opencode read-only commands (smoke)", () => {
  ...
  // NEO_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh NEO_TEST_HOME means
  ...
  // in production it'd be a path under NEO_TEST_HOME / XDG_DATA_HOME.
