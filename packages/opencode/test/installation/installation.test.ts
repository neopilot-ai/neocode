...
describe("installation", () => {
  describe("latest", () => {
    // neocode_change start - curl/unknown fallback now resolves from the public npm
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(curlCalls).toContain("https://registry.npmjs.org/@neocode%2fcli/local")
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@neocode%2fcli/${InstallationChannel}`) // neocode_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@neocode%2fcli/${InstallationChannel}`) // neocode_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@neocode%2fcli/${InstallationChannel}`) // neocode_change
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Neopilot-Ai/tap/neo")) return "" // neocode_change
          if (cmd === "brew" && args.includes("--formula") && args.includes("neo")) return "neo" // neocode_change
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Neopilot-Ai/tap/neo") && args.includes("--formula")) return "neo" // neocode_change
