...
//   - NEO_CONFIG_CONTENT      : provider config inline, no files to find
//   - NEO_TEST_HOME           : pins os.homedir() → tmpdir
//   - NEO_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - NEO_PURE                : skip external plugin discovery + install
//   - NEO_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
const cliArgs = ["run", "--conditions=browser", "--preload=@opentui/solid/preload", cliEntry] // neocode_change
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    NEO_CONFIG_CONTENT: configJson,
    NEO_DISABLE_PROJECT_CONFIG: "1",
    NEO_PURE: "1",
    NEO_DISABLE_AUTOUPDATE: "1",
    NEO_DISABLE_AUTOCOMPACT: "1",
