...
// neocode integration in shared LSP files, these tests catch it.

import { describe, test, expect, spyOn, afterEach } from "bun:test"
import path from "path"
import * as LSPServer from "../../src/lsp/server"
import { TsClient } from "../../src/neocode/ts-client"
import { TsCheck } from "../../src/neocode/ts-check"
import { Flag } from "@opencode-ai/core/flag/flag"
import { Instance, type InstanceContext } from "../../src/neocode/instance"
...
describe("typescript lightweight mode", () => {
  ...
  describe("source integration guards", () => {
    // These tests verify that neocode integration code exists in shared
    ...
    test("lsp/server.ts gates Typescript.spawn behind flag", async () => {
      ...
      expect(src).toContain("NEO_EXPERIMENTAL_LSP_TOOL")
