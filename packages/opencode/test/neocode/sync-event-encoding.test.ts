...
import * as EventWire from "../../src/neocode/event-wire"
...
describe("SyncEvent encoding", () => {
  test("preserves JSON values nested under unknown schemas", () => {
    ...
    expect(EventWire.encode(schema, { value: new URL("https://neo.khulnasoft.com/docs") })).toEqual({
      value: "https://neo.khulnasoft.com/docs",
    })
  })
