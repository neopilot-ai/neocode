...
import { formatTable, formatMarkdown, handle, isTextModel, outputLimit } from "../../../src/neocode/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["neo/test-model", "YES", "Hello!", "1000ms"],
      ["neo/another-model", "NO", "(Error)", "500ms"],
    ]
