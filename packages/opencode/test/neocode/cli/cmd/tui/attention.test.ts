...
import type { Event, Session, SessionNetworkWait, SuggestionRequest } from "@neocode/sdk/v2"
import type { TuiAttentionNotifyInput } from "@neocode/plugin/tui"
...
describe("Neo attention TUI plugin", () => {
