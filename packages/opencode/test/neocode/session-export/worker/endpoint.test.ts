...
import { defaultEndpoint, resolveEndpoint } from "@/neocode/session-export/worker/endpoint"
...
describe("session export endpoint", () => {
  ...
  test("allows approved production endpoint", () => {
    const endpoint = "https://supermassive-black-hole.neoapps.io/v1/session-export/batch"
