...
import { Chunker } from "@/neocode/session-export/worker/chunks"
import { Scrubber } from "@/neocode/session-export/worker/scrub"
import { handleEvent } from "@/neocode/session-export/worker/handlers"
import type {
  CompactionCaptured,
  LlmRequestCompleted,
  LlmRequestStarted,
...
} from "@/neocode/session-export/events"
...
function started(id: string, input: Partial<LlmRequestStarted["input"]>): LlmRequestStarted {
  return {
    ...
    agent: "claude",
    modeId: "build",
    model: { providerId: "neo", modelId: "free-1", isFree: true },
