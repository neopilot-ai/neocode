// Tests the neocode-specific patch module guarantees:
...
// These round-trip through the apply_patch tool so the Neo encoding layer is
...
describe("Patch encoding preservation", () => {
  ...
  beforeEach(async () => {
    dir = await fs.mkdtemp(path.join(tmpdir(), "neo-patch-"))
  })
