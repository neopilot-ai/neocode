...
import { NeoSessionPromptQueue } from "../../src/neocode/session/prompt-queue"
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const first = yield* NeoSessionPromptQueue.enqueue(
          sessionID,
        ...
        const second = yield* NeoSessionPromptQueue.enqueue(
          sessionID,
