...
import { hasAtomicChatPlugin } from "@/neocode/atomic-chat-feature"
import { NeocodeDefaultPlugins } from "@/neocode/config/default-plugins"
import { PluginLoader } from "@/plugin/loader"

const atomic = "@neocode/plugin-atomic-chat"

describe("neocode default atomic chat plugin", () => {
  test("injects atomic chat without registering an external plugin origin", () => {
    ...
    NeocodeDefaultPlugins.apply(cfg, { disabled: false })
  ...
  test("does not add atomic chat plugin when default plugins are disabled", () => {
    ...
    NeocodeDefaultPlugins.apply(cfg, { disabled: true })
