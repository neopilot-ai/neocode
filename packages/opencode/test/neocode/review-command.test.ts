...
import { legacyReviewMessage, parseReviewCommand, reviewCommand } from "../../src/neocode/review/command"
...
describe("review command parsing", () => {
  test("parses every supported review invocation", () => {
    ...
    expect(parseReviewCommand("/review https://github.com/Neopilot-Ai/neocode/pull/11084")).toBe("review")
