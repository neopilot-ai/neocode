...
const previous = {
  flag: Flag.NEO_SERVER_PASSWORD,
  env: process.env.NEO_SERVER_PASSWORD,
}

afterEach(async () => {
  Flag.NEO_SERVER_PASSWORD = previous.flag
  if (previous.env === undefined) delete process.env.NEO_SERVER_PASSWORD
  else process.env.NEO_SERVER_PASSWORD = previous.env
