...
describe("neocode XLSX reads", () => {
  it.live("extracts labelled formatted content from case-variant XLSX files", () =>
    Effect.gen(function* () {
      ...
      expect(result.output).toContain("Link (https://neo.khulnasoft.com)")
