...
import { environmentDetails } from "../../src/neocode/editor-context"
...
import PROMPT_GPT55 from "../../src/session/prompt/neocode-gpt-5.5.txt"
...
describe("environmentDetails", () => {
  test("includes cwd and worktree in dynamic context", () => {
    const result = environmentDetails({
      directory: "/repo/.neo/worktrees/feature",
      worktree: "/repo/.neo/worktrees/feature",
      activeFile: "src/app.ts",
    })

    expect(result).toContain("Working directory: /repo/.neo/worktrees/feature")
    expect(result).toContain("Workspace root folder: /repo/.neo/worktrees/feature")
