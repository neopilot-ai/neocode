...
import { pollWithTimeout, testEffect } from "../lib/effect" // neocode_change
    ...
    provideTmpdirInstance(
      () => {
        ...
        return Effect.gen(function* () {
          ...
          expect(seen).toHaveLength(1)
          expect(sync.url).toBe("https://legacy-share.example.com/api/share/shr_abc/sync") // neocode_change
