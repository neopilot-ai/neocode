...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEO_CALLER", () => {
    process.env["NEO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEO_CALLER", () => {
    process.env["NEO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEO_CALLER", () => {
    process.env["NEO_CALLER"] = "unknown"
