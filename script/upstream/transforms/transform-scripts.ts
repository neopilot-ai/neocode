 ...
 * by transforming them from anomalyco/opencode to Neopilot-Ai/neocode.
 */
...
const SCRIPT_REPLACEMENTS: ScriptReplacement[] = [
  // GitHub API URLs
  {
    ...
    replacement: "api.github.com/repos/Neopilot-Ai/neocode",
    description: "GitHub API URL",
  },
  {
    pattern: /\/repos\/anomalyco\/opencode/g,
    replacement: "/repos/Neopilot-Ai/neocode",
  ...
  // gh CLI commands
  {
    ...
    replacement: 'gh api "/repos/Neopilot-Ai/neocode',
