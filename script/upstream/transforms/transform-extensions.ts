#!/usr/bin/env bun
/**
 * Transform extension files (Zed, etc.) with Neo branding
 *
 * This script handles extension configuration files by transforming
 * OpenCode references to Neo.
 */
...
const EXTENSION_REPLACEMENTS: ExtensionReplacement[] = [
  ...
  },
  {
    ...
    replacement: 'description = "Neo - AI coding assistant"',
  ...
  // GitHub/Repository references
  {
    ...
    replacement: 'repository = "https://github.com/Neopilot-Ai/neocode"',
  ...
  // Binary/command references
  {
    ...
    replacement: 'command = "neo"',
    description: "Command name",
    fileTypes: [".toml"],
  },

  // Generic OpenCode -> Neo in strings
  {
    pattern: /"OpenCode"/g,
    replacement: '"Neo"',
  ...
  },
  {
    ...
    replacement: "Neo language server",
