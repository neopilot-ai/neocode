#!/usr/bin/env bun
/**
 * Preserve Neo package versions during upstream merge
 *
 * This script ensures that Neo's package versions are not overwritten
...
/**
 * Get the current Neo version from the main package.json
 */
