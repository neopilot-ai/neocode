...
export interface MergeConfig {
  /** Package name mappings from opencode to neo */
  packageMappings: PackageMapping[]

  /** Files to always keep Neo's version (never take upstream changes) */
  keepOurs: string[]

  /** Files to skip entirely (don't add from upstream, remove if added) */
  skipFiles: string[]

  /** Files that should take upstream version and apply Neo branding transforms */
  ...
  /** Directories that are Neo-specific and should be preserved */
  neoDirectories: string[]
...
export const defaultConfig: MergeConfig = {
  packageMappings: [
    ...
    { from: "@opencode-ai/sdk", to: "@neocode/sdk" },
    { from: "@opencode-ai/plugin", to: "@neocode/plugin" },
  ],
  ...
  keepOurs: [
    ...
    // Neo-specific command files
    ".opencode/command/commit.md",
    // Neo-specific publish scripts
    ...
    // GitHub Action - Neo version is fully ported and complete
    "github/action.yml",
    "github/README.md",
  ...
  // Files that only exist in upstream and should NOT be added to Neo
  // These are removed during merge if they appear
  skipFiles: [
    // Translated README files (Neo doesn't have these)
    "README.ar.md",
    "README.bn.md",
    "README.br.md",
    "README.bs.md",
    ...
    // Stats file
    "STATS.md",
    // Team members file (Neo doesn't maintain this upstream list)
    ".github/TEAM_MEMBERS",
    // Workflows that don't exist in Neo
    ".github/workflows/update-nix-hashes.yml",
    ".github/workflows/deploy.yml",
    ".github/workflows/docs-update.yml",
    ".github/workflows/docs-locale-sync.yml",
    // Workflows deleted in Neo (replaced or no longer needed)
    ".github/workflows/close-prs.yml",
    ".github/workflows/opencode.yml",
    ".github/workflows/publish-vscode.yml",
    // Upstream PR cleanup is replaced by .github/workflows/neo-auto-close.yml
    "script/github/close-prs.ts",
    // VS Code example configs (Neo ships real .vscode/* files)
    ".vscode/launch.example.json",
    ".vscode/settings.example.json",
    // Nix files for packages Neo has removed / replaced with nix/neo.nix
    "nix/desktop.nix",
    "nix/opencode.nix",
    // opencode CLI bin (Neo uses its own build output)
    "packages/opencode/bin/opencode",
    // Removed prompt file
    "packages/opencode/src/session/prompt/build-switch.txt",
    // Vouch files (Neo doesn't use Vouch).
    ...
    // SST infrastructure files (Neo is CLI-only, no hosted platform)
    "sst.config.ts",
    "sst-env.d.ts",
  ...
  // i18n translation files that need Neo branding transforms
