 ...
 *
 * Transforms string literals containing opencode references to neo:
 * - "opencode-ai" -> "@neocode/cli"
 * - "npx opencode" -> "npx @neocode/cli"
 * - etc.
 *
 * Usage:
...
const STRING_REPLACEMENTS: StringReplacement[] = [
  ...
  { pattern: /\bopencode-ai\b/g, replacement: "@neocode/cli" },
  ...
  // CLI commands
  { pattern: /\bnpx opencode\b/g, replacement: "npx @neocode/cli" },
  { pattern: /\bbun add opencode\b/g, replacement: "bun add @neocode/cli" },
  { pattern: /\bnpm install opencode\b/g, replacement: "npm install @neocode/cli" },
  { pattern: /\bnpm i opencode\b/g, replacement: "npm i @neocode/cli" },

  // Database filename
  { pattern: /\bopencode\.db\b/g, replacement: "neo.db" },

  // Binary name references (be careful with these)
  { pattern: /\bopencode upgrade\b/g, replacement: "neo upgrade" },
  ...
  { pattern: /\bVITE_OPENCODE_/g, replacement: "VITE_NEO_" },
  { pattern: /\b_EXTENSION_OPENCODE_/g, replacement: "_EXTENSION_NEO_" },
]
