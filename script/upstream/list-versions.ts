...
import { getAvailableUpstreamVersions, getCurrentNeoVersion } from "./utils/version"
...
async function main() {
  ...
  const neoVersion = await getCurrentNeoVersion()

  console.log()
  success(`Current Neo version: ${neoVersion}`)
  console.log()
