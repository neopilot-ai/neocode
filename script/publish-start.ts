...
const skipNotes = process.env["NEO_SKIP_NOTES"] === "1" // neocode_change
if (skipNotes) console.log("changelog skipped: NEO_SKIP_NOTES=1") // neocode_change
...
if (!Script.preview) {
  ...
  // neocode_change start - skip draft flag when NEO_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
