...
Generates UPCOMING_CHANGELOG.md by running the neo changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for neo run (default: low)
      --quiet            Suppress neo command output unless it fails
...
const cmd = ["neo", "run"] // neocode_change - opencode -> neo
