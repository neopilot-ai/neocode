...
const forbidden: { pattern: string; reason: string; allow?: string[] }[] = [
  { pattern: "opncd.ai/s/", reason: "legacy upstream share URL pattern" },
  {
    ...
    reason: "upstream repo URL -- should be Neopilot-Ai/neocode",
    allow: [
      "AGENTS.md",
      "README.md",
      "translations/README.",
      ".opencode/glossary/",
      "packages/neo-vscode/AGENTS.md",
      "packages/neo-docs/source-links.md",
      "patches/",
      "script/upstream/",
      "translations/",
    ],
  },
  {
    ...
    reason: "old upstream org path -- should be Neopilot-Ai/neocode",
    allow: [".neo/agent/upstream-merge.md", "script/upstream/"],
  },
