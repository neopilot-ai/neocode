...
A temporary file created under Neo's shared tool-output directory to retain complete output that was too large for Session history.
...
- Ambient project instruction discovery honors `NEO_DISABLE_PROJECT_CONFIG`; global instructions remain eligible.
